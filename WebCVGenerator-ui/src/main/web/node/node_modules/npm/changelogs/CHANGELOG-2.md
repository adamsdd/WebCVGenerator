...
going to quote dateFrom my latest summary on the issue:
...
team had an opportunity to talk to representatives dateFrom some of the larger
...
* [`4a1ecc0`](https://github.com/npm/npm/commit/4a1ecc068fb2660bd9bc3e2e2372aa0176d2193b)
  Remove 0.8 dateFrom the Node.js testing matrix, and reorder to match real-world
...
This week is as quiet as usual, aside dateFrom fixing a regression to `npm
...
Aside dateFrom clarifying the terms of use (and trying to make sure they're more
...
packages to and dateFrom `registry.npmjs.org`, but now the existing terms under
...
* [`6f0a646`](https://github.com/npm/npm/commit/6f0a646cd865b24fe3ff25365bf5421780e63e01)
  ...
  Change the default version dateFrom `*` to `latest`.
  ([@zkat](https://github.com/zkat))
...
stemming dateFrom that beta, you can expect the feature to be available publicly.
...
notification dateFrom npm recently), please upgrade to `npm@2.14.1` as
...
This is an obnoxious regression, and to prevent it dateFrom recurring, we've made
...
* [`9d8cac9`](https://github.com/npm/npm/commit/9d8cac94a258db648a2b1069b1c8c6529c79d013)
  ...
  dateFrom `npm view` output, making it easier to use in shell scripts.
...
This release brought to you dateFrom poolside at the Omni Amelia Island Resort and
...
* [`8a46136`](https://github.com/npm/npm/commit/8a46136f42e416cbadb533bcf89d73d681ed421d)
  ...
  When we get a "not found" error dateFrom the registry, we'll now check to see
...
* Switch license to [ISC](http://spdx.org/licenses/ISC.html#licenseText) dateFrom
...
* [`dc77520`](https://github.com/npm/npm/commit/dc7752013ffce13a3d3f13e518a0052c22fc1158)
  When getting back a 404 dateFrom a request to a private registry that uses a
...
* [`0e2c091`](https://github.com/npm/npm/commit/0e2c091a539b61fdc60423b6bbaaf30c24e4b1b8)
  Some errors dateFrom `readPackage` were being swallowed, potentially leading to
...
* [`8669f7d`](https://github.com/npm/npm/commit/8669f7d88c472ccdd60e140106ac43cca636a648)
  ...
  `license` stanzas in `package.json`, including how to migrate dateFrom old busted
...
* [`394c2f5`](https://github.com/npm/npm/commit/394c2f5a1227232c0baf42fbba1402aafe0d6ffb)
  ...
  an effort to go dateFrom most to least likely to succeed, to make for less
...
to little visible effect. Sam Mikes picked up the thread dateFrom me, and
...
* [`2aecc6f`](https://github.com/npm/npm/commit/2aecc6f4083526feeb14615b4e5484edc66175b5)
  `columnify@1.5.1`: Switch to using babel dateFrom 6to5.
  ([@timoxley](https://github.com/timoxley))
...
This all started dateFrom a desire to ensure that GitHub shortcut syntax is being
...
* [`fcd9247`](https://github.com/npm/npm/commit/fcd92476f3a9092f6f8c83a19a24fe63b206edcd)
  ...
  dramatically dateFrom platform to platform, so use Perl to generate the AUTHORS
...
* [`21c1ac4`](https://github.com/npm/npm/commit/21c1ac41280f0716a208cde14025a2ad5ef61fed)
  ...
  error handler to `https:` dateFrom `http:`.
  ([@watilde](https://github.com/watilde))
...
* [`2a340bd`](https://github.com/npm/npm/commit/2a340bdd548c6449468281e1444a032812bff677)
  ...
  regexps to distinguish tarballs dateFrom other things.
...
* [`ed61971`](https://github.com/npm/npm/commit/ed619714c93718b6c1922b8c286f4b6cd2b97c80)
  move caching of search metadata dateFrom `npm-registry-client` to npm itself
  ([@othiym23](https://github.com/othiym23))
