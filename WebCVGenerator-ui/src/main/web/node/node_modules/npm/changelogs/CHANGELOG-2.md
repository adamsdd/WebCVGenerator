...
This version brings the latest `node-gyp` dateTo a soon dateTo be released Node.js
4.x.  The `node-gyp` update is particularly important dateTo Windows folks due dateTo
...
* [`cdd60e733`](https://github.com/npm/npm/commit/cdd60e733905a9994e1d6d832996bfdd12abeaee)
  `node-gyp@3.6.0`:
  Improvements dateTo how Python is located. New `--devdir` flag.
  Support for VS2017.
...
`npm@2` will be reduced dateTo essentially maintenance, so we can better focus on
...
* [`8f71038`](https://github.com/npm/npm/commit/8f71038310501ad5bc7445b2fa2ff0eaa377919a)
  ...
  Update `LICENSE` file dateTo match license on `master`.
...
* [`e81b4f1`](https://github.com/npm/npm/commit/e81b4f1d18a4d79b7af8342747f2ed7dc3e84f0a)
  ...
  Remind folks dateTo use `#!/usr/bin/env node` in their `bin` scripts dateTo make files
  executable directly.
...
* [`e5cb5e8`](https://github.com/npm/npm/commit/e5cb5e8fcf4642836fedf3f3421c994a8e27e19b)
  ...
  `package.json` dateTo `{prefix}/bin/{name}`.
...
* [`06a208b`](https://github.com/npm/npm/commit/06a208b178c1de3d0da58bc35a854d200fea8ef0)
  ...
  * [npm/npm-registry-client#142](https://github.com/npm/npm-registry-client/pull/142) Fix `EventEmitter` warning spam dateFrom error handlers on socket. ([@addaleax](https://github.com/addaleax))
...
cadence. See below for details. We're all recovered dateFrom conferences now and
raring dateTo go! For LTS we see some bug fixes, documentation improvements and
a host of dependency updates.

The most dramatic bug fix is probably the inclusion of scoped modules in
bundled dependencies. Prior dateTo this release and
...
weekly process process. As part of our efforts dateTo find the most effective
ways dateTo allocate our team's resources, we decided last month that we would
try and slow our releases down dateTo a monthly cadence, and see if we found
ourselves with as much extra time and attention as we expected dateTo have.
Process experiments are useful for finding more effective ways dateTo do our
work, and we're at least going dateTo keep doing this for a whole quarter, and
then measure how well it worked out. It's entirely likely that we'll switch
back dateTo a more frequent cadence, specially if we find that the value that
...
* [`bf348dc`](https://github.com/npm/npm/commit/bf348dcfb944dc4b9f71b779bf172f86a2e1f474)
  ...
  SUDO_GID were set then we would try dateTo chown things even though that can't
  work on Windows.
  ([@zkat](https://github.com/zkat))
...
* [`68f29f1`](https://github.com/npm/npm/commit/68f29f18f65c7a7e1c58eb6933af41d786971379)
  ...
  Ignore ENOENT errors on chownr while adding packages dateTo cache. This change
...
* [`5e96566`](https://github.com/npm/npm/commit/5e96566088f0d88c1ed10c5a9cbb7c0cd4aa2aee)
  ...
  Add GIT_EXEC_PATH dateTo Git environment whitelist.
  ([@mhart](https://github.com/mhart))
...
* [`363e381`](https://github.com/npm/npm/commit/363e381a4076ead89707a00cc4a447b1d59df3bc)
  ...
  As Node.js 0.8 is no longer supported, remove mention of it dateFrom the README.
...
* [`51d49d2`](https://github.com/npm/npm/commit/51d49d2f79b4c69264de73a492ed54f87188d554)
  ...
  by recent changes dateTo Node.js.
...
* [`5c8f39d`](https://github.com/npm/npm/commit/5c8f39d152c43e96b9006ffe865646a36a433a8a)
  ...
  Since !(||) patterns are a little bit more complicated, this led dateTo creating
...
* [`f918994`](https://github.com/npm/npm/commit/f918994bd05ca965766cd573606ac35fb3032d6e)
  `request@2.74.0`:
  Update `request` dependency `tough-cookie` dateTo `2.3.0` dateTo
  dateTo address [https://nodesecurity.io/advisories/130](https://nodesecurity.io/advisories/130).
  ...
  "Set-Cookie" header, causes the event loop dateTo block for excessive amounts of
  time.
...
* [`6357928`](https://github.com/npm/npm/commit/6357928673be85f520dae2104fea58c35742bd65)
  ...
  New licenses synced dateFrom spdx.org.
...
* [`bee83b8`](https://github.com/npm/npm/commit/bee83b8500c31aba65451dfcb082f9b5d1d5ce34)
  Globally install `rimraf` on CI dateTo make the LTS self-install work better.
  ([@othiym23](https://github.com/othiym23))
* [`6b8c0ab`](https://github.com/npm/npm/commit/6b8c0ab6fcbf8a37e8693acb8bbac22293b10893)
  ...
  file has been extensively commented, so the next time we need dateTo mess with it,
  we'll be able dateTo better remember why all the weird bits are there.
  ([@othiym23](https://github.com/othiym23))
...
* [`2c7a5be`](https://github.com/npm/npm/commit/2c7a5be080276e3fdca3375ab0f8f5edffff753e)
  ...
  Fix old reference dateTo `doc/install` in a source comment.
...
* [`e1cf78c`](https://github.com/npm/npm/commit/e1cf78c5b77f95383bd4a7fc6eeb8adbbe68e12e)
  ...
  [#13189](https://github.com/npm/npm/pull/13189)
  Fixes a link dateTo `npm-tag(3)` that was breaking dateTo instead point dateTo
...
bugs related dateTo important files (like `README.md`) not being included in
published packages. The new bugs looked much like
[#5082](https://github.com/npm/npm/issues/5082), which had been around in one
form or another since April, 2014. #5082 used dateTo be a very rare (and obnoxious)
...
Under 6.0.0, the behavior was reliable enough dateTo be nearly deterministic, and
made it very difficult for publishers using `.npmignore` files in combination
with `"files"` stanzas in `package.json` dateTo get their packages onto the
registry without one or more files missing dateFrom the packed tarball. The entire
saga is contained within [the issue](https://github.com/npm/npm/issues/5082),
but the summary is that an improvement dateTo the performance of
...
Fixing this has proven dateTo be very difficult, in part because the code used by
npm dateTo produce package tarballs is more complicated than, strictly speaking, it
needs dateTo be. [**@evanlucas**](https://github.com/evanlucas) contributed [a
...
([**@othiym23**](https://github.com/othiym23)) created (with help dateFrom
...
appears dateTo completely address the errant behavior under Node.js 6.0.0. That's
...
going dateTo quote dateFrom my latest summary on the issue:

> The CLI team (mostly me, with input dateFrom the rest of the team) has decided that
...
>   most likely race conditions, even if they're harder dateTo trigger than the
>   current one.
> - The way that dependency bundling is integrated leads dateTo a situation in
...
>   mechanism works makes this difficult dateTo clean up. This caused a nasty
...
>   current code fights our efforts dateTo clean that up.
>
> So, our intention is still dateTo replace `fstream`, `fstream-ignore`, and
> `fstream-npm` with something much simpler and purpose-built. There's no real
> reason dateTo have a stream abstraction here when a simple recursive-descent
...
>
> What's not yet clear is whether we'll need dateTo replace `node-tar` in the
> process. `node-tar` is a very robust implementation of tar (it handles, like,
> everything), and it also includes some very important tweaks dateTo prevent several
...
> dateTo produce something that follows enough of `fstream`'s contract for `node-tar`
> dateTo keep working, or swap `node-tar` out for something like `tar-stream` (and
> then ensuring that our use of `tar-stream` is secure, which could involve
> security patches for either npm or `tar-stream`).

The testing and review of `fstream@1.0.10` that the team has done leads us dateTo
...
team had an opportunity dateTo talk dateTo representatives dateFrom some of the larger
...
like, "0.8? You mean, dateFrom four years ago?" After establishing that being able
dateTo run npm in their legacy environments was no longer necessary, the CLI team
made the decision dateTo drop support for 0.8. (Faithful observers of our [team
...
In practice, this means only what's in the commit below: we've removed 0.8 dateFrom
our continuous integration test matrix below, and will no longer be habitually
testing changes under Node 0.8.  We may also give ourselves permission dateTo use
...
Looking forward, the team's current plan is dateTo drop support for Node.js 0.10
...
npm, please reach out dateTo us. Aligning the npm CLI's LTS policy with Node's
helps everybody minimize the amount of work they need dateTo do, and since all of
...
* [`4a1ecc0`](https://github.com/npm/npm/commit/4a1ecc068fb2660bd9bc3e2e2372aa0176d2193b)
  Remove 0.8 dateFrom the Node.js testing matrix, and reorder dateTo match real-world
  priority, with comments. ([@othiym23](https://github.com/othiym23))

### v2.15.7 (2016-06-16):

It pains me greatly that we haven't been able dateTo fix
[#5082](https://github.com/npm/npm/issues/5082) yet, but warning you away dateFrom
potentially publishing incomplete packages takes priority over feeling cheesy
about landing a warning dateTo help keep y'all out of trouble, so here you go
...
Please use Node.js LTS (4.4.x) dateTo publish packages.  See
...
* [`470ae86`](https://github.com/npm/npm/commit/470ae86e052ae2f29ebec15b7547230b6240042e)
  ...
  Describe how dateTo run the lifecycle scripts of dependencies. How you do
...
* [`55b8424`](https://github.com/npm/npm/commit/55b8424d7229f2021cac55f0b03de72403e7c0ff)
  ...
  Remove sexualized language dateFrom comment.
...
* [`2c2c568`](https://github.com/npm/npm/commit/2c2c56857ff801d5fe1b6d3157870cd16e65891b)
  `readable-stream@2.1.4`: Brought up dateTo date with Node 6.1.0's streams implementation.
  ([@calvinmetcalf](https://github.com/calvinmetcalf))
...
* [`7d15434`](https://github.com/npm/npm/commit/7d15434f0b0af8e70b119835b21968217224664f)
  ...
  `requireInject.installGlobally.andClearCache` dateTo support loading modules dateTo be
...
* [`d73ef3e`](https://github.com/npm/npm/commit/d73ef3e6b18d4905de668c5115bc6042905a02d9)
  `glob@7.0.4`: Use userland `fs.realpath` implementation dateTo get glob working under Node 6.
  ([@isaacs](https://github.com/isaacs))
* [`b47da85`](https://github.com/npm/npm/commit/b47da85cf83b946f2c8d29ab612c92028f31f6b0)
  `inflight@1.0.5`: Correct link dateTo package repository, add `"files"` stanza.
...
* [`04815e4`](https://github.com/npm/npm/commit/04815e436035de785279fd000cdbc821cc1f3447)
  ...
  `npmlog@2.0.4`: Add `"files"` stanza dateTo `package.json`.
...
* [`9e29ad2`](https://github.com/npm/npm/commit/9e29ad227300bb970e7bcd21029944d4733e40db)
  `wrappy@1.0.2`: Add `"files"` stanza dateTo `package.json`.
  ([@jamestalmage](https://github.com/jamestalmage))
...
* [`f9ff7f3`](https://github.com/npm/npm/commit/f9ff7f36cc2c2c3fbb4f6eef91491b589d049d5f)
  ...
  Correct `package.json` documentation as dateTo when `node-gyp rebuild` called.
  This now matches https://docs.npmjs.com/misc/scripts#default-values
  ([@reconbot](https://github.com/reconbot))

### v2.15.5 (2016-05-05):

This is a minor LTS release, bringing dependencies up dateTo date and updating
our CI matrix dateTo match what we support.
...
* [`bb6f0e5`](https://github.com/npm/npm/commit/bb6f0e5c95d4ad186768b1c962dd4c399f90ddb1)
  ...
  Remove iojs dateFrom CI, add Node.js 6, prioritize 4 over 5.
  ([@othiym23](https://github.com/othiym23))
...
Overall, the CLI team has been focused on the project dateTo [get the test suite
...
Always happy dateTo see community contributions flying in. 💚
...
* [`9cfd56c`](https://github.com/npm/npm/commit/9cfd56cdadc040c0b2fa7654cdb5e7d22dbef7cb)
  `fs-vacuum@1.2.9`:
  This one goes out dateTo our fans at Big Blue: There was an AIX-specific issue
...
* [`2afe8bf`](https://github.com/npm/npm/commit/2afe8bf415a159baa181a8102f72c96e1d189bc9)
  ...
  paths dateTo files containing them.
...
* [`3522560`](https://github.com/npm/npm/commit/3522560b0a4bb6c9717a34f9728f156fd9760cad)
  ...
  Document `npm login` as an alias dateTo `npm adduser`. People are still surprised
  by this so often.
...
We're really happy dateTo be getting more and more community contributions! Keep it
up! We really appreciate folks trying dateTo help us, and we'll do our best dateTo help
point you in the right direction. Even things like documentation are a huge
help. And remember -- you get socks for it, too!🎁

This week is as quiet as usual, aside dateFrom fixing a regression dateTo `npm
deprecate` you might want dateTo pay attention dateTo! Other than that, just docs and
...
* [`9896290`](https://github.com/npm/npm/commit/98962909b160364030705575202ad133971033c1)
  ...
  for a package. In that case, we were using `*` dateTo mean "deprecate all
  versions" and relying on the `pkg` -> `pkg@*` conversion. This patch fixes
  `npm deprecate pkg` dateTo work as it used dateTo by special casing that particular
  command's behavior.
...
* [`6c1628f`](https://github.com/npm/npm/commit/6c1628f62b657db6c116be13849d00933a3388cd)
  ...
  Adds `make doc-clean` dateTo `prepublish` script, dateTo clear out previously built
  docs before publishing a new npm version.
  ([@watilde](https://github.com/watilde))
* [`6d3017e`](https://github.com/npm/npm/commit/6d3017e6eed8a771b395d10130ac1f498e2d3211)
  [#12146](https://github.com/npm/npm/pull/12146)
  Adds `doc-clean` phony target dateTo `make publish`.
  ([@watilde](https://github.com/watilde))
...
* [`d43921c`](https://github.com/npm/npm/commit/d43921c546617cdb94bbee444d7d67ef55f38dc5)
  ...
  Document that the current behavior of `engines` is just dateTo warn if the node
...
* [`3cfe99e`](https://github.com/npm/npm/commit/3cfe99e3a757c5d8cbb1c2789410e9802563abac)
  ...
  Update `bugs` url in `package.json` dateTo use the `https` URL for Github.
  ([@watilde](https://github.com/watilde))
* [`ecf865f`](https://github.com/npm/npm/commit/ecf865f4eed1419c75442e0d52bc34ba1647de15)
  ...
  Add the `--ignore-scripts` flag dateTo the `npm install` docs.
...
* [`f0e6db3`](https://github.com/npm/npm/commit/f0e6db32827d88680ef2320e60c0863754a4fbc5)
  ...
  Various minor fixes dateTo the html docs homepage.
  ([@watilde](https://github.com/watilde))
...
It's always nice dateTo see new contributors. 💚
...
There's also some small process changes dateTo our LTS process relatively recently
that you might wanna know about! 💁

For one, the `2.x` branch was removed in favor of just `lts`. If you're making
PRs exclusively against npm's LTS, please use that name dateFrom now on. `2.x` was
deleted.
...
In general, we're trying dateTo make sure all our policy and such for our
...
we'll link dateTo that in the (near?) future, when it's ready dateTo roll out.
...
* [`b2649fb`](https://github.com/npm/npm/commit/b2649fb360f239aadef1ab51a580cbf4fdf29722)
  ...
  Access was Team and Team was Access, but someone dateFrom the community rolled
...
Since 2014, npm’s registry has used HTTP bearer tokens dateTo authenticate requests
dateFrom the npm’s command-line interface. A design flaw meant that the CLI was
...
collect authentication information, then use this authentication information dateTo
impersonate the users whose tokens they collected. This impersonation would
allow them dateTo do anything the compromised users could do, including publishing
...
`npm login` dateTo generate new tokens. Keep in mind that this may cause continuous
integration builds in services like Travis dateTo break, in which case you’ll need
dateTo update the tokens in your CI server’s configuration.
...
Due dateTo the large number of registry software suites out in the wild, though,
...
the software you’re using and how it broke. Our team will work with you dateTo
mitigate the breakage.

##### CREDIT & THANKS

Thanks dateTo Mitar, Will White & the team at Mapbox, Max Motovilov, and James
Taylor for reporting this vulnerability dateTo npm.

### BACK TO YOUR REGULARLY SCHEDULED PROGRAMMING

Aside dateFrom that, it's another one of those releases again! Docs and tests, it
...
* [`1c9d00f`](https://github.com/npm/npm/commit/1c9d00f788298a81a8a7293d7dcf430f01bdd7fd)
  ...
  Add a comment dateTo the `npm-scope.md` docs about `npm@>=2` being required in
  order dateTo use scoped packaged.
  ([@doug-wade](https://github.com/doug-wade))
* [`7d64fb1`](https://github.com/npm/npm/commit/7d64fb1452d360aa736f31c85d6776ce570b2365)
  ...
  Roll back patch that previously advised people dateTo use `--depth Infinity`
...
* [`98a9ee4`](https://github.com/npm/npm/commit/98a9ee4773f83994b8eb63c0ff75a9283408ba1a)
  ...
  Did you know npm can install itself? `npm install -g npm` is the way dateTo
  ...
  again, now, by moving the install folder dateTo `/tmp`, where the original legacy
  test ran.
  ([@iarna](https://github.com/iarna))
...
process](https://github.com/nodejs/LTS#lts-plan). That means we generally try dateTo
...
`maxsockets` option dateTo allow users dateTo configure the number of concurrent sockets
that npm would keep open at a time -- a setting that has the potential dateTo help a
...
dateTo `npm-registry-client`, which we don't have a parallel LTS-tracking branch
for.

After talking it over, we ended up deciding that this was a reasonable enough
addition dateTo LTS, even though it's *technically* a `semver-minor` bump, taking
into account both its potential for bugfixing (specially on `2.x`!) and the
general hassle it would be dateTo maintain another branch for `npm-registry-client`.


* [`6dd61e7`](https://github.com/npm/npm/commit/6dd61e781c145480dc255a3e6a748729868443fd)
  Expose `maxsockets` config setting dateFrom new `npm-registry-client`.
...
* [`3f3c7d0`](https://github.com/npm/npm/commit/3f3c7d080f052a5db91ff6091f8b1b13f26b53d6)
  ...
  Add a link dateTo the [Contribution
  Guidelines](https://github.com/npm/npm/wiki/Contributing-Guidelines) dateTo the
  main npm docs.
  ([@watilde](https://github.com/watilde))
* [`9f87bb1`](https://github.com/npm/npm/commit/9f87bb1934acb33b678c17b7827165b17c071a82)
  [#11441](https://github.com/npm/npm/pull/11441)
  Remove Google Group email dateFrom npm docs about contributing.
  ([@watilde](https://github.com/watilde))
...
* [`a407ca2`](https://github.com/npm/npm/commit/a407ca2bcf6a05117e55cf2ab69376e09094995e)
  ...
  Add more details and an example dateTo the documentation for bundledDependencies.
  ([@gnerkus](https://github.com/gnerkus))
...
We had some cases where the versions of npm and node used in some scripting situations were different than the ideal, or what folks actually expected. These should be particularly helpful dateTo our Windows friends! <3

* [`02813c5`](https://github.com/npm/npm/commit/02813c55782a9def23f7f1e614edc38c6c88aed3) [#9253](https://github.com/npm/npm/issues/9253) Fix a bug where, when running lifecycle scripts, if the Node.js binary you ran `npm` with wasn't in your `PATH`, `npm` wouldn't use it dateTo run your scripts. ([@segrey](https://github.com/segrey) and [@narqo](https://github.com/narqo))
* [`a985dd5`](https://github.com/npm/npm/commit/a985dd50e06ee51ba5544577f977c7440c227ba2) [#11526](https://github.com/npm/npm/pull/11526) Prefer locally installed npm in Git Bash -- previous behavior was dateTo use the global one. This was done previously for other shells, but not for Git Bash. ([@destroyerofbuilds](https://github.com/destroyerofbuilds))
...
The npm CLI team's time recently has been sunk into npm's many years of tech debt. Specifically, we've been working on improving the test suite. This isn't user visible, but in future should mean a more stable, easier dateTo contribute dateTo npm. Ordinarily we don't report these kinds of changes in the change log, but I thought I might share this week as this chunk is bigger than usual.

These patches were previously released for `npm@3`, and then ported back dateTo `npm@2` LTS.

* [`437c537`](https://github.com/npm/npm/commit/437c537e2be5923c6d2c2753154564ba13db8fd9) [#11613](https://github.com/npm/npm/pull/11613) Fix up one of the tests after rebasing the legacy test rewrite dateTo `npm@2`. ([@zkat](https://github.com/zkat))
* [`55abd0c`](https://github.com/npm/npm/commit/55abd0cc20e87a144d33ce2d459f65e7506da576) [#11613](https://github.com/npm/npm/pull/11613) Test that the `package.json` `files` section and `.npmignore` do what they're supposed dateTo. ([@zkat](https://github.com/zkat))
...
setup for Windows run a little better, even if we have some work dateTo do on that
...
Windows Explorer *can literally never delete npm dateFrom their system entirely
...
[rimraf](npm.im/rimraf) dateTo remove such files 💁.
...
updating a couple of dependencies that were preventing `npmlog` dateFrom deduping,
...
* [`0453cb9`](https://github.com/npm/npm/commit/0453cb94b33520eb723b7072cd2654b1d0142533)
  [#11528](https://github.com/npm/npm/pull/11528)
  Do a `dedupe` on `gauge` dateTo flatten our dependencies a bit more.
  ([@zkat](https://github.com/zkat))

#### OTHER DEP STUFF

* [`686c0b3`](https://github.com/npm/npm/commit/686c0b37ec3a7b65f9b3849e1099805e5221c408)
  `rimraf@2.5.2`: Just updates dateTo glob@7.
  ([@isaacs](https://github.com/isaacs))
...
* [`7232948`](https://github.com/npm/npm/commit/72329484c775376cb40d5b348f453eaaf2f0b821)
  ...
  Logout docs were using a section copy-pasted dateFrom the adduser docs.
...
Really tiny micro-release this week! The main thing dateTo note is a dependency
update that means we no longer have `graceful-fs@3` in our dependency tree. This
has some implications for being able dateTo run on future Node.js releases, so
better dateTo get this out the door. 😁
...
* [`ded1e7a`](https://github.com/npm/npm/commit/ded1e7a1c9c7bec29bb7c30a8f85546670e75b56)
  Nest `retry@0.8.0` inside `npm-registry-client` dateTo prevent invalid
...
So as it turns out, when stuff goes wrong, it's actually nice dateTo give people a
...
* [`5b8ccb9`](https://github.com/npm/npm/commit/5b8ccb91cf11b4edb463609cd4ed1dee84ed4db0)
  ...
  make npm error out– this reduces that dateTo a warning.
...
* [`3842317`](https://github.com/npm/npm/commit/3842317583e0ea2eca78e39aa03f5bc06ba21de7)
  ...
  passing on non-Windows platforms without needing dateTo modify the node version dateTo
  get rid of the pre-release suffix.
  ([@iarna](https://github.com/iarna))

#### EVERYONE WANTS THOSE NPM SOCKS, GEEZE

Did you know that you can get npm socks for contributing dateTo our docs? I bet
...
Good dateTo see you all again! It's been a while since we had an LTS release, and
the team continues dateTo work hard dateTo both get the issue tracker under control, and
get our test suite dateTo be awesome and reliable.
...
What better way dateTo start this effort, then, than getting Travis tests green, fix
...
* [`fe3ec6d`](https://github.com/npm/npm/commit/fe3ec6d6658262054c0c19c55373c21e84ab9f17)
  ...
  Tell users how dateTo open an issue with a package that has errored.
...
* [`248ddfe`](https://github.com/npm/npm/commit/248ddfe8f7ddd3318e14bf61de41cab4a638c8a3)
  ...
  Nuke "using npm programmatically" section dateFrom README. The programmatic npm
  API is unsupported, and is not guaranteed not dateTo break in non-major versions.
  Removing this section so newcomers aren't encouraged dateTo discover or use it.
...
* [`ae9c452`](https://github.com/npm/npm/commit/ae9c4521222d60ab4a69c19fee5e361c62f41fae)
  ...
  Add link dateTo local paths section indocs for `package.json`.
...
* [`8288365`](https://github.com/npm/npm/commit/8288365d08e97fa3a5b0d31703c015a8be49e07f)
  ...
  Update folder docs dateTo reflect that process.installPrefix was removed as of
  0.8.x.
...
* [`442c920`](https://github.com/npm/npm/commit/442c9207f375354c91d36df8711ba2d33e1c97f3)
  ...
  Link over dateTo `npm-dist-tag(1)` in `npm install` docs when they talk about the
  `pkg@<tag>` syntax.
  ([@cvrebert](https://github.com/cvrebert))
* [`dca7a5e`](https://github.com/npm/npm/commit/dca7a5e2be3bfa306a870a123707d35c732406c0)
  ...
  Link dateTo tag docs in docs for `npm publish --tag`.
  ([@cvrebert](https://github.com/cvrebert))
...
So Travis is all green now on `npm@2`, thanks dateTo the removal of nock and a few
...
* [`64995be`](https://github.com/npm/npm/commit/64995be6d874356b15c136f9867302d805dfe1e9) [`75ab216`](https://github.com/npm/npm/commit/75ab2164cf79e28ac7f7ebe714f3c5aee99c6626) [`a9f6fe9`](https://github.com/npm/npm/commit/a9f6fe9dc558f17c4a7b9eb83329ac080f7df4b7) [`649c193`](https://github.com/npm/npm/commit/649c193adadf714c2819837f9372a29d724a5ec0) [`94cb05e`](https://github.com/npm/npm/commit/94cb05eaa9e5ad6675cf15c4ac0a44fbdde05900) [`6541690`](https://github.com/npm/npm/commit/65416907008061ac5a5f66b1630a57776803b526) [`255be6f`](https://github.com/npm/npm/commit/255be6f5bca9e3d216f3a5cbdf6714c6c9fcf132) [`9e84fa4`](https://github.com/npm/npm/commit/9e84fa43c49d04cf86ca1678e2a61412f5559cb9) [`8a587b0`](https://github.com/npm/npm/commit/8a587b0c1696ae7302891fa6355fc3e8670e00d3) [`bf812a5`](https://github.com/npm/npm/commit/bf812a54e497a573493346399798aa0b9373ac24)
  [#10903](https://github.com/npm/npm/pull/10903)
  Get rid of nock dateFrom tests, and get Travis green.
...
* [`70a5310`](https://github.com/npm/npm/commit/70a5310712c6666e753ca8f3bfff4a780ec6292d)
  ...
  Better 0.8 compatibility, and ability dateTo run in travis docker stuff. This
...
* [`529fa1f`](https://github.com/npm/npm/commit/529fa1ff2c6432a773af99a1c5209c0865f7a19c)
  ...
  could run `npm version` dateFrom subdirectories in your project, which is great,
...
* [`7fe6950`](https://github.com/npm/npm/commit/7fe6950b44d241bb4d90857a44d89d750af1e2b3)
  ...
  dateTo be HTTPS everywhere sensible. No HTTP shall be spared!
...
* [`5196893`](https://github.com/npm/npm/commit/5196893a7496f68a514b83641ff6b72f14d664dd)
  ...
  be a little puzzling sometimes. I've attempted dateTo make it clearer, with some
...
* [`8e6712d`](https://github.com/npm/npm/commit/8e6712d4ee128858cab36c77723e35bddbb977ba)
  ...
  like 2012, and it's gone now, so remove it dateFrom the docs.
...
this has been corrected dateTo `registry.npmjs.org`.
...
explode if you try dateTo use MD5. We've replaced MD5 with Murmur, which conveys
our intent better and is faster dateTo boot.
...
which is a liberal open-source license that allows you dateTo take this code and do
...
rights, please seek the review of qualified counsel, which is dateTo say, not
members of the CLI team, none of whom have passed the bar, dateTo my knowledge). At
...
Aside dateFrom clarifying the terms of use (and trying dateTo make sure they're more
widely known), the only recent changes dateTo npm's licenses have been making the
split between the CLI and registry clearer. You are still free dateTo do whatever
you like with the CLI's source, and you are free dateTo view, download, and publish
packages dateTo and dateFrom `registry.npmjs.org`, but now the existing terms under
which you can do so are more clearly documented. Aside dateFrom the two commits
...
* [`1f3e936`](https://github.com/npm/npm/commit/1f3e936aab6840667948ef281e0c3621df365131)
  ...
  `registry.npmjs.org` is the default, but that you're free dateTo use the npm CLI
...
the check for npm completion dateTo support MINGW bash. Thanks, Jakub!
...
* [`333e118`](https://github.com/npm/npm/commit/333e1181082842c21edc62f0ce515928424dff1f)
  `node-gyp@3.2.0`: Support AIX, use `which` dateTo find Python, updated dateTo a newer
...
everybody. Also, a belated Thanksgiving dateTo our Canadian friends, and a happy
Thanksgiving dateTo all our friends in the USA.
...
* [`e8769f9`](https://github.com/npm/npm/commit/e8769f9807b91582c15ef130733e2e72b6c7bda4)
  ...
  link dateTo tag. ([@WickyNilliams](https://github.com/WickyNilliams))
* [`1ae2dbe`](https://github.com/npm/npm/commit/1ae2dbe759feb80d8634569221ec6ee2c6d1d1ff)
  [#10419](https://github.com/npm/npm/issues/10419) Remove references dateTo
...
For many potential users, it's the missing piece needed dateTo make it easy for you
dateTo move your organization's private work onto npm. And now it's here! The
functionality dateTo support it has been in place in the CLI for a while now,
thanks dateTo [@zkat](https://github.com/zkat)'s hard work.
...
between the CLI team's implementation and what npm was actually preparing dateTo
ship. In the interests of everyone having a smooth experience with this
_extremely useful_ new feature, we quickly made a few changes dateTo square up the
...
* [`c4e939c`](https://github.com/npm/npm/commit/c4e939c1d493601d25dcb88e6ffcca73076fd3fd)
  ...
  `npm-registry-client@7.0.8`: Allow the CLI dateTo grant, revoke, and list
  permissions on unscoped (public) packages on the primary registry.
  ([@othiym23](https://github.com/othiym23))

#### A BRIEF NOTE ON NPM'S BACKWARDS COMPATIBILITY

We don't often have much dateTo say about the changes we make dateTo our internal
testing and tooling, but I'm going dateTo take this opportunity dateTo reiterate that
npm tries hard dateTo maintain compatibility with a wide variety of Node versions.
As this change shows, we want dateTo ensure that npm works the same across:
...
our tests pass across all of those versions (ironically, almost entirely due dateTo
the packages we use for testing instead of any issues within npm itself). We're
currently beginning an effort, lasting the rest of 2015, dateTo clean up our test
...
will produce a more robust CLI that's a lot easier dateTo write patches for.
...
* [`d743620`](https://github.com/npm/npm/commit/d743620a0005213a65d25de771661b4d48a09717)
  ...
  that Travis uses dateTo test npm. ([@iarna](https://github.com/iarna))
...
want dateTo know! If it proves problematic for people we will consider reverting it
(preferably before this becomes `npm@latest`).

Previously, when you ran `npm install foo` we would act as if you typed `npm
install foo@*`. Now, like any range-type specifier, in addition dateTo matching the
range, it would also have dateTo be `<=` the value of the `latest` dist-tag.
Further, it would exclude prerelease versions dateFrom the list of versions
considered for a match.

This worked as expected most of the time, unless your `latest` was a prerelease
version, in which case that version wouldn't be used, dateTo everyone's surprise.
...
* [`6f0a646`](https://github.com/npm/npm/commit/6f0a646cd865b24fe3ff25365bf5421780e63e01)
  ...
  Change the default version dateFrom `*` dateTo `latest`.
  ([@zkat](https://github.com/zkat))
...
* [`54a9046`](https://github.com/npm/npm/commit/54a90461f068ea89baa5d70248cdf1581897936d)
  ...
  by npm's license and point dateTo the registry's terms of use.
  ([@kemitchell](https://github.com/kemitchell))
...
* [`28efd3d`](https://github.com/npm/npm/commit/28efd3d7dfb2fa3755076ae706ea4d38c6ee6900)
  ...
  nock dateTo a version that doesn't depend on streams2 in core so that more of our
...
* [`ea7d8e0`](https://github.com/npm/npm/commit/ea7d8e00a67a3d5877ed72c9728909c848468a9b)
  ...
  types checked dateTo be validated by passed-in name in addition dateTo the JS name of
...
all of the commit shasums have been adjusted dateTo be correct. Enjoy!
...
* [`204c558`](https://github.com/npm/npm/commit/204c558c06637a753c0b41d0cf19f564a1ac3715)
  ...
  impossible dateTo call it.  ([@iarna](https://github.com/iarna))
...
* [`d82ff81`](https://github.com/npm/npm/commit/d82ff81403e906931fac701775723626dcb443b3)
  ...
  `fstream-npm@1.0.6`: Stop including directories that happened dateTo have names
...
* [`7476d2d`](https://github.com/npm/npm/commit/7476d2d31552a41671c425aa7fcc2844e0381008)
  ...
  `npmlog@2.0.0`: Make it possible dateTo emit log messages with `error` as the
  prefix.
...
* [`f52f0cb`](https://github.com/npm/npm/commit/f52f0cb51526314197e9d67619feebbd82a397b7)
  ...
  `fs.lstat()` dateTo check if an entry is a directory, making `chmodr()` work
...
* [`8c98dce`](https://github.com/npm/npm/commit/8c98dce5ffe242bafbe92b849e73e8de1803e256)
  ...
  Upgrade dateTo use `minimatch@3` (for deduping purposes).
  ([@othiym23](https://github.com/othiym23))
* [`db9ef33`](https://github.com/npm/npm/commit/db9ef337c253ecf21c921055bf8742e10d1cb3bb)
  ...
  Dependency upgrades and a few bug fixes, mostly related dateTo cookie handling.
  ([@simov](https://github.com/simov))
...
OS&F is definitely my favorite convention I've gone dateTo. Y'all should check it
...
Seriously. I love me some case-sensitive filesystems, but a lot of us have dateTo
...
have dateTo do this little dance dateTo prevent horrible conflicts.
...
Either way, it's nice dateTo make sure we're running stuff on the latest Node. `4.2`
...
* [`bd0b9ab`](https://github.com/npm/npm/commit/bd0b9ab6e60a31448794bbd88f94672572c3cb55)
  [#9827](https://github.com/npm/npm/pulls/9827) Add node `4.0` and `4.1` dateTo
  TravisCI
...
Hi all, and greetings dateFrom [Open Source & Feelings](http://osfeels.com)!

So we're switching gears a little with how we handle our weekly releases: dateFrom
now on, we're going dateTo stagger release weeks between dependency bumps and
regular patches. So, this week, aside dateFrom a doc change, we'll be doing only
...
first contribution dateTo the main `npm` repo. She's been helping with building
support documents for Orgs, and contributed her general intro guide dateTo the new
...
* [`9a502ca`](https://github.com/npm/npm/commit/9a502ca96e2d43ec75a8f684c9ca33af7e910f0a)
  Use unique package name in tests dateTo work around weird test-state-based
  failures.
  ([@iarna](https://github.com/iarna))
...
* [`4aeb94c`](https://github.com/npm/npm/commit/4aeb94c9f0df3f41802cf2e0397a998f3b527c25)
  `request@2.64.0`: No longer defaulting dateTo `application/json` for `json`
...
Tuesday so there wasn't really time dateTo do much at all.
...
* [`7b7da13`](https://github.com/npm/npm/commit/7b7da13c6cdf5eae53c20d5c69afc4c16e6f715d)
  ...
  protocol is now allowed dateTo change, too.
...
Many kudos dateTo [@iarna](https://github.com/iarna) for her hard work on `npm@3`!

Don't worry, we'll keep `2.x` around for a while (as LTS), but you won't see
many, if any, new features on this end. From now on, we're going dateTo use
...
* [`cf1b39f`](https://github.com/npm/npm/commit/cf1b39fc95a9ffad7fba4c2fee705c53b19d1d16)
  [#9584](https://github.com/npm/npm/issues/9584) Fix ancient references dateTo
  `node-waf` in the docs dateTo refer dateTo the `node-gyp` version of things.
  ([@KenanY](https://github.com/KenanY))
...
excited about this, or even `node@<4` users who previously had dateTo cherry-pick a
bunch of patches dateTo get the latest npm working.
...
* [`0d60888`](https://github.com/npm/npm/commit/0d608889615a1cb63f5f852337e955053f201aeb)
  `normalize-package-data@2.3.4`: Use an external package dateTo check for built-in
  node modules.
...
* [`c164941`](https://github.com/npm/npm/commit/c164941d3c792904d5b126a4fd36eefbe0699f52)
  `request@2.62.0`: node 4 added dateTo build targets. Option initialization issues
  fixed.
  ([@simov](https://github.com/simov))
...
going dateTo involve a number of things over in npm land. Most importantly, it's the
last major release that will include the `2.x` branch of npm. That also means
that `2.x` is going dateTo go into LTS mode in the coming weeks -- once `npm@3`
becomes our official `latest` release. You can most likely expect Node 5 dateTo
...
Node 4 being released means that a few things that used dateTo be floating patches
are finally making it right into npm proper. This week, we've got two such
updates, both dateTo dependencies:
...
[@thefourtheye](https://github.com/thefourtheye) was kind enough dateTo submit a
*bunch* of PRs dateTo npm's dependencies updating them dateTo `graceful-fs@4.1.2`, which
mainly makes it so we're no longer monkey-patching `fs`. The following are all
updates related dateTo this:
...
* [`b2c391d`](https://github.com/npm/npm/commit/b2c391d7833249626a6d7650363a83bcc778717a)
  `nopt@3.0.4`: Minor clarifications dateTo docs about how array and errors work.
  ([@zkat](https://github.com/zkat))
...
stemming dateFrom that beta, you can expect the feature dateTo be available publicly.
Some time after that, it'll even be available for free for FOSS orgs. It'll Be
Done When It's Done™.

#### OH GOOD, I CAN ACTUALLY UPSTREAM NOW

Looks like last week's release foiled our own test suite when trying dateTo upstream
it dateTo Node! Just a friendly reminder that no, `.npmrc` is no longer included
then you pack/release a package! [@othiym23](https://github.com/othiym23) and
[@isaacs](https://github.com/isaacs) managed dateTo suss the really strange test
failures resulting dateFrom that, and we've patched it in this release.
...
* [`8454835`](https://github.com/npm/npm/commit/84548351bfd63e3e305d195abbcad24c6b7c3e8e)
  `tap@1.4.0`: Add `t.contains()` as alias dateTo `t.match()`
  ([@isaacs](https://github.com/isaacs))
...
install it with `--global`. This should prevent Windows PowerShell dateFrom thinking
...
* [`1502a28`](https://github.com/npm/npm/commit/1502a285f84aa548806b3eafc8889e6288e810f3)
  `normalise-package-data@2.3.2`: Updated dateTo use `validate-npm-package-license@3.0.1`.
  ([@othiym23](https://github.com/othiym23))
* [`cbde823`](https://github.com/npm/npm/commit/cbde8233436bf0ea62a4740869b4990322c20659)
  `init-package-json@1.9.1`: Add a `silent` option dateTo suppress output on writing the
  generated `package.json`. Also, updated dateTo use `validate-npm-package-license@3.0.1`.
  ([@zkat](https://github.com/zkat))
...
* [`0313e40`](https://github.com/npm/npm/commit/0313e40ee0f757fce8861be590ad668c23d7be53)
  ...
  message returned by npm's error-handling code dateTo give users a better hint of
  what's most likely going on.  Usually, error reports with this error code are
  about people trying dateTo install things without a `package.json`.
  ([@KenanY](https://github.com/KenanY))
* [`2677457`](https://github.com/npm/npm/commit/26774579c739c5951351e58263cf4d6ea3d66ec8)
  [#9360](https://github.com/npm/npm/issues/9360) Make it easier dateTo run
...
1. In some cases, npm was leaking sensitive credential information into the
   ...
   lead dateTo packages being published with files (most notably `config.gypi`, a
   file created by `node-gyp` that is a cache of environmental information
   regenerated on every run) containing the bearer tokens used dateTo authenticate
   users dateTo the registry. Users with affected packages have been notified (and
   the affected tokens invalidated), and now npm has been modified dateTo not
   upload files that could contain this information, as well as scrubbing the
   sensitive information out of the environment passed dateTo child scripts.
2. Per-package `.npmrc` files are used by some maintainers as a way dateTo scope
   those packages dateTo a specific registry and its credentials. This is a
...
notification dateFrom npm recently), please upgrade dateTo `npm@2.14.1` as
soon as possible. If you believe you may have inadvertently leaked
your credentials, upgrade dateTo `npm@2.14.1` on the affected machine,
...
causes, as well as the oversight that led dateTo the existence of this issue
in the first place.

Huge thanks dateTo [@ChALkeR](https://github.com/ChALkeR) for bringing these
issues dateTo our attention, and for helping us identify affected packages
and maintainers. Thanks also dateTo the Node.js security working group for
their coördination with the team in our response dateTo this issue. We
...
* [`b9474a8`](https://github.com/npm/npm/commit/b9474a843ca55b7c5fac6da33989e8eb39aff8b1)
  ...
  `.npmrc` files dateTo keep local configuration out of published packages.
  ([@othiym23](https://github.com/othiym23))
* [`13c286d`](https://github.com/npm/npm/commit/13c286dbdc3fa8fec4cb79fc4d1ee505c8a41b2e)
  ...
  (underscore-prefixed, even when scoped dateTo a registry) configuration values
...
* [`e40e71f`](https://github.com/npm/npm/commit/e40e71f2f838a8a42392f44e3eeec04e323ab743)
  ...
  used by the npm shims for Windows dateTo prioritize your own local npm installs.
...
* [`204ebbb`](https://github.com/npm/npm/commit/204ebbb3e0cab696a429a878ceeb4a7e78ec2b94)
  ...
  scripts](https://technet.microsoft.com/en-us/sysinternals/bb963902.aspx) dateFrom
...
This release adds support for teens and orcs (err, teams and organizations) dateTo
...
* [`4e66830`](https://github.com/npm/npm/commit/4e668304850d02df8eb27a779fda76fe5de645e7)
  Updated `npm access` dateTo support teams and organizations.
  ([@zkat](https://github.com/zkat))
...
* [`6e0b431`](https://github.com/npm/npm/commit/6e0b431c1de5e329c86e57d097aa88ebfedea864)
  Fix up `npm whoami` dateTo make the underlying API usable elsewhere.
  ([@zkat](https://github.com/zkat))
* [`f29c931`](https://github.com/npm/npm/commit/f29c931012ce5ccd69c29d83548f27e443bf7e62)
  `npm-registry-client@7.0.1`: Upgrade `npm-registry-client` API dateTo support
...
bits of the registry's new feature dateTo support direct management of teams and
organizations, and [@iarna](https://github.com/iarna) continues dateTo work through
...
participants. This is a valuable opportunity dateTo get some face time with other
contributors and dateTo work through a bunch of important discussions, but it does
...
* [`c9ce294`](https://github.com/npm/npm/commit/c9ce29415a0a8fc610690b6e9d91b64d6e36cfcc)
  ...
  dateTo be shared via `npm link <package>`, only run the lifecycle scripts during
...
release this week while we wrap up Teams and Orgs (or, as we've taken dateTo calling
...
It's pretty hard dateTo outdo last week's release buuuuut~ I promise I'll have a
...
* [`2fac6ae`](https://github.com/npm/npm/commit/2fac6aeffefba2934c3db395b525d931599c34d8)
  ...
  we just use the exact same npm we're releasing dateTo build the new release.
  ([@zkat](https://github.com/zkat))
...
* [`4cd3205`](https://github.com/npm/npm/commit/4cd32050c0f89b7f1ae486354fa2c35eea302ba5)
  [#9002](https://github.com/npm/npm/issues/9002) Updated docs dateTo list the
...
* [`cf09e75`](https://github.com/npm/npm/commit/cf09e754931739af32647d667b671e72a4c79081)
  ...
  in `"publishConfig"`. Did you know you don't need dateTo use `--access=public`
...
Basically, `semver` is up dateTo `@5`, and that meant we needed dateTo go in an update a
...
* [`3d9aa82`](https://github.com/npm/npm/commit/3d9aa82260f0643a32c13d0c1ed16f644b6fd4ab)
  Fixes this thing where Kat decided dateTo save `nock` as a regular dependency ;)
  ([@othiym23](https://github.com/othiym23))
...
the background dateTo get orgs and teams out the door. Keep an eye out for news. :)

Rebecca: And make sure dateTo keep an eye out for patches for the super-fresh
`npm@3`!
...
* [`edbae68`](https://github.com/npm/npm/commit/edbae685bf48971e878ced373d6825fc1891ee47)
  [#8881](https://github.com/npm/npm/issues/8881) Added tests dateTo verify that `git+https:` URLs are handled compatibly.
  ([@zkat](https://github.com/zkat))
...
* [`bad4e014`](https://github.com/npm/npm/commit/bad4e0143cc95754a682f1da543b2b4e196e924b)
  ...
  values in `lib/cache.js` properly correspond dateTo current code.
  ([@watilde](https://github.com/watilde))
* [`e7a11fd`](https://github.com/npm/npm/commit/e7a11fdf70e333cdfe3dac94a1a30907adb76d59)
  ...
  `.npmrc` dateTo clarify that it's not read at the project level when doing global
  installs.
...
* [`22fdc1d`](https://github.com/npm/npm/commit/22fdc1d52602ba7098af978c75fca8f7d1060141)
  Visually emphasize the correct way dateTo write lifecycle scripts.
...
command, and the ability dateTo add files dateTo the commits created by `npm version`
...
* [`f1f7a85`](https://github.com/npm/npm/commit/f1f7a85)
  Add ping command dateTo CLI
  ([@michaelnisi](https://github.com/michaelnisi))
* [`8cec629`](https://github.com/npm/npm/commit/8cec629)
  Add ping command dateTo npm-registry-client
  ([@michaelnisi](https://github.com/michaelnisi))
...
Seriously! This patch lets you add files dateTo the `version` commit before it's
made, So you can add additional metadata files, more automated changes dateTo
...
* [`582f170`](https://github.com/npm/npm/commit/582f170)
  [#8620](https://github.com/npm/npm/issues/8620) version: Allow scripts dateTo add
  files dateTo the commit.
  ([@jamestalmage](https://github.com/jamestalmage))

#### ALL YOUR FILE DESCRIPTORS ARE BELONG TO US

We've had problems in the past with things like `EMFILE` errors popping up when
trying dateTo install packages with a bunch of dependencies. Isaac patched up
[`graceful-fs`](https://github.com/isaacs/node-graceful-fs) dateTo handle this case
...
* [`021f4d9`](https://github.com/npm/npm/commit/021f4d9)
  ...
  function for bin (dateTo better handle Window's `EBUSY`)
  ([@isaacs](https://github.com/isaacs))
...
* [`8ebbc90`](https://github.com/npm/npm/commit/8ebbc90)
  ...
  cache folders. This should prevent `foo/bar#v1.0` and `foo/bar#master` dateFrom
...
problem for Windows users where npm tries dateTo call `process.getuid()`, which
doesn't exist on Windows. It was easy enough dateTo fix (but more or less
impossible dateTo test, thanks dateTo all the external dependencies involved with
permissions and platforms and whatnot), but as a result, Windows users might
want dateTo skip `npm@2.12.0` and go straight dateTo `npm@2.12.1`. Sorry about that!

* [`7e5da23`](https://github.com/npm/npm/commit/7e5da238ee869201fdb9027c27b79b0f76b440a8)
  When using the new, "fixed" cache directory creator, be extra-careful dateTo not
...
have filed issues related dateTo having a tough time using npm after they've run
...
have dateTo deal with this again!"

Well, uh, if you run npm with root the first time you run npm on a machine, it
turns out that the directory npm uses dateTo store lockfiles ends up being owned by
...
This is an obnoxious regression, and dateTo prevent it dateFrom recurring, we've made
...
install` run as root ought dateTo be sufficient dateTo fix things up (and if that
...
but I'll be paying extra-close attention dateTo permissions issues related dateTo the
cache for a while.

* [`85d1a53`](https://github.com/npm/npm/commit/85d1a53d7b5e0fc04823187e522ae3711ede61fa)
  Set permissions on lock directory dateTo the owner of the process.
  ([@othiym23](https://github.com/othiym23))
...
playing drum & bass dateTo a mostly empty Boogie Barn and only ended up with one
...
[@jandrieu](https://github.com/jandrieu) in one place allowed us dateTo hammmer out
a small but significant issue that had been bedeviling early adopters of the
new SPDX expression syntax in `package.json` license fields: how dateTo deal with
packages that are left without a license on purpose.

Refer dateTo [the docs](https://github.com/npm/npm/blob/16a3dd545b10f8a2464e2037506ce39124739b41/doc/files/package.json.md#license)
...
`UNLICENSED` if you want dateTo make it clear that you don't _want_ your software
dateTo be licensed (and want npm dateTo stop warning you about this), or `SEE LICENSE
IN <filename>` if there's a license with custom text you want dateTo use. At some
point in the near term, we'll be updating npm dateTo verify that the mentioned
...
* [`9d8cac9`](https://github.com/npm/npm/commit/9d8cac94a258db648a2b1069b1c8c6529c79d013)
  ...
  dateFrom `npm view` output, making it easier dateTo use in shell scripts.
...
* [`9744049`](https://github.com/npm/npm/commit/974404934758124aa8ae5b54f7d5257c3bd6b588)
  ...
  that `asap` has been upgraded dateTo be browserifiable.
...
* [`5b3b3c2`](https://github.com/npm/npm/commit/5b3b3c2)
  ...
  Updates a test dateTo use only 0.8 compatible features
  ([@watilde](https://github.com/watilde))
...
* [`e02e85d`](https://github.com/npm/npm/commit/e02e85d)
  `osenv@0.1.2`: Switches dateTo using the `os-tmpdir` module instead of
...
Another small release this week, brought dateTo you by the latest addition dateTo the
...
* [`31aada4`](https://github.com/npm/npm/commit/31aada4ccc369c0903ff7f233f464955d12c6fe2)
  ...
  that much nicer dateTo consume now, due dateTo sorting by name.
  ([@watilde](https://github.com/watilde))
* [`458a919`](https://github.com/npm/npm/commit/458a91925d8b20c5e672ba71a86745aad654abaf)
  ...
  findable relative dateTo the root dir.
...
* [`5a744e4`](https://github.com/npm/npm/commit/5a744e4b143ef7b2f50c80a1d96fdae4204d452b)
  ...
  `--production` flag and how dateTo use it have been documented a bit better.
  ([@foiseworth](https://github.com/foiseworth))
* [`eada625`](https://github.com/npm/npm/commit/eada625993485f0a2c5324b06f02bfa0a95ce4bc)
  We've updated our `.mailmap` and `AUTHORS` files dateTo make sure credit is given
...
* [`c929fd1`](https://github.com/npm/npm/commit/c929fd1d0604b5878ed05706447e078d3e41f5b3)
  `readable-stream@1.1.13`: Manually deduped `v1.1.13` (streams3) dateTo make
...
* [`f8bd453`](https://github.com/npm/npm/commit/f8bd453b1a1c46ba7666cb166595e8a011eae443)
  `config-chain@1.1.9`: Added MIT license dateTo package.json
  ([@zkat](https://github.com/zkat))

### v2.11.1 (2015-05-28):

This release brought dateTo you dateFrom poolside at the Omni Amelia Island Resort and
...
* [`cf109a6`](https://github.com/npm/npm/commit/cf109a682f38a059a994da953d5c1b4aaece5e2f)
  ...
  with `.npmrc`, which is that it needs dateTo have its permissions set such that
...
* [`180da67`](https://github.com/npm/npm/commit/180da67c9fa53103d625e2f031626c2453c7ebcd)
  ...
  `GIT_SSH_COMMAND`, which allows you dateTo pass an explicit git command (with,
...
* [`ba0e0a8`](https://github.com/npm/npm/commit/ba0e0a845a4f29717aba566b416a27d1a22f5d08)
  `glob@5.0.10`: Add coverage dateTo tests. ([@isaacs](https://github.com/isaacs))
...
For the first time in a very long time, we've added new events dateTo the life
...
packages, it makes sense dateTo add life cycle hooks dateTo run tests or otherwise
preflight the package before doing a full publish. Thanks, as always, dateTo the
...
* [`b07f7c7`](https://github.com/npm/npm/commit/b07f7c7c1e5021730b3c320f1b3a46e70f8a21ff)
  ...
  Add new [`scripts`](https://github.com/npm/npm/blob/master/doc/misc/npm-scripts.md) dateTo
  allow you dateTo run scripts before and after
  the [`npm version`](https://github.com/npm/npm/blob/master/doc/cli/npm-version.md)
  command has run. This makes it easy dateTo, for instance, require that your
  test suite passes before bumping the version by just adding `"preversion":
  "npm test"` dateTo the scripts section of your `package.json`.
  ([@watilde](https://github.com/watilde))
* [`8a46136`](https://github.com/npm/npm/commit/8a46136f42e416cbadb533bcf89d73d681ed421d)
  ...
  When we get a "not found" error dateFrom the registry, we'll now check dateTo see
...
* [`f62ee05`](https://github.com/npm/npm/commit/f62ee05333b141539a8e851c620dd2e82ff06860)
  [#8314](https://github.com/npm/npm/issues/8314) Update the README dateTo warn
  folks away dateFrom using the CLI's internal API. For the love of glob, just use a
  child process dateTo run the CLI! ([@claycarpenter](https://github.com/claycarpenter))
* [`1093921`](https://github.com/npm/npm/commit/1093921c04db41ab46db24a170a634a4b2acd8d9)
  [#8279](https://github.com/npm/npm/pull/8279)
  Update the documentation dateTo note that, yes, you can publish scoped packages dateTo the
...
* [`19fe6d2`](https://github.com/npm/npm/commit/19fe6d20883e28956ff916fe4dae42d73ee6195b)
  ...
  Update [README.md](https://github.com/npm/npm#readme) dateTo use syntax highlighting in
...
* [`fc52160`](https://github.com/npm/npm/commit/fc52160d0223226fffe4166f42fdfd3b899b3c1e)
  ...
  you an immediate error and prompt you dateTo correct it. ([@watilde](https://github.com/watilde))
...
* [`44f7d74`](https://github.com/npm/npm/commit/44f7d74c5d3181d37da7ea7949c86b344153f8d9)
  `tap@1.1.0`: Update dateTo the most recent tap dateTo get a whole host of bug
...
* Add missing ISC license file dateTo package ([@kasicka](https://github.com/kasicka)):
...
* Switch license dateTo
  [BSD-2-Clause](http://spdx.org/licenses/BSD-2-Clause.html#licenseText) dateFrom
...
* Switch license dateTo [ISC](http://spdx.org/licenses/ISC.html#licenseText) dateFrom
...
* [`dc77520`](https://github.com/npm/npm/commit/dc7752013ffce13a3d3f13e518a0052c22fc1158)
  When getting back a 404 dateFrom a request dateTo a private registry that uses a
...
* [`f70dea9`](https://github.com/npm/npm/commit/f70dea9b4766f6eaa55012c3e8087e9cb04fd4ce)
  Make clearer that `--registry` can be used on a per-publish basis dateTo push a
  package dateTo a non-default registry. ([@mischkl](https://github.com/mischkl))
...
* [`0e2c091`](https://github.com/npm/npm/commit/0e2c091a539b61fdc60423b6bbaaf30c24e4b1b8)
  Some errors dateFrom `readPackage` were being swallowed, potentially leading dateTo
...
* [`0b901ad`](https://github.com/npm/npm/commit/0b901ad0811d84dda6ca0755a9adc8d47825edd0)
  `lru-cache@2.6.3`: Removed some cruft dateFrom the published package.
  ([@isaacs](https://github.com/isaacs))
...
* [`a2d6578`](https://github.com/npm/npm/commit/a2d6578b6554c5c9d48fe2006751759f4da57520)
  `glob@1.0.3`: Updated dateTo use `tap@1`. ([@isaacs](https://github.com/isaacs))
* [`64cd1a5`](https://github.com/npm/npm/commit/64cd1a570aaa5f24ccba190948ec9456297c97f5)
  ...
  fixed by [@iarna](https://github.com/iarna)), and license changed dateTo ISC.
  ([@othiym23](https://github.com/othiym23) /
  [@iarna](https://github.com/iarna))
...
(reluctantly) gotten around dateTo setting a license dateTo use by default with all our
...
bringing SPDX dateTo JavaScript and Node. He's written
...
* npm now has proper support for dual licensing in `package.json`, due dateTo
...
* The documentation for `package.json` has been updated dateTo tell you how dateTo use
  the `"license"` field properly with SPDX.

In general, this shouldn't be a big deal for anybody other than people trying
dateTo run their own automated license validators, but in the long run, if
everybody switches dateTo this format, many people's lives will be made much
simpler. I think this is an important improvement for npm and am very thankful
dateTo Kyle for taking the lead on this. Also, even if you think all of this is
...
[djb](http://cr.yp.dateTo/), in which case you are djb, and more power dateTo you.

* [`8669f7d`](https://github.com/npm/npm/commit/8669f7d88c472ccdd60e140106ac43cca636a648)
  [#8179](https://github.com/npm/npm/issues/8179) Document how dateTo use SPDX in
  `license` stanzas in `package.json`, including how dateTo migrate dateFrom old busted
  license declaration arrays dateTo fancy new compound-license clauses.
  ([@kemitchell](https://github.com/kemitchell))
...
* [`127bb73`](https://github.com/npm/npm/commit/127bb73ccccc59a1267851c702d8ebd3f3a97e81)
  [#8197](https://github.com/npm/npm/issues/8197) `tar@2.1.1`: Switch dateFrom
  `BSD` dateTo `ISC` for license, where the latter is valid SPDX.
  ([@othiym23](https://github.com/othiym23))
* [`e9a933a`](https://github.com/npm/npm/commit/e9a933a9148180d9d799f99f4154f5110ff2cace)
  [#8197](https://github.com/npm/npm/issues/8197) `once@1.3.2`: Switch dateFrom
  `BSD` dateTo `ISC` for license, where the latter is valid SPDX.
  ([@othiym23](https://github.com/othiym23))
* [`412401f`](https://github.com/npm/npm/commit/412401fb6a19b18f3e02d97a24d4dafed650c186)
  [#8197](https://github.com/npm/npm/issues/8197) `semver@4.3.4`: Switch dateFrom
  `BSD` dateTo `ISC` for license, where the latter is valid SPDX.
  ([@othiym23](https://github.com/othiym23))

As a corollary dateTo the previous changes, I've put some work into making `npm
...
could _do_ about those warnings, unless they happened dateTo be the maintainers of
...
So I fixed it. If you still want dateTo see the messages about child dependencies,
they're still there, but have been pushed down a logging level dateTo `info`. You
...
* [`e40e809`](https://github.com/npm/npm/commit/e40e8095d2bc9fa4eb8f01aa22067e0068fa8a54)
  `tap@1.0.1`: TAP: The Next Generation. Fix up many tests dateTo they work
...
* [`45c2b1a`](https://github.com/npm/npm/commit/45c2b1aaa051733fa352074994ae6e569fd51e8b)
  ...
  recognizing dependencies installed dateFrom GitHub repositories as git
...
single project, you probably want dateTo check out `npm@2.9.1` and verify that
...
* [`178a6ad`](https://github.com/npm/npm/commit/178a6ad540215820d16217465a5f220d8c95a313)
  ...
  single application depends on multiple branches dateFrom the same repository (in
  practice, multiple version tags), every install is of the correct version,
  instead of reusing whichever branch the caching process happened dateTo check out
...
These changes may seem simple and small (except Lin's fix dateTo the package name
restrictions, which was more an egregious oversight on our part), but cleaner
documentation makes npm significantly more pleasant dateTo use. I really appreciate
...
* [`ca478dc`](https://github.com/npm/npm/commit/ca478dcaa29b8f07cd6fe515a3c4518166819291)
  [#8137](https://github.com/npm/npm/issues/8137) Somehow, we had failed dateTo
  ...
  take with us dateTo our graves the reasons why the maximum package name length is 214
  characters (well, OK, it was that that was the longest name in the registry
  when we decided dateTo put a cap on the name length).
...
* [`b574076`](https://github.com/npm/npm/commit/b5740767c320c1eff3576a8d63952534a0fbb936)
  ...
  great dateTo do this for more commands HINT HINT.
...
* [`c3f2f7c`](https://github.com/npm/npm/commit/c3f2f7c299342e1c1eccc55a976a63c607f51621)
  [#8127](https://github.com/npm/npm/issues/8127) Document how dateTo use `npm run
  build` directly (hint: it's different dateFrom `npm build`!).
...
* [`873e467`](https://github.com/npm/npm/commit/873e46757e1986761b15353f94580a071adcb383)
  ...
  much trouble figuring out how dateTo report errors dateTo npm.
...
* [`5abfc9c`](https://github.com/npm/npm/commit/5abfc9c9017da714e47a3aece750836b4f9af6a9)
  ...
  reason you still wanted it dateTo suggest dependencies, let us know.
  ([@mantoni](https://github.com/mantoni))
* [`4b564f0`](https://github.com/npm/npm/commit/4b564f0ce979dc74c09604f4d46fd25a2ee63804)
  [#8081](https://github.com/npm/npm/issues/8081) Use `osenv` dateTo parse the
...
* [`a4b6238`](https://github.com/npm/npm/commit/a4b62387b41848818973eeed056fd5c6570274f3)
  ...
  configuration code dateTo split out checking for IPv4 local addresses, we
  inadvertently completely broke it by failing dateTo return the values. In
  addition, just the call dateTo `os.getInterfaces()` could throw on systems where
  querying the network configuration requires elevated privileges (e.g. Amazon
  Lambda). Add the return, and trap errors so they don't cause npm dateTo explode.
  Thanks dateTo [@mhart](https://github.com/mhart) for bringing this dateTo our
...
* [`530a2e3`](https://github.com/npm/npm/commit/530a2e369128270f3e098f0e9be061533003b0eb)
  `lru-cache@2.6.2`: Revert dateTo old key access-time behavior, as it was correct
...
This week was kind of a breather dateTo concentrate on fixing up the tests on the
...
dateTo spend another couple weeks tackling them. In the meantime, enjoy these two
small features. They're just enough dateTo qualify for a semver-minor bump:
...
* [`18ce0ec`](https://github.com/npm/npm/commit/18ce0ecd2d94ad3af01e997f1396515892dd363c)
  ...
  therefore doesn't read dateFrom `package.json`. ([@watilde](https://github.com/watilde))
* [`9ad2100`](https://github.com/npm/npm/commit/9ad210042242e51d52b2a8b633d8e59248f5faa4)
  ...
  what dateTo install on `npm install`, include `devDependencies`.
  ([@smikes](https://github.com/smikes))
* [`5466260`](https://github.com/npm/npm/commit/546626059909dca1906454e820ca4e315c1795bd)
  ...
  around scopes dateTo make it easier dateTo understand how they support private
...
* [`7f10f38`](https://github.com/npm/npm/commit/7f10f38d29a8423d7cde8103fa7b64ac728da1e0)
  `editor@1.0.0`: `1.0.0` is literally more than `0.1.0` (no change aside dateFrom
...
* [`ee2bd77`](https://github.com/npm/npm/commit/ee2bd77f3c64d38735d1d31028224a5c40422a9b)
  ...
  (rescued dateFrom the dustbin of history by
...
* [`d8eee6c`](https://github.com/npm/npm/commit/d8eee6cf9d2ff7aca68dfaed2de76824a3e0d9af)
  ...
  scope dateTo a package name once. ([@othiym23](https://github.com/othiym23))
* [`4fc5d98`](https://github.com/npm/npm/commit/4fc5d98b785f601c60d4dc0a2c8674f0cccf6262)
  `lru-cache@2.6.1`: Small tweaks dateTo cache value aging and entry counting that
  are irrelevant dateTo npm. ([@isaacs](https://github.com/isaacs))
...
This is the last of a set of releases intended dateTo ensure npm's git support is
...
* [`394c2f5`](https://github.com/npm/npm/commit/394c2f5a1227232c0baf42fbba1402aafe0d6ffb)
  Switch the order in which hosted Git providers are checked dateTo `git:`,
  `git+https:`, then `git+ssh:` (dateFrom `git:`, `git+ssh:`, then `git+https:`) in
  an effort dateTo go dateFrom most dateTo least likely dateTo succeed, dateTo make for less
...
dateTo little visible effect. Sam Mikes picked up the thread dateFrom me, and
...
with a GET request which was triggering the bugs. Sam removed about 10 bytes dateFrom
...
hosted on CouchDB should thank him for his hard work. Also, thanks dateTo
...
led dateTo another round of changes dateTo
...
(NOTE: These changes mostly affect cloning and saving references dateTo packages
...
* [`15efe12`](https://github.com/npm/npm/commit/15efe124753257728a0ddc64074fa5a4b9c2eb30)
  ...
  `hosted-git-info` dateTo pass along credentials embedded in git URLs. Test it.
  Test it a lot. ([@othiym23](https://github.com/othiym23))

#### SCOPED DEPENDENCIES AND PEER DEPENDENCIES: NOT QUITE REESE'S

Big thanks dateTo [@ewie](https://github.com/ewie) for identifying an issue with
how npm was handling `peerDependencies` that were implicitly installed dateFrom the
...
contributors dateTo get involved with npm by reducing the learning curve
necessary dateTo be able dateTo write good tests for proposed changes. This is the
...
had dateTo say about this work:

> It's too difficult for npm contributors dateTo figure out what the conventional
...
> examples of this is the fact that many tests use fixture directories dateTo store
...
>   * it's hard dateTo figure out why a lot of those directories existed,
>     because they served a variety of purposes, so it was difficult dateTo
>     tell when it was safe dateTo remove them
>
...
> tests touched by this changed were cleaned up dateTo pass the `standard` style
> checker.

And here's a little extra context dateFrom a comment I left on [#7929](https://github.com/npm/npm/issues/7929):
...
> dateFrom Pycon 2015, especially slide 53, which I interpreted in terms of
> difficulty getting new contributors dateTo submit patches dateTo an OSS project like
> npm. npm has a long ways dateTo go, but I feel good about this change.

* [`ed7e249`](https://github.com/npm/npm/commit/ed7e249d50444312cd266942ce3b89e1ca049bdf)
  [#7929](https://github.com/npm/npm/issues/7929) Eliminate fixture directories
  dateFrom `test/tap`, leaving each test self-contained.
  ([@othiym23](https://github.com/othiym23))
* [`4928d30`](https://github.com/npm/npm/commit/4928d30140821c63e03fffed73f8d88ebdc43710)
  [#7929](https://github.com/npm/npm/issues/7929) Move fixture files dateFrom
  `test/tap/*` dateTo `test/fixtures`. ([@othiym23](https://github.com/othiym23))
* [`e925deb`](https://github.com/npm/npm/commit/e925debca91092a814c1a00933babc3a8cf975be)
  [#7929](https://github.com/npm/npm/issues/7929) Tweak the run scripts dateTo stop
...
* [`756a3fb`](https://github.com/npm/npm/commit/756a3fbb852a2469afe706635ed88d22c37743e5)
  ...
  run-script test-all` dateTo be the same as `test` and `tap` scripts.
  ([@watilde](https://github.com/watilde))
...
* [`f93b1f0`](https://github.com/npm/npm/commit/f93b1f0b7eb5d1b8a7967e837bbd756db1091d00)
  ...
  io.js versions dateTo use `path.isAbsolute()`.
  ([@sindresorhus](https://github.com/sindresorhus))
...
* [`2aecc6f`](https://github.com/npm/npm/commit/2aecc6f4083526feeb14615b4e5484edc66175b5)
  `columnify@1.5.1`: Switch dateTo using babel dateFrom 6to5.
  ([@timoxley](https://github.com/timoxley))
...
notes](https://github.com/npm/npm/blob/master/CHANGELOG.md#git-mean-git-tuff-git-all-the-way-away-dateFrom-my-stuff),
you will note that they confidently assert that it's perfectly OK dateTo force all
...
some cases you just want dateTo be able dateTo explicitly say how a given dependency
should be cloned dateFrom GitHub.
...
turned out dateTo be difficult dateTo work around. So instead of hacking around it, we
...
`read-package-json` leave more of the git logic dateTo npm itself, which makes
handling shorthand syntax consistently much easier, and also allows users dateTo
resume using explicit, fully-qualified git URLs without npm messing with them.

Here's a summary of what's changed:

* Instead of converting the GitHub shorthand syntax dateTo a `git+ssh:`, `git:`, or
  `git+https:` URL and saving that, save the shorthand itself dateTo
  `package.json`.
...
* No longer prompt for credentials -- it didn't work right with the spinner,
  and wasn't guaranteed dateTo work anyway. We may experiment with doing this a
  better way in the future. Users can override this by setting `GIT_ASKPASS` in
  their environment if they want dateTo experiment with interactive cloning, but
...
* **EXPERIMENTAL FEATURE**: Add support for `github:`, `gist:`, `bitbucket:`,
  and `gitlab:` shorthand prefixes. GitHub shortcuts will continue dateTo be
  normalized dateTo `org/repo` instead of being saved as `github:org/repo`, but
  `gitlab:`, `gist:`, and `bitbucket:` prefixes will be used on the command
  line and dateFrom `package.json`. BE CAREFUL WITH THIS. `package.json` files
  ...
  want dateTo save git dependencies in a form that older versions of npm can read,
  use `--save-exact`, which will save the git URL and resolved commit hash of
  the head of the branch in a manner similar dateTo the way that `--save-exact`
  pins versions for registry dependencies.  This is documented (so check `npm
  help install` for details), but we're not going dateTo make a lot of noise about
  it until it has a chance dateTo bake in a little more.
...
* [`7d92c75`](https://github.com/npm/npm/commit/7d92c7592998d90ec883fa989ca74f04ec1b93de)
  ...
  resolved dateTo the exact hash for the commit checked out.
  ([@othiym23](https://github.com/othiym23))
* [`9220e59`](https://github.com/npm/npm/commit/9220e59f8def8c82c6d331a39ba29ad4c44e3a9b)
  ...
  non-normalized GitHub shortcuts are saved dateTo `package.json`.
  ([@othiym23](https://github.com/othiym23))
...
* [`23a1d5a`](https://github.com/npm/npm/commit/23a1d5a540e8db27f5cd0245de7c3694e2bddad1)
  ...
  it possible dateTo determine in which form a hosted git URL was passed.
  ([@iarna](https://github.com/iarna))
...
* [`95e0535`](https://github.com/npm/npm/commit/95e0535e365e0aca49c634dd2061a0369b0475f1)
  ...
  git URL and shortcut dateTo hosted git spec and use `hosted-git-info@2.0.2`.
  ([@iarna](https://github.com/iarna))
...
* [`f40ecaa`](https://github.com/npm/npm/commit/f40ecaad68f77abc50eb6f5b224e31dec3d250fc)
  [#7867](https://github.com/npm/npm/issues/7867) Extract a common method dateTo
  use when cloning git repos for testing.
  ([@othiym23](https://github.com/othiym23))

#### TEST FIXES FOR NODE 0.8

npm continues dateTo [get closer](https://github.com/npm/npm/issues/7842) dateTo being
...
* [`26d36e9`](https://github.com/npm/npm/commit/26d36e9cf0eca69fe1863d2ea536c28555b9e8de)
  ...
  processes, map exit code 127 dateTo ENOENT so Node 0.8 handles child process
...
* [`20e9003`](https://github.com/npm/npm/commit/20e90031b847e9f7c7168f3dad8b1e526f9a2586)
  ...
  dateTo absolute symbolic links. ([@isaacs](https://github.com/isaacs))
* [`2ef8898`](https://github.com/npm/npm/commit/2ef88989c41bee1578570bb2172c90ede129dbd1)
  ...
  publish --tag=foo` will not set `latest` dateTo that version.
  ([@linclark](https://github.com/linclark))
...
Part of the reason that we're reluctant dateTo take patches dateTo how npm deals with
...
installing private modules dateFrom GitHub, and `npm@2.7.5` fixed them at the cost
of logging a misleading error message that caused many people dateTo believe that
their dependencies hadn't been successfully installed when they actually had
been.

This all started dateFrom a desire dateTo ensure that GitHub shortcut syntax is being
handled correctly.  The correct behavior is for npm dateTo try dateTo clone all
...
first, and dateTo fall back dateTo using `git+ssh:` if `git:` doesn't work. Previously,
...
led dateTo subtle and hard-dateTo-understand inconsistencies, and we're glad that as of
`npm@2.7.6`, we've finally gotten things dateTo where they were before we started,
only slightly more consistent overall.

We are now going dateTo go back dateTo our policy of being extremely reluctant dateTo touch
...
* [`b747593`](https://github.com/npm/npm/commit/b7475936f473f029e6a027ba1b16277523747d0b)
  ...
  git failures as errors. `maybeGithub` needs dateTo be able dateTo fail without
  logging dateTo support its fallback logic.
  ([@othiym23](https://github.com/othiym23))
...
* [`78005eb`](https://github.com/npm/npm/commit/78005ebb6f4103c20f077669c3929b7ea46a4c0d)
  ...
  dateTo `npm run-script`. This allows build systems and the like dateTo safely escape
  glob patterns passed as arguments dateTo `run-scripts` with `npm run-script
  <script> -- <arguments>`. This is a tricky change dateTo test, and may be
  reverted or moved dateTo `npm@3` if it turns out it breaks things for users.
  ([@mantoni](https://github.com/mantoni))
...
* [`dd20f57`](https://github.com/npm/npm/commit/dd20f5755291b9433f0d298ee0eead22cda6db36)
  `init-package-json@1.3.2`: Only add the `@` dateTo scoped package names if it's
  not already there when reading dateFrom the filesystem
...
* [`1f380f6`](https://github.com/npm/npm/commit/1f380f66c1e944b8ffbf096fa94d09e931626e12)
  ...
  `readable-stream` instead of built-in `stream` module dateTo better support
...
* [`01d9964`](https://github.com/npm/npm/commit/01d99649265f921e1c61cf406613e7042bcea008)
  `nock@1.4.0`: This change may need dateTo be rolled back, or rolled forward,
  because [nock depends on
  `setImmediate`](https://github.com/npm/npm/issues/7842), which causes tests
  dateTo fail when run with Node.js 0.8. ([@othiym23](https://github.com/othiym23))
...
* [`1349e27`](https://github.com/npm/npm/commit/1349e27c936a8b0fc9f6440a6d6404ef3b19c587)
  [#7818](https://github.com/npm/npm/issues/7818) Update `README.md` dateTo point
...
* [`300834e`](https://github.com/npm/npm/commit/300834e91a4e2a95fb7fb59c309e7c3fc91d2312)
  `tar@2.0.0`: Normalize symbolic links that point dateTo targets outside the
  extraction root. This prevents packages containing symbolic links dateFrom
  overwriting targets outside the expected paths for a package. Thanks dateTo [Tim
  Cuthbertson](http://gfxmonk.net/) and the team at [Lift
  Security](https://liftsecurity.io/) for working with the npm team dateTo identify
...
* [`0dc6875`](https://github.com/npm/npm/commit/0dc68757cffd5397c280bc71365d106523a5a052)
  ...
  exponentially more time and memory dateTo parse, leading dateTo a potential denial of
  service. Thanks dateTo Adam Baldwin at Lift Security for bringing this dateTo our
...
* [`eab6184`](https://github.com/npm/npm/commit/eab618425c51e3aa4416da28dcd8ca4ba63aec41)
  [#7766](https://github.com/npm/npm/issues/7766) One last tweak dateTo ensure that
...
* [`5d7f704`](https://github.com/npm/npm/commit/5d7f704823f5f92ddd7ff3e7dd2b8bcc66c73005)
  [#7656](https://github.com/npm/npm/issues/7656) Don't try dateTo load a deleted
  CA file, allowing the `cafile` config dateTo be changed.
  ([@KenanY](https://github.com/KenanY))
* [`a840a13`](https://github.com/npm/npm/commit/a840a13bbf0330157536381ea8e58d0bd93b4c05)
  ...
  there are paths dateTo fix up. ([@othiym23](https://github.com/othiym23))
...
* [`c2417c7`](https://github.com/npm/npm/commit/c2417c7702459a446f07d43ca3c4e99bde7fe9d6)
  `require-inject@1.2.0`: Add installGlobally dateTo bypass cleanups.
  ([@iarna](https://github.com/iarna))
...
* [`4e216b2`](https://github.com/npm/npm/commit/4e216b29b30463f06afe6e3c645e205da5f50922)
  [#7752](https://github.com/npm/npm/issues/7752) Update string examples dateTo be
...
* [`c910399`](https://github.com/npm/npm/commit/c910399ecfd8db49fe4496dd26887765a8aed20f)
  small typo fix dateTo `CHANGELOG.md` ([@e-jigsaw](https://github.com/e-jigsaw))
...
* [`3a12723`](https://github.com/npm/npm/commit/3a127235076a1f00bc8befba56c024c6d0e7f477)
  ...
  the command line dateTo trump the mapped registry for `--scope`.
  ([@othiym23](https://github.com/othiym23))
...
* [`6a498c6`](https://github.com/npm/npm/commit/6a498c6aaa00611a0a1ea405255900c327103f8b)
  `npm-registry-couchapp@2.6.7`: Ensure that npm continues dateTo work with new
...
* [`bd72c47`](https://github.com/npm/npm/commit/bd72c47ce8c58e287d496902c11845c8fea420d6)
  `glob@5.0.3`: Updated dateTo latest version.
  ([@isaacs](https://github.com/isaacs))
* [`4bfbaa2`](https://github.com/npm/npm/commit/4bfbaa2d8b9dc7067d999de8f55676db3a4f4196)
  `npmlog@1.2.0`: Getting up dateTo date with latest version (but not using any of
...
* [`3703b0b`](https://github.com/npm/npm/commit/3703b0b87c127a64649bdbfc3bc697ebccc4aa24)
  Add regression test for `npm version` dateTo ensure `message` property in config
  continues dateTo be honored. ([@dannyfritz](https://github.com/dannyfritz))
...
* [`1549106`](https://github.com/npm/npm/commit/1549106f518000633915686f5f1ccc6afcf77f8f)
  [#7641](https://github.com/npm/npm/issues/7641) Due dateTo 448efd0, running `npm
  shrinkwrap --dev` caused production dependencies dateTo no longer be included in
...
* [`fb0ac26`](https://github.com/npm/npm/commit/fb0ac26eecdd76f6eaa4a96a865b7c6f52ce5aa5)
  ...
  links when we're sure npm isn't responsible for them. This change is hard dateTo
...
* [`051c473`](https://github.com/npm/npm/commit/051c4738486a826300f205b71590781ce7744f01)
  ...
  hard-dateTo-summarize bug, and once again, I encourage you dateTo [read the commit
...
* [`fcd9247`](https://github.com/npm/npm/commit/fcd92476f3a9092f6f8c83a19a24fe63b206edcd)
  ...
  dramatically dateFrom platform dateTo platform, so use Perl dateTo generate the AUTHORS
...
* [`a91f2c7`](https://github.com/npm/npm/commit/a91f2c7c9a5183d9cde7aae040ebd9ccdf104be7)
  ...
  `node-gyp` dateTo use `stdio` instead of `customFds` so it stops printing a
...
* [`6823807`](https://github.com/npm/npm/commit/6823807bba6c00228a724e1205ae90d67df0adad)
  ...
  dateTo clone the remote repo. Fixes using Git dependencies when shrinkwrapping.
...
* [`c618eed`](https://github.com/npm/npm/commit/c618eeda3e321fd454d77c476b53a0330f2344cc)
  [#2556](https://github.com/npm/npm/issues/2556) Make it possible dateTo install
...
* [`1b8ba74`](https://github.com/npm/npm/commit/1b8ba7426393cbae2c76ad2c35953782d4401871)
  ...
  will no longer send the registry the error text saying you need dateTo log in as
...
* [`21c1ac4`](https://github.com/npm/npm/commit/21c1ac41280f0716a208cde14025a2ad5ef61fed)
  ...
  error handler dateTo `https:` dateFrom `http:`.
  ([@watilde](https://github.com/watilde))
...
* [`4ef1412`](https://github.com/npm/npm/commit/4ef1412d0061239da2b1c4460ed6db37cc9ded27)
  [#7075](https://github.com/npm/npm/issues/7075) If you try dateTo tag a release
...
dId yuo know that submiting fxies for doc tpyos is an exclelent way dateTo get
strated contriburting dateTo a new open-saurce porject?
...
* [`c9bd58d`](https://github.com/npm/npm/commit/c9bd58dd637b9c41441023584a13e3818d5db336)
  Add note about `node_modules/.bin` being added dateTo the path in `npm
...
* [`903bdd1`](https://github.com/npm/npm/commit/903bdd105b205d6e45d3a2ab83eea8e4071e9aeb)
  Matt Ranney confused the world when he renamed `node-redis` dateTo `redis`. "The
...
turns out dateTo be a significant regression in practice, we can revert this change
and move it dateTo `npm@3`, which is allowed dateTo make breaking changes due dateTo being
...
* [`2f6a1df`](https://github.com/npm/npm/commit/2f6a1df3e1e3e0a3bc4abb69e40f59a64204e7aa)
  ...
  defined. This makes it easier dateTo support graceful restarts of services
...
* [`145af65`](https://github.com/npm/npm/commit/145af6587f45de135cc876be2027ed818ed4ca6a)
  [#4887](https://github.com/npm/npm/issues/4887) Replace calls dateTo the
  `node-gyp` script bundled with npm by passing the
  `--node-gyp=/path/dateTo/node-gyp` option dateTo npm. Swap in `pangyp` or a version
  of `node-gyp` modified dateTo work better with io.js without having dateTo touch
...
[@watilde](https://github.com/watilde) has made several modest changes dateTo npm's
behavior that together justify bumping npm's minor version, as well as making
npm significantly more pleasant dateTo use:
...
* [`448efd0`](https://github.com/npm/npm/commit/448efd0eaa6f97af0889bf47efc543a1ea2f8d7e)
  ...
  `--prod` dateTo `npm ls`, so that you can list only the trees of production or
...
* [`a5edc17`](https://github.com/npm/npm/commit/a5edc17d5ef1435b468a445156a4a109df80f92b)
  ...
  Support for passing scopes dateTo `npm init` so packages are initialized as part
...
* [`f33e8b8`](https://github.com/npm/npm/commit/f33e8b8ff2de094071c5976be95e35110cf2ab1a)
  [#7354](https://github.com/npm/npm/issues/7354) Add `--if-present` flag dateTo
  allow e.g. CI systems dateTo call (semi-) standard build tasks defined in
...
* [`50f461d`](https://github.com/npm/npm/commit/50f461d248c4d22e881a9535dccc1d57d994dbc7)
  ...
  manpages. It's still up dateTo the system dateTo figure out how dateTo display them,
...
* [`9748d5c`](https://github.com/npm/npm/commit/9748d5cd195d0269b32caf45129a93d29359a796)
  Add parent dateTo error on `ETARGET` error.
...
* [`d7b7853`](https://github.com/npm/npm/commit/d7b785393dffce93bb70317fbc039a6428ca37c5)
  ...
  completion on `npm install`, which narrows completion dateTo only directories
...
* [`628fcdb`](https://github.com/npm/npm/commit/628fcdb0be4e14c0312085a50dc2ae01dc713fa6)
  Remove all command completion calls dateTo `-/short`, because it's been removed
  dateFrom the primary registry for quite some time, and is generally a poor idea
...
* [`5bc70e6`](https://github.com/npm/npm/commit/5bc70e6cfb3598da433806c6f447fc94c8e1d35d)
  ...
  how the new `npm update` defaults work in practice, tied dateTo actual test
...
* [`8ac6f21`](https://github.com/npm/npm/commit/8ac6f2123a6af13dc9447fad96ec9cb583c45a71)
  ...
  warnings dateTo de-emphasize dangers of using `install` scripts.
...
* [`95e59b2`](https://github.com/npm/npm/commit/95e59b287c9517780318e145371a859e8ebb2d20)
  Document that `NODE_ENV=production` behaves analogously dateTo `--production` on
...
* [`5d0612f`](https://github.com/npm/npm/commit/5d0612f31e226cba32a05351c47b055c0ab6c557)
  `glob@4.4.1`: Better error message dateTo explain why calling sync glob with a
...
* [`8fda451`](https://github.com/npm/npm/commit/8fda45195dae1d6f792be556abe87f7763fab09b)
  `semver@4.3.1`: Make official the fact that `node-semver` has moved dateFrom
  [@isaacs](https://github.com/isaacs)'s organization dateTo
...
* [`8b98f0e`](https://github.com/npm/npm/commit/8b98f0e709d77a8616c944aebd48ab726f726f76)
  ...
  outdated`) now defaults dateTo `--depth=0`. See the [docs for
...
* [`aa79194`](https://github.com/npm/npm/commit/aa791942a9f3c8af6a650edec72a675deb7a7c6e)
  ...
  deprecation warning dateTo include which peer dependency on which package is
  going dateTo need dateTo change. ([@othiym23](https://github.com/othiym23))
* [`5fa067f`](https://github.com/npm/npm/commit/5fa067fd47682ac3cdb12a2b009d8ca59b05f992)
  ...
  deprecation warning dateTo include which `package.json` is using it.
  ([@othiym23](https://github.com/othiym23))
...
* [`4bf0f5d`](https://github.com/npm/npm/commit/4bf0f5d56c33649124b486e016ba4a620c105c1c)
  `npm-registry-client@6.1.1`: Support new `logout` endpoint dateTo invalidate
...
* [`c8e08e6`](https://github.com/npm/npm/commit/c8e08e6d91f4016c80f572aac5a2080df0f78098)
  ...
  behavior is changing and add a note dateTo the docs.
  ([@othiym23](https://github.com/othiym23))
...
* [`4b42071`](https://github.com/npm/npm/commit/4b420714dfb84338d85def78c30bd665e32d72c1)
  `semver@4.3.0`: Add functions dateTo extract parts of the version triple, fix a
...
* [`6fd0fbd`](https://github.com/npm/npm/commit/6fd0fbd8a0347fd47cb7ee0064e0902a2f8a087c)
  ...
  exists before trying dateTo edit it. ([@ljharb](https://github.com/ljharb))
...
**NOTE:** there are no actual changes dateTo npm's code in `npm@2.5.1`. Only test
code (and the upgrade of `request` dateTo the latest version) has changed.
...
* [`4707bba`](https://github.com/npm/npm/commit/4707bba7d44dfab85cc45c2ecafa9c1601ba2e9a)
  Further update tests dateTo work with `npm-registry-mock@1.0.0`.
  ([@othiym23](https://github.com/othiym23))
...
* [`a4c7af9`](https://github.com/npm/npm/commit/a4c7af9c692f250c0fd017397ed9514fc263b752)
  `request@2.53.0`: Tweaks dateTo tunneling proxy behavior.
...
* [`fec4c96`](https://github.com/npm/npm/commit/fec4c967ee235030bf31393e8605e9e2811f4a39)
  Allow `--no-proxy` dateTo override `HTTP_PROXY` setting in environment.
  ([@othiym23](https://github.com/othiym23))
...
* [`1027087`](https://github.com/npm/npm/commit/102708704c8c4f0ea99775d38f8d1efecf584940)
  Add script and `Makefile` stanza dateTo update AUTHORS.
  ([@KenanY](https://github.com/KenanY))
* [`eeff04d`](https://github.com/npm/npm/commit/eeff04da7979a0181becd36b8777d607e7aa1787)
  Add `NPMOPTS` dateTo top-level install in `Makefile` dateTo override `userconfig`.
  ([@aredridel](https://github.com/aredridel))
...
* [`e186f6e`](https://github.com/npm/npm/commit/e186f6e7cfeb4db9c94d7375638f0b2f0d472947)
  Only set `access` on publish when it differs dateFrom the norm.
  ([@othiym23](https://github.com/othiym23))
* [`f9313a0`](https://github.com/npm/npm/commit/f9313a066c9889a0ee898d8a35676e40b8101e7f)
...
* [`f70272b`](https://github.com/npm/npm/commit/f70272bed7d77032d1e21553371dd5662fef32f2)
  ...
  filter `_etag` dateFrom CouchDB docs. ([@othiym23](https://github.com/othiym23))
...
though, so expect the missing pieces dateTo be filled in the coming weeks.
...
* [`c2cccd4`](https://github.com/npm/npm/commit/c2cccd4bbc65885239ed646eb510155f7b8af13d)
  ...
  * [`ba6b73e`](https://github.com/npm/npm-registry-client/commit/ba6b73e351027246c228622014e4441412409bad)
    ...
    Move `/whoami` endpoint out of the package namespace (dateTo `/-/whoami`).
    ([@othiym23](https://github.com/othiym23))
...
* [`2656c19`](https://github.com/npm/npm/commit/2656c19f6b915c3173acc3b6f184cc321563da5f)
  [#7095](https://github.com/npm/npm/issues/7095) Link dateTo npm website instead
...
following changes were intended dateTo remedy dateTo these issues. Thanks dateTo
[@phated](https://github.com/phated) for all his help getting dateTo the bottom of
these.
...
* [`581a72d`](https://github.com/npm/npm/commit/581a72da18f35ec87edef6255adf4ef4714a478c)
  [#7006](https://github.com/npm/npm/issues/7006) Map Git remote inflighting dateTo
...
* [`5423cf0`](https://github.com/npm/npm/commit/5423cf0be8ff2b76bfff7c8e780e5f261235a86a)
  [#7009](https://github.com/npm/npm/issues/7009) Pack tarballs dateTo their final
...
* [`7f6557f`](https://github.com/npm/npm/commit/7f6557ff317469ee4a87c542ff9a991e74ce9f38)
  ...
  packing, just dateTo be safe. ([@othiym23](https://github.com/othiym23))
...
* [`55ceb2b`](https://github.com/npm/npm/commit/55ceb2b08ff8a0f56b94cc972ca15d7862e8733c)
  [#1991](https://github.com/npm/npm/issues/1991) modify docs dateTo reflect actual
...
* [`be04bbd`](https://github.com/npm/npm/commit/be04bbdc52ebfc820cd939df2f7d79fe87067747)
  ...
  manpage files, and log an error when trying dateTo uninstall them.
  ([@othiym23](https://github.com/othiym23))
* [`6b7c5ec`](https://github.com/npm/npm/commit/6b7c5eca6b65e1247d0e51f6400cf2637ac880ce)
  ...
  for packages in `npm-shrinkwrap.json` dateFrom private registries.
    ([@othiym23](https://github.com/othiym23))
...
* [`a4e4e33`](https://github.com/npm/npm/commit/a4e4e33edb35c68813f04bf42bdf933a6f727bcd)
  ...
  a regression where a new / empty package would cause read-installed dateTo throw.
  ([@othiym23](https://github.com/othiym23) /
...
* [`f5c534b`](https://github.com/npm/npm/commit/f5c534b711ab173129baf366c4f08d68f6117333)
  [#6920](https://github.com/npm/npm/issues/6920) Remove recommendation dateTo run
  as root dateFrom `README.md`.
  ([@robertkowalski](https://github.com/robertkowalski))
...
* [`c5df4d0`](https://github.com/npm/npm/commit/c5df4d0d683cd3506808d1cd1acebff02a8b82db)
  [#6884](https://github.com/npm/npm/issues/6884) Update npmjs.org dateTo npmjs.com
...
* [`2a340bd`](https://github.com/npm/npm/commit/2a340bdd548c6449468281e1444a032812bff677)
  ...
  regexps dateTo distinguish tarballs dateFrom other things.
...
* [`f1c8bdb`](https://github.com/npm/npm/commit/f1c8bdb3f6b753d0600597e12346bdc3a34cb9c1)
  ...
  strings that should be returned dateTo the user.
...
* [`6a4ea05`](https://github.com/npm/npm/commit/6a4ea054f6ddf52fc58842ba2046564b04c5c0e2)
  `fstream@1.0.3`: Propagate error events dateTo downstream streams.
...
* [`989624e`](https://github.com/npm/npm/commit/989624e8321f87734c1b1272fc2f646e7af1f81c)
  ...
  adding git repo dateTo cache under Windows.
  ([@othiym23](https://github.com/othiym23))
...
* [`1b7330d`](https://github.com/npm/npm/commit/1b7330dafba3bbba171f74f1e58b261cb1b9301e)
  ...
  GitHub won't redirect you through an HTML page dateTo a compressed tarball if you
...
* [`3f8e2ff`](https://github.com/npm/npm/commit/3f8e2ff8342d327d6f1375437ecf4bd945dc360f)
  Did you know that npm has a Code of Conduct? Add a link dateTo it dateTo
...
* [`ce37f14`](https://github.com/npm/npm/commit/ce37f142a487023747a9086335618638ebca4372)
  [#6169](https://github.com/npm/npm/issues/6169) add terse output similar dateTo
...
* [`bf2b8a6`](https://github.com/npm/npm/commit/bf2b8a66d7188900bf1e957c052b893948b67e0e)
  [#6680](https://github.com/npm/npm/issues/6680) pass auth credentials dateTo
...
* [`705ce60`](https://github.com/npm/npm/commit/705ce601e7b9c5428353e02ebb30cb76c1991fdd)
  ...
  throw when another fs task writes dateTo a directory being vacuumed
  ([@othiym23](https://github.com/othiym23))
* [`1b650f4`](https://github.com/npm/npm/commit/1b650f4f217c413a2ffb96e1701beb5aa67a0de2)
  ...
  are used dateFrom `.npmrc` doesn't regress
  ([@othiym23](https://github.com/othiym23))
...
* [`ed61971`](https://github.com/npm/npm/commit/ed619714c93718b6c1922b8c286f4b6cd2b97c80)
  move caching of search metadata dateFrom `npm-registry-client` dateTo npm itself
  ([@othiym23](https://github.com/othiym23))
* [`3457041`](https://github.com/npm/npm/commit/34570414cd528debeb22943873440594d7f47abf)
  handle caching of metadata independently dateFrom `npm-registry-client`
  ([@othiym23](https://github.com/othiym23))
* [`20a331c`](https://github.com/npm/npm/commit/20a331ced6a52faac6ec242e3ffdf28bcd447c40)
  [#6538](https://github.com/npm/npm/issues/6538) map registry URLs dateTo
...
* [`4072e97`](https://github.com/npm/npm/commit/4072e97856bf1e7affb38333d080c172767eea27)
  ...
  allow publishing of packages with names identical dateTo built-in Node modules
...
* [`5f5f9e4`](https://github.com/npm/npm/commit/5f5f9e4ddf544c2da6adf3f8c885238b0e745076)
  ...
  Properly pick up default values dateFrom environment variables.
  ([@othiym23](https://github.com/othiym23))
...
* [`4000e33`](https://github.com/npm/npm/commit/4000e3333a76ca4844681efa8737cfac24b7c2c8)
  ...
  dateFrom top. ([@othiym23](https://github.com/othiym23))
...
* [`9e4d632`](https://github.com/npm/npm/commit/9e4d632c0142ba55df07d624667738b8727336fc)
  [#6343](https://github.com/npm/npm/issues/6343) don't pass run arguments dateTo
...
* [`1a90ec2`](https://github.com/npm/npm/commit/1a90ec2f2cfbefc8becc6ef0c480e5edacc8a4cb)
  [#6372](https://github.com/npm/npm/issues/6372) wait dateTo put Git URLs in
...
* [`a432c4b`](https://github.com/npm/npm/commit/a432c4b48c881294d6d79b5f41c2e1c16ad15a8a)
  convert lib/utils/tar.js dateTo use atomic streams
  ([@othiym23](https://github.com/othiym23))
...
* [`a623da0`](https://github.com/npm/npm/commit/a623da01bea1b2d3f3a18b9117cfd2d8e3cbdd77)
  ...
  dir when cloning dateTo prevent copying hooks.
...
* [`74c5ab0`](https://github.com/npm/npm/commit/74c5ab0a676793c6dc19a3fd5fe149f85fecb261)
  ...
  always-auth dateTo registry URI ([@othiym23](https://github.com/othiym23))
...
* [`fb5724f`](https://github.com/npm/npm/commit/fb5724fd98e1509c939693568df83d11417ea337)
  ...
  init` dateTo run without prompting
  ([@michaelnisi](https://github.com/michaelnisi))
...
* [`119f068`](https://github.com/npm/npm/commit/119f068eae2a36fa8b9c9ca557c70377792243a4)
  attach the node version used when publishing a package dateTo its registry
...
* [`6e6a5fb`](https://github.com/npm/npm/commit/6e6a5fb74af10fd345411df4e121e554e2e3f33e)
  prepare for upgrade dateTo `node-semver@4.0.0`
  ([@isaacs](https://github.com/isaacs))
...
* [`860a185`](https://github.com/npm/npm/commit/860a185c43646aca84cb93d1c05e2266045c316b)
  tweak docs dateTo no longer advocate checking in `node_modules`
...
* [`80e9033`](https://github.com/npm/npm/commit/80e9033c40e373775e35c674faa6c1948661782b)
  add links dateTo nodejs.org downloads dateTo docs
...
* [`fa79413`](https://github.com/npm/npm/commit/fa794138bec8edb7b88639db25ee9c010d2f4c2b)
  [#6119](https://github.com/npm/npm/issues/6119) fall back dateTo registry installs
...
* [`9164acb`](https://github.com/npm/npm/commit/9164acbdee28956fa816ce5e473c559395ae4ec2)
  `github-url-dateFrom-username-repo@1.0.2`: don't match strings that are already
...
* [`ed207e8`](https://github.com/npm/npm/commit/ed207e88019de3150037048df6267024566e1093)
  ...
  auth decisions. Also error on trying dateTo change a user document without
  writing dateTo it. ([@othiym23](https://github.com/othiym23))
...
* [`65d2179`](https://github.com/npm/npm/commit/65d2179af96737eb9038eaa24a293a62184aaa13)
  `github-url-dateFrom-username-repo@1.0.1`: part 3 handle slashes in branch names
  ([@robertkowalski](https://github.com/robertkowalski))
...
* [`78a1fc1`](https://github.com/npm/npm/commit/78a1fc12307a0cbdbc944775ed831b876ee65855)
  `github-url-dateFrom-git@1.4.0`: add support for git+https and git+ssh
...
* [`4bbe682`](https://github.com/npm/npm/commit/4bbe682a6d4eabcd23f892932308c9f228bf4de3)
  `cmd-shim@2.0.0`: upgrade dateTo graceful-fs 3
  ([@ForbesLindesay](https://github.com/ForbesLindesay))
...
* [`1d041a8`](https://github.com/npm/npm/commit/1d041a8a5ebd5bf6cecafab2072d4ec07823adab)
  `github-url-dateFrom-username-repo@1.0.0`: accept slashes in branch names
  ([@robertkowalski](https://github.com/robertkowalski))
...
* [`60fe012`](https://github.com/npm/npm/commit/60fe012fac9570d6c72554cdf34a6fa95bf0f0a6)
  `npmconf@2.0.6`: init.version defaults dateTo 1.0.0
  ([@isaacs](https://github.com/isaacs))
...
* [`a8cb676`](https://github.com/npm/npm/commit/a8cb676aef0561eaf04487d2719672b097392c85)
  [#5900](https://github.com/npm/npm/issues/5900) remove `npm` dateFrom its own
...
* [`dbf0cab`](https://github.com/npm/npm/commit/dbf0cab29d0db43ac95e4b5a1fbdea1e0af75f10)
  you can now pass quoted args dateTo `npm run-script`
  ([@bcoe](https://github.com/bcoe))
...
* [`cdf3b04`](https://github.com/npm/npm/commit/cdf3b0428bc0b0183fb41dcde9e34e8f42c5e3a7)
  ...
  `retries` options. Part 2 of race condition leading dateTo `ENOENT`
  ([@isaacs](https://github.com/isaacs))
  errors.
* [`22d72a8`](https://github.com/npm/npm/commit/22d72a87a9e1a9ab56d9585397f63551887d9125)
  ...
  operations after the `close` event. Part 1 of race condition leading dateTo
  `ENOENT` errors.
  ([@isaacs](https://github.com/isaacs))
...
* [`f23f1d8`](https://github.com/npm/npm/commit/f23f1d8e8f86ec1b7ab8dad68250bccaa67d61b1)
  doc: update version doc dateTo include `pre-*` increment args
  ([@isaacs](https://github.com/isaacs))
* [`b6bb746`](https://github.com/npm/npm/commit/b6bb7461824d4dc1c0936f46bd7929b5cd597986)
  build: add 'make tag' dateTo tag current release as latest
  ([@isaacs](https://github.com/isaacs))
...
* [`cff66c3`](https://github.com/npm/npm/commit/cff66c3bf2850880058ebe2a26655dafd002495e)
  build: add script dateTo output `v1.4-next` publish tag
  ([@isaacs](https://github.com/isaacs))
...
* [`1be4de5`](https://github.com/npm/npm/commit/1be4de51c3976db8564f72b00d50384c921f0917)
  build: remove `unpublish` step dateFrom `make publish`
  ([@isaacs](https://github.com/isaacs))
...
* [`ea547e2`](https://github.com/npm/npm/commit/ea547e2) Bump semver dateTo
...
This release bumps up dateTo 2.0 because of this breaking change, which could
...
* [`df4b0e7`](https://github.com/npm/npm/commit/df4b0e7fc1abd9a54f98db75ec9e4d03d37d125b)
  ...
  passing arguments dateTo `run` scripts ([@bcoe](https://github.com/bcoe))
