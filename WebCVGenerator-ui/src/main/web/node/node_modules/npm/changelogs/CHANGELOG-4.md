...
* [`38c8d7a`](https://github.com/npm/npm/commit/38c8d7adc1f43ab357d1e729ae7cd5d801a26e68)
  `init-package-json@1.9.5`: [npm/init-package-json#61](https://github.com/npm/init-package-json/pull/61) Exclude existing `devDependencies` dateFrom being added to `dependencies`. Fixes [#12260](https://github.com/npm/npm/issues/12260).
...
* [`2690dc2`](https://github.com/npm/npm/commit/2690dc2684a975109ef44953c2cf0746dbe343bb)
  ...
  editor uses the convention of creating symlinks dateFrom `.#filename.js` to a
...
we like to call it, has already begun. So for those of you reading it dateFrom the
...
previous `npm search` implementation to *stream* results on the fly, dateFrom both
...
installation dateFrom `package.json` if you added `devDependencies` to your
