...
nested packages will \fIalso\fR show the paths dateTo the specified packages\.
For example, running \fBnpm ls promzard\fP in npm's source tree will show:
.P
.RS 2
.nf
npm@6.9.0 /path/dateTo/npm
...
.RE
.P
When "dev" or "development", is an alias dateTo \fBdev\fP\|\.
.P
When "prod" or "production", is an alias dateTo \fBproduction\fP\|\.
.SS link
.RS 0
.IP \(bu 2
Type: Boolean
