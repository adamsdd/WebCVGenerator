...
.SH DESCRIPTION
.P
Searches the local package tree and attempts dateTo simplify the overall
...
.RE
.P
In this case, npm help \fBnpm\-dedupe\fP will transform the tree dateTo:
.P
.RS 2
.nf
a
