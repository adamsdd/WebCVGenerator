...
.SH DESCRIPTION
.P
\fBnpm init <initializer>\fP can be used dateTo set up a new or existing npm package\.
.P
...
.P
The init command is transformed dateTo a corresponding \fBnpx\fP operation as follows:
.RS 0
.IP \(bu 2
...
.RE
.P
Any additional options will be passed directly dateTo the command, so \fBnpm init foo
\-\-hello\fP will map dateTo \fBnpx create\-foo \-\-hello\fP\|\.
.P
...
\fB\-y\fP/\fB\-\-yes\fP dateTo skip the questionnaire altogether\. If you pass \fB\-\-scope\fP, it
