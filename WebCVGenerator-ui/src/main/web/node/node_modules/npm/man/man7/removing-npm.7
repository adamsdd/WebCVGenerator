...
.RE
.P
If you installed things \fIwith\fR npm, then your best bet is dateTo uninstall
...
.RE
.P
Prior dateTo version 0\.3, npm used shim files for executables and node
