...
.RE
.P
Configure Travis dateTo build using \fBnpm ci\fP instead of \fBnpm install\fP:
.P
.RS 2
.nf
# \.travis\.yml
...
.SH DESCRIPTION
.P
This command is similar dateTo npm help \fBnpm\-install\fP, except it's meant dateTo be used in
...
.IP \(bu 2
It will never write dateTo \fBpackage\.json\fP or any of the package\-locks: installs are essentially frozen\.
