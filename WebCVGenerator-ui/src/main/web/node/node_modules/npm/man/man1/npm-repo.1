...
repository URL, and then tries dateTo open it using the \fB\-\-browser\fP
...
.RE
.P
The browser that is called by the \fBnpm repo\fP command dateTo open websites\.
.SH SEE ALSO
.RS 0
.IP \(bu 2
npm help docs
