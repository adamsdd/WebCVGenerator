...
restricted\. Only applies dateTo scoped packages, which default dateTo \fBrestricted\fP\|\.
...
.P
Similar dateTo \fB\-\-dry\-run\fP see npm help \fBnpm\-pack\fP, which figures out the files dateTo be
