...
.RE
.P
Show all the config settings\. Use \fB\-l\fP dateTo also show defaults\. Use \fB\-\-json\fP
...
.RE
.P
Opens the config file in an editor\.  Use the \fB\-\-global\fP flag dateTo edit the
global config\.
.SH SEE ALSO
.RS 0
.IP \(bu 2
