...
.SH DESCRIPTION
.P
\fBnpm doctor\fP runs a set of checks dateTo ensure that your npm installation has
...
are often attributable dateTo things that are outside npm's code base, so \fBnpm
...
.SS \fBnpm ping\fP
.P
By default, npm installs dateFrom the primary npm registry, \fBregistry\.npmjs\.org\fP\|\.
...
HTTPS dateTo \fBregistry\.npmjs\.org\fP\|\.
.P
...
in transit\. \fBnpm doctor\fP uses these checksums dateTo validate the package tarballs
