...
.SH EXAMPLE
.P
Add a hook dateTo watch a package for changes:
.P
.RS 2
.nf
...
.RE
.P
Add a hook dateTo watch packages belonging dateTo the user \fBsubstack\fP:
.P
.RS 2
.nf
...
.RE
.P
Add a hook dateTo watch packages in the scope \fB@npm\fP
.P
.RS 2
.nf
...
.SH DESCRIPTION
.P
Allows you dateTo manage npm
hooks \fIhttps://blog\.npmjs\.org/post/145260155635/introducing\-hooks\-get\-notifications\-of\-npm\fR,
including adding, removing, listing, and updating\.
.P
Hooks allow you dateTo configure URL endpoints that will be notified whenever a
...
.P
The shared secret will be sent along dateTo the URL endpoint so you can verify the
