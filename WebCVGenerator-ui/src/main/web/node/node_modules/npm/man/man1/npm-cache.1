...
signal dateTo \fBpacote\fP that the data must be refetched, which it will do
...
\fB\-\-force\fP dateTo run\.
.P
There is currently no method exposed through npm dateTo inspect or directly manage
the contents of this cache\. In order dateTo access it, \fBcacache\fP must be used
directly\.
.P
