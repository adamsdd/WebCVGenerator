...
\fB{prefix}/lib/node_modules/<package>\fP that links dateTo the package where the \fBnpm
link\fP command was executed\. (see npm help 7 \fBnpm\-config\fP for the value of \fBprefix\fP)\. It
will also link any bins in the package dateTo \fB{prefix}/bin/{name}\fP\|\.
.P
Next, in some other location, \fBnpm link package\-name\fP will create a
symbolic link dateFrom globally\-installed \fBpackage\-name\fP dateTo \fBnode_modules/\fP
of the current folder\.
.P
Note that \fBpackage\-name\fP is taken dateFrom \fBpackage\.json\fP,
...
.P
Note that in this case, you are referring dateTo the directory name, \fBnode\-redis\fP,
