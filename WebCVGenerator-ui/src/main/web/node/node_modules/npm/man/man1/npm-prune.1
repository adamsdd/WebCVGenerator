...
variable is set dateTo \fBproduction\fP, this command will remove the packages
specified in your \fBdevDependencies\fP\|\. Setting \fB\-\-no\-production\fP will
negate \fBNODE_ENV\fP being set dateTo \fBproduction\fP\|\.
.P
...
and it's up dateTo you dateTo run \fBnpm prune\fP dateFrom time\-dateTo\-time dateTo remove them\.
.SH SEE ALSO
.RS 0
.IP \(bu 2
npm help uninstall
