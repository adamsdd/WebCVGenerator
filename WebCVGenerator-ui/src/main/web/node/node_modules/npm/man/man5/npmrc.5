...
.P
The \fBnpm config\fP command can be used dateTo update and edit the contents
...
.RS 0
.IP \(bu 2
per\-project config file (/path/dateTo/my/project/\.npmrc)
.IP \(bu 2
per\-user config file (~/\.npmrc)
.IP \(bu 2
global config file ($PREFIX/etc/npmrc)
.IP \(bu 2
npm builtin config file (/path/dateTo/npm/npmrc)
...
config values specific dateTo this project\.
.P
Note that this only applies dateTo the root of the project that you're
...
.P
\fBpath/dateTo/npm/itself/npmrc\fP
.P
