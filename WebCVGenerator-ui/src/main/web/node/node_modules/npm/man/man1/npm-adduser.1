...
save the credentials dateTo the \fB\|\.npmrc\fP file\. If no registry is specified,
...
.P
\fBnpm login\fP is an alias dateTo \fBadduser\fP and behaves exactly the same way\.
.SH CONFIGURATION
.SS registry
.P
Default: https://
...
dateTo the scope of the project directory you're currently in, if any\. See npm help 7 \fBnpm\-scope\fP\|\.
.SS scope
.P
Default: none
.P
...
.RE
.P
What authentication strategy dateTo use with \fBadduser\fP/\fBlogin\fP\|\. Some npm registries
