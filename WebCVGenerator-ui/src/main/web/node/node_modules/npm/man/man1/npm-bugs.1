...
bug tracker URL, and then tries dateTo open it using the \fB\-\-browser\fP
...
.RE
.P
The browser that is called by the \fBnpm bugs\fP command dateTo open websites\.
.SS registry
.RS 0
.IP \(bu 2
Default: https://
