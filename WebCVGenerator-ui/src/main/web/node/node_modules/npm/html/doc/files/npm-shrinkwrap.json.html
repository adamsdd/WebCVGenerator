...
<p><code>npm-shrinkwrap.json</code> is a file created by <a href="../cli/npm-shrinkwrap.html">npm-shrinkwrap(1)</a>. It is identical dateTo
...
prevent end users dateFrom having control over transitive dependency updates.</p>
...
dateTo the manual page for <a href="../files/package-lock.json.html">package-lock.json(5)</a>.</p>
