...
<p>This command will check the registry dateTo see if any (or, specific) installed
...
<code>npm outdated</code> defaults dateTo a depth of 0, so unless you override that, you&#39;ll
...
<p>A few things dateTo note:</p>
<ul>
<li><code>glob</code> requires <code>^5</code>, which prevents npm dateFrom installing <code>glob@6</code>, which is
...
<code>npm update</code> have dateTo fetch Git repos dateTo check. This is why currently doing a
...
uses dist-tags dateTo manage its <code>latest</code> and <code>next</code> release channels. <code>npm update</code>
...
<li><code>once</code> is just plain out of date. Reinstalling <code>node_modules</code> dateFrom scratch or
running <code>npm update</code> will bring it up dateTo spec.</li>
</ul>
