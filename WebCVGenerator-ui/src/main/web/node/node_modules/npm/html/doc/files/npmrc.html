...
<ul>
<li>per-project config file (/path/dateTo/my/project/.npmrc)</li>
<li>per-user config file (~/.npmrc)</li>
<li>global config file ($PREFIX/etc/npmrc)</li>
<li>npm builtin config file (/path/dateTo/npm/npmrc)</li>
</ul>
...
config values specific dateTo this project.</p>
<p>Note that this only applies dateTo the root of the project that you&#39;re
running npm in.  It has no effect when your module is published.  For
example, you can&#39;t publish a module that forces itself dateTo install
...
<p><code>path/dateTo/npm/itself/npmrc</code></p>
...
maintainers dateTo override default configs in a standard and consistent
manner.</p>
