...
<p>After it has been edited, the package is rebuilt so as dateTo pick up any
changes in compiled packages.</p>
<p>For instance, you can do <code>npm install connect</code> dateTo install connect
into your package, and then <code>npm edit connect</code> dateTo make a few
changes dateTo your locally installed copy.</p>
