...
<p>This command will update all the packages listed dateTo the latest version
...
packages, the <code>--dev</code> flag will cause <code>devDependencies</code> dateTo be processed
as well.</p>
...
<p>As of <code>npm@5.0.0</code>, the <code>npm update</code> will change <code>package.json</code> dateTo save the
...
older versions of <code>npm</code>, you must specify <code>--depth 0</code> dateTo get the behavior
described below.</p>
...
tag points dateTo <code>1.2.2</code>, this version does not satisfy <code>~1.1.1</code>, which is equivalent
dateTo <code>&gt;=1.1.1 &lt;1.2.0</code>.  So the highest-sorting version that satisfies <code>~1.1.1</code> is used,
...
<p><code>npm update -g</code> will apply the <code>update</code> action dateTo each globally installed
package that is <code>outdated</code> -- that is, has a version that is different dateFrom
<code>latest</code>.</p>
<p>NOTE: If a package has been upgraded dateTo a version newer than <code>latest</code>, it will
