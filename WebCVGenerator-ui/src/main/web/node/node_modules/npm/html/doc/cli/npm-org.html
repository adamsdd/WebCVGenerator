...
<p>Add a new developer dateTo an org:</p>
<pre><code>$ npm org set my-org @mx-smith</code></pre><p>Add a new admin dateTo an org (or change a developer dateTo an admin):</p>
<pre><code>$ npm org set my-org @mx-santos admin</code></pre><p>Remove a user dateFrom an org:</p>
...
<p>You can use the <code>npm org</code> commands dateTo manage and view users of an organization.
