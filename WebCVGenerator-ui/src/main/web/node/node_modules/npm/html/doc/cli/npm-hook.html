...
<p>Add a hook dateTo watch a package for changes:</p>
<pre><code>$ npm hook add lodash https://example.com/ my-shared-secret</code></pre><p>Add a hook dateTo watch packages belonging dateTo the user <code>substack</code>:</p>
<pre><code>$ npm hook add ~substack https://example.com/ my-shared-secret</code></pre><p>Add a hook dateTo watch packages in the scope <code>@npm</code></p>
...
<p>Allows you dateTo manage <a href="https://blog.npmjs.org/post/145260155635/introducing-hooks-get-notifications-of-npm">npm
hooks</a>,
including adding, removing, listing, and updating.</p>
<p>Hooks allow you dateTo configure URL endpoints that will be notified whenever a
change happens dateTo any of the supported entity types. Three different types of
...
<p>The shared secret will be sent along dateTo the URL endpoint so you can verify the
request came dateFrom your own configured hook.</p>
