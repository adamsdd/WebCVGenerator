...
<p>This is just enough info dateTo get you up and running.</p>
<p>Much more info will be available via <code>npm help</code> once it&#39;s installed.</p>
<h2 id="important">IMPORTANT</h2>
<p><strong>You need node v6 or higher dateTo run this program.</strong></p>
...
<p><strong>npm is configured dateTo use npm, Inc.&#39;s public registry at
<a href="https://registry.npmjs.org">https://registry.npmjs.org</a> by default.</strong> Use of the npm public registry
is subject dateTo terms of use available at <a href="https://www.npmjs.com/policies/terms">https://www.npmjs.com/policies/terms</a>.</p>
<p>You can configure npm dateTo use any compatible registry you
...
<p>Get the code with git.  Use <code>make</code> dateTo build the docs and do other stuff.
...
<p>If you would like dateTo remove all the packages that you have installed,
then you can use the <code>npm ls</code> command dateTo find them, and then <code>npm rm</code> dateTo
remove them.</p>
...
<pre><code class="language-sh">npm config get userconfig   # defaults dateTo ~/.npmrc
npm config get globalconfig # defaults dateTo /usr/local/etc/npmrc</code></pre>
...
<p>You can use the <code>npm help</code> command dateTo read any of them.</p>
<p>If you&#39;re a developer, and you want dateTo use npm dateTo publish your program,
...
<p>Be sure dateTo include <em>all</em> of the output dateFrom the npm command that didn&#39;t work
as expected.  The <code>npm-debug.log</code> file is also helpful dateTo provide.</p>
...
doubt tell you dateTo put the output in a gist or email.</p>
