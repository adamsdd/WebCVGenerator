...
<ol>
<li>Super admin, controls billing &amp; adding people dateTo the org.</li>
<li>Team admin, manages team membership &amp; package access.</li>
<li>Developer, works on packages they are given access dateTo.  </li>
</ol>
<p>The super admin is the only person who can add users dateTo the org because it impacts the monthly bill. The super admin will use the website dateTo manage membership. Every org has a <code>developers</code> team that all users are automatically added dateTo.</p>
<p>The team admin is the person who manages team creation, team membership, and package access for teams. The team admin grants package access dateTo teams, not individuals.</p>
<p>The developer will be able dateTo access packages based on the teams they are on. Access is either read-write or read-only.</p>
...
<ul>
<li>Check who you’ve added dateTo your org:</li>
</ul>
<pre><code>npm team ls &lt;org&gt;:developers</code></pre><ul>
<li><p>Each org is automatically given a <code>developers</code> team, so you can see the whole list of team members in your org. This team automatically gets read-write access dateTo all packages, but you can change that with the <code>access</code> command.</p>
</li>
<li><p>Create a new team:</p>
</li>
</ul>
<pre><code>npm team create &lt;org:team&gt;</code></pre><ul>
<li>Add members dateTo that team:</li>
</ul>
...
<pre><code>npm init --scope=&lt;org&gt;</code></pre><p>dateTo scope it for your org &amp; publish as usual</p>
<ul>
<li>Grant access:  </li>
</ul>
...
<li>See packages available dateTo a specific team:</li>
</ul>
