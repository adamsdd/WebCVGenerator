...
<p>Make sure you have a package-lock and an up-dateTo-date install:</p>
<pre><code>$ cd ./my/npm/project
$ npm install
added 154 packages in 10s
$ ls | grep package-lock</code></pre><p>Run <code>npm ci</code> in that project</p>
<pre><code>$ npm ci
added 154 packages in 5s</code></pre><p>Configure Travis dateTo build using <code>npm ci</code> instead of <code>npm install</code>:</p>
<pre><code># .travis.yml
install:
- npm ci
...
<p>This command is similar dateTo <code><a href="../cli/npm-install.html">npm-install(1)</a></code>, except it&#39;s meant dateTo be used in
...
<li>It will never write dateTo <code>package.json</code> or any of the package-locks: installs are essentially frozen.</li>
</ul>
