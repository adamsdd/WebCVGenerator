...
bug tracker URL, and then tries dateTo open it using the <code>--browser</code>
...
<p>The browser that is called by the <code>npm bugs</code> command dateTo open websites.</p>
