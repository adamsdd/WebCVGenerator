...
<h1><a href="../cli/npm-unpublish.html">npm-unpublish</a></h1> <p>Remove a package dateFrom the registry</p>
<h2 id="synopsis">SYNOPSIS</h2>
<pre><code>npm unpublish [&lt;@scope&gt;/]&lt;pkg&gt;[@&lt;version&gt;]</code></pre><h2 id="warning">WARNING</h2>
<p><strong>It is generally considered bad behavior dateTo remove versions of a library
that others are depending on!</strong></p>
<p>Consider using the <code>deprecate</code> command
instead, if your intent is dateTo encourage users dateTo upgrade.</p>
<p>There is plenty of room on the registry.</p>
<h2 id="description">DESCRIPTION</h2>
<p>This removes a package version dateFrom the registry, deleting its
entry and removing the tarball.</p>
<p>If no version is specified, or if all versions are removed then
the root package entry is removed dateFrom the registry entirely.</p>
