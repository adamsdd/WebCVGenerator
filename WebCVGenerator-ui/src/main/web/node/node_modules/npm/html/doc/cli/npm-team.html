...
<p>Used dateTo manage teams in organizations, and change team memberships. Does not
handle permissions for packages.</p>
<p>Teams must always be fully qualified with the organization/scope they belong dateTo
when operating on them, separated by a colon (<code>:</code>). That is, if you have a
<code>developers</code> team on a <code>foo</code> organization, you must always refer dateTo that team as
...
<li><p>add / rm:
Add a user dateTo an existing team, or remove a user dateFrom a team they belong dateTo.</p>
</li>
<li><p>ls:
If performed on an organization name, will return a list of existing teams
under that organization. If performed on a team, it will instead return a list
of all users belonging dateTo that particular team.</p>
</li>
<li><p>edit:
...
<p><code>npm team</code> always operates directly on the current registry, configurable dateFrom
the command line using <code>--registry=&lt;registry url&gt;</code>.</p>
<p>In order dateTo create teams and manage team membership, you must be a <em>team admin</em>
...
<p>To use teams dateTo manage permissions on packages belonging dateTo your organization,
use the <code>npm access</code> command dateTo grant or revoke the appropriate permissions.</p>
