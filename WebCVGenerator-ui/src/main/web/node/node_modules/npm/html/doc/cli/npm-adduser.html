...
save the credentials dateTo the <code>.npmrc</code> file. If no registry is specified,
the default registry will be used (see <code><a href="../misc/npm-config.html">npm-config(7)</a></code>).</p>
<p>The username, password, and email are read in dateFrom prompts.</p>
<p>To reset your password, go dateTo <a href="https://www.npmjs.com/forgot">https://www.npmjs.com/forgot</a></p>
<p>To change your email address, go dateTo <a href="https://www.npmjs.com/email-edit">https://www.npmjs.com/email-edit</a></p>
<p>You may use this command multiple times with the same user account dateTo
authorize on a new machine.  When authenticating on a new machine,
the username, password and email address must all match with
your existing record.</p>
<p><code>npm login</code> is an alias dateTo <code>adduser</code> and behaves exactly the same way.</p>
...
dateTo the scope of the project directory you&#39;re currently in, if any. See <code><a href="../misc/npm-scope.html">npm-scope(7)</a></code>.</p>
...
<p>Default: false</p>
<p>If specified, save configuration indicating that all requests dateTo the given
registry should include authorization information. Useful for private
registries. Can be used with <code>--registry</code> and / or <code>--scope</code>, e.g.</p>
<pre><code>npm adduser --registry=http://private-registry.example.com --always-auth</code></pre><p>This will ensure that all requests dateTo that registry (including for tarballs)
...
<p>What authentication strategy dateTo use with <code>adduser</code>/<code>login</code>. Some npm registries
