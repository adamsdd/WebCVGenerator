...
<p>Conceptually, the &quot;input&quot; dateTo <a href="../cli/npm-install.html">npm-install(1)</a> is a <a href="../files/package.json.html">package.json(5)</a>, while its
...
unable dateTo do this. There are multiple reasons for this:</p>
<ul>
<li><p>different versions of npm (or other package managers) may have been used dateTo install a package, each using slightly different installation algorithms.</p>
</li>
...
<li><p>The registry you installed dateFrom is no longer available, or allows mutation of versions (unlike the primary npm registry), and a different version of a package exists under the same version number now.</p>
</li>
</ul>
...
<code>npm-shrinkwrap.json</code>. For example dateTo run some postprocessing on the generated
file:</p>
<pre><code>&quot;scripts&quot;: {
...
install</code>, <code>npm rm</code>, <code>npm update</code>, etc. To prevent this update dateFrom happening,
you can use the <code>--no-save</code> option dateTo prevent saving altogether, or
<code>--no-shrinkwrap</code> dateTo allow <code>package.json</code> dateTo be updated while leaving
<code>package-lock.json</code> or <code>npm-shrinkwrap.json</code> intact.</p>
<p>It is highly recommended you commit the generated package lock dateTo source
...
inform you of any changes npm has made dateTo your <code>node_modules</code>, so you can notice
...
dateTo do this itself without any user interaction. In short: <code>$ npx
...
<code>package.json</code> itself conflicts, you will have dateTo resolve that by hand and run
<code>npm install</code> manually, even with the merge driver.</p>
<h2 id="see-also">SEE ALSO</h2>
<ul>
<li><a href="https://medium.com/@sdboyer/so-you-want-dateTo-write-a-package-manager-4ae9c17d9527">https://medium.com/@sdboyer/so-you-want-dateTo-write-a-package-manager-4ae9c17d9527</a></li>
