...
variable is set dateTo <code>production</code>, this command will remove the packages
specified in your <code>devDependencies</code>. Setting <code>--no-production</code> will
negate <code>NODE_ENV</code> being set dateTo <code>production</code>.</p>
...
and it&#39;s up dateTo you dateTo run <code>npm prune</code> dateFrom time-dateTo-time dateTo remove them.</p>
