...
<li><p>rm:
Clear a tag that is no longer in use dateFrom the package.</p>
</li>
<li><p>ls:
...
<p>A tag can be used when installing packages as a reference dateTo a version instead
...
<pre><code>npm install --tag &lt;tag&gt;</code></pre><p>This also applies dateTo <code>npm dedupe</code>.</p>
<p>Publishing a package sets the <code>latest</code> tag dateTo the published version unless the
...
<p>Tags can be used dateTo provide an alias instead of version numbers.</p>
<p>For example, a project might choose dateTo have multiple streams of development
and use a different tag for each stream,
e.g., <code>stable</code>, <code>beta</code>, <code>dev</code>, <code>canary</code>.</p>
<p>By default, the <code>latest</code> tag is used by npm dateTo identify the current version of
...
as prereleases.</p>
<p>The <code>next</code> tag is used by some projects dateTo identify the upcoming version.</p>
<p>By default, other than <code>latest</code>, no tag has any special significance dateTo npm
itself.</p>
<h2 id="caveats">CAVEATS</h2>
<p>This command used dateTo be known as <code>npm tag</code>, which only created new tags, and so
...
<p>The simplest way dateTo avoid semver problems with tags is dateTo use tags that do not
