...
<p>Searches the local package tree and attempts dateTo simplify the overall
...
`-- d &lt;-- depends on c@~1.0.9
    `-- c@1.0.10</code></pre><p>In this case, <code><a href="../cli/npm-dedupe.html">npm-dedupe(1)</a></code> will transform the tree dateTo:</p>
<pre><code>a
+-- b
+-- d
