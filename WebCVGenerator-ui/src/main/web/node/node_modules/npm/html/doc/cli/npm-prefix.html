...
<p>Print the local prefix dateTo standard out. This is the closest parent directory
dateTo contain a <code>package.json</code> file or <code>node_modules</code> directory, unless <code>-g</code> is
also specified.</p>
