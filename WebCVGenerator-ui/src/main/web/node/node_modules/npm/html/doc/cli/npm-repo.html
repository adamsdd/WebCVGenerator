...
repository URL, and then tries dateTo open it using the <code>--browser</code>
...
<p>The browser that is called by the <code>npm repo</code> command dateTo open websites.</p>
