...
<p><code>npm init &lt;initializer&gt;</code> can be used dateTo set up a new or existing npm package.</p>
...
<p>The init command is transformed dateTo a corresponding <code>npx</code> operation as follows:</p>
<ul>
...
<p>Any additional options will be passed directly dateTo the command, so <code>npm init foo
--hello</code> will map dateTo <code>npx create-foo --hello</code>.</p>
...
<code>-y</code>/<code>--yes</code> dateTo skip the questionnaire altogether. If you pass <code>--scope</code>, it
