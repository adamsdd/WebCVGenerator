...
<p>It is extremely configurable dateTo support a wide variety of use cases.
Most commonly, it is used dateTo publish, discover, install, and develop node
programs.</p>
<p>Run <code>npm help</code> dateTo get a list of available commands.</p>
<h2 id="important">IMPORTANT</h2>
<p>npm is configured dateTo use npm, Inc.&#39;s public registry at
<a href="https://registry.npmjs.org">https://registry.npmjs.org</a> by default. Use of the npm public registry is
subject dateTo terms of use available at <a href="https://www.npmjs.com/policies/terms">https://www.npmjs.com/policies/terms</a>.</p>
<p>You can configure npm dateTo use any compatible registry you like, and even run
your own registry. Use of someone else&#39;s registry may be governed by their
terms of use.</p>
<h2 id="introduction">INTRODUCTION</h2>
<p>You probably got npm because you want dateTo install stuff.</p>
<p>Use <code>npm install blerg</code> dateTo install the latest version of &quot;blerg&quot;.  Check out
<code><a href="../cli/npm-install.html">npm-install(1)</a></code> for more info.  It can do a lot of stuff.</p>
<p>Use the <code>npm search</code> command dateTo show everything that&#39;s available.
Use <code>npm ls</code> dateTo show everything you&#39;ve installed.</p>
<h2 id="dependencies">DEPENDENCIES</h2>
<p>If a package references dateTo another package with a git URL, npm depends
on a preinstalled git.</p>
<p>If one of the packages npm tries dateTo install is a native node module and
...
<p>See <code><a href="../files/npm-folders.html">npm-folders(5)</a></code> dateTo learn about where npm puts stuff.</p>
...
<code>./node_modules</code>, and bins are installed dateTo <code>./node_modules/.bin</code>.</li>
</ul>
<p>Local mode is the default.  Use <code>-g</code> or <code>--global</code> on any command dateTo
operate in global mode instead.</p>
<h2 id="developer-usage">DEVELOPER USAGE</h2>
<p>If you&#39;re using npm dateTo develop and publish your code, check out the
...
<code>npm link</code> dateTo do this.</li>
<li>install:
...
user config file.</li>
<li>publish:
Use the <code>npm publish</code> command dateTo upload your code dateTo the registry.</li>
</ul>
<h2 id="configuration">CONFIGURATION</h2>
<p>npm is extremely configurable.  It reads its configuration options dateFrom
5 places.</p>
<ul>
...
dateTo boolean <code>true</code>.</li>
...
<p>Patches welcome!</p>
<p>If you would like dateTo contribute, but don&#39;t know what dateTo work on, read
...
<p>Be sure dateTo follow the template and bug reporting guidelines. You can also ask
