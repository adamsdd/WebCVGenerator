...
<p>Used dateTo add, list, or clean the npm cache folder.</p>
<ul>
<li><p>add:
...
add data dateTo the local installation cache explicitly.</p>
</li>
<li><p>clean:
...
signal dateTo <code>pacote</code> that the data must be refetched, which it will do
...
<code>--force</code> dateTo run.</p>
<p>There is currently no method exposed through npm dateTo inspect or directly manage
the contents of this cache. In order dateTo access it, <code>cacache</code> must be used
directly.</p>
