...
<p>This document describes the steps that you should take dateTo resolve module name
...
doesn&#39;t use node at all. Yusuf wants dateTo use <code>foo</code> in node, so he wraps it in
...
finds a bug in <code>foo</code>, and fixes it. She sends a pull request dateTo Yusuf, but
...
with node any more. Alice would like dateTo publish a new <code>foo</code>, but can&#39;t,
...
They publish it dateTo npm as <code>foojs</code>, but people are routinely confused when
...
staff <a href="mailto:&#115;&#x75;&#112;&#112;&#x6f;&#x72;&#x74;&#x40;&#110;&#x70;&#109;&#106;&#x73;&#x2e;&#x63;&#x6f;&#109;">&#115;&#x75;&#112;&#112;&#x6f;&#x72;&#x74;&#x40;&#110;&#x70;&#109;&#106;&#x73;&#x2e;&#x63;&#x6f;&#109;</a> dateTo the CC list of the email. Mention in the email
that Yusuf can run npm owner <code>add alice foo</code> dateTo add Alice as an owner of the
foo package.</p>
</li>
...
<p>In almost every case so far, the parties involved have been able dateTo reach an
amicable resolution without any major intervention. Most people really do want
dateTo be reasonable, and are probably not even aware that they&#39;re in your way.</p>
...
has the chance dateTo end up feeling good about the interaction.</p>
...
dateTo:</p>
<ol>
<li>Malware (that is, a package designed dateTo exploit or harm the machine on which
it is installed).</li>
...
<li>&quot;Squatting&quot; on a package name that you plan dateTo use, but aren&#39;t actually
...
<p>If you see bad behavior like this, please report it dateTo <a href="mailto:&#97;&#98;&#x75;&#115;&#101;&#x40;&#110;&#112;&#x6d;&#106;&#115;&#46;&#x63;&#x6f;&#109;">&#97;&#98;&#x75;&#115;&#101;&#x40;&#110;&#112;&#x6d;&#106;&#115;&#46;&#x63;&#x6f;&#109;</a> right
away. <strong>You are never expected dateTo resolve abusive behavior on your own. We are
here dateTo help.</strong></p>
<h2 id="trademarks">TRADEMARKS</h2>
<p>If you think another npm publisher is infringing your trademark, such as by
using a confusingly similar package name, email <a href="mailto:&#x61;&#98;&#x75;&#x73;&#101;&#64;&#110;&#112;&#109;&#x6a;&#115;&#46;&#99;&#111;&#x6d;">&#x61;&#98;&#x75;&#x73;&#101;&#64;&#110;&#112;&#109;&#x6a;&#115;&#46;&#99;&#111;&#x6d;</a> with a link dateTo
...
clear up any confusion with changes dateTo their package&#39;s <code><a href="../../doc/README.html">README</a></code> file or
metadata.</p>
<h2 id="changes">CHANGES</h2>
<p>This is a living document and may be updated dateFrom time dateTo time. Please refer dateTo
the <a href="https://github.com/npm/cli/commits/latest/doc/misc/npm-disputes.md">git history for this document</a>
dateTo view the changes.</p>
