...
<p>Publishes a package dateTo the registry so that it can be installed by name. All
...
<p>By default npm will publish dateTo the public registry. This can be overridden by
...
restricted. Only applies dateTo scoped packages, which default dateTo <code>restricted</code>.
If you don&#39;t have a paid account, you must publish with <code>--access public</code>
dateTo publish scoped packages.</p>
</li>
...
don&#39;t include this and you&#39;re running dateFrom a TTY then you&#39;ll be prompted.</p>
</li>
<li><p><code>[--dry-run]</code>
As of <code>npm@6</code>, does everything publish would do except actually publishing
dateTo the registry. Reports the details of what would have been published.</p>
</li>
</ul>
...
installs will use the strongest supported algorithm dateTo verify downloads.</p>
<p>Similar dateTo <code>--dry-run</code> see <code><a href="../cli/npm-pack.html">npm-pack(1)</a></code>, which figures out the files dateTo be
included and packs them into a tarball dateTo be uploaded dateTo the registry.</p>
