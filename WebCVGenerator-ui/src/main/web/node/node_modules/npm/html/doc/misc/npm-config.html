...
<h1><a href="../misc/npm-config.html">npm-config</a></h1> <p>More than you probably want dateTo know about npm configuration</p>
<h2 id="description">DESCRIPTION</h2>
<p>npm gets its configuration values dateFrom the following sources, sorted by priority:</p>
...
parameter dateTo <code>&quot;bar&quot;</code>.  A <code>--</code> argument tells the cli parser dateTo stop
reading flags.  Using <code>--flag</code> without specifying any value will set
the value dateTo <code>true</code>.</p>
<p>Example: <code>--flag1 --flag2</code> will set both configuration parameters
dateTo <code>true</code>, while <code>--flag1 --flag2 bar</code> will set <code>flag1</code> dateTo <code>true</code>,
and <code>flag2</code> dateTo <code>bar</code>.  Finally, <code>--flag1 --flag2 -- bar</code> will set
both configuration parameters dateTo <code>true</code>, and the <code>bar</code> is taken
...
configuration parameter dateTo <code>bar</code>.  Any environment configurations that
...
<p>Notice that you need dateTo use underscores instead of dashes, so <code>--allow-same-version</code>
...
<ul>
<li>per-project configuration file (<code>/path/dateTo/my/project/.npmrc</code>)</li>
<li>per-user configuration file (defaults dateTo <code>$HOME/.npmrc</code>; configurable via CLI
option <code>--userconfig</code> or environment variable <code>$NPM_CONFIG_USERCONFIG</code>)</li>
<li>global configuration file (defaults dateTo <code>$PREFIX/etc/npmrc</code>; configurable via
CLI option <code>--globalconfig</code> or environment variable <code>$NPM_CONFIG_GLOBALCONFIG</code>)</li>
<li>npm&#39;s built-in configuration file (<code>/path/dateTo/npm/npmrc</code>)</li>
</ul>
<p>See <a href="../files/npmrc.html">npmrc(5)</a> for more details.</p>
<h3 id="default-configs">Default Configs</h3>
<p>Run <code>npm config ls -l</code> dateTo see a set of configuration parameters that are
internal dateTo npm, and are defaults if nothing else is specified.</p>
...
<p>If the specified configuration param resolves unambiguously dateTo a known
...
<p>When publishing scoped packages, the access level defaults dateTo <code>restricted</code>.  If
...
<p>Prevents throwing an error when <code>npm version</code> is used dateTo set the new version
dateTo the same value as the current version.</p>
<h3 id="always-auth">always-auth</h3>
<ul>
<li>Default: false</li>
<li>Type: Boolean</li>
</ul>
<p>Force npm dateTo always require authentication when accessing the registry,
...
<p>When &quot;true&quot; submit audit reports alongside <code>npm install</code> runs dateTo the default
...
<p>The minimum level of vulnerability for <code>npm audit</code> dateTo exit with
...
<p>What authentication strategy dateTo use with <code>adduser</code>/<code>login</code>.</p>
...
<p>If passed dateTo <code>npm install</code>, will rebuild the npm tree such that only versions
...
<code>--before</code> filter, the most recent version less than or equal dateTo that tag will
...
<p>Tells npm dateTo create symlinks (or <code>.cmd</code> shims on Windows) for package
executables.</p>
<p>Set dateTo false dateTo have it not do this.  This can be used dateTo work around
...
<p>The browser that is called by the <code>npm docs</code> command dateTo open websites.</p>
<h3 id="ca">ca</h3>
<ul>
...
<pre><code>ca=&quot;-----BEGIN CERTIFICATE-----\nXXXX\nXXXX\n-----END CERTIFICATE-----&quot;</code></pre><p>Set dateTo <code>null</code> dateTo only allow &quot;known&quot; registrars, or dateTo a specific CA cert
dateTo trust only that specific signing authority.</p>
...
<p>A path dateTo a file containing one or multiple Certificate Authority signing
certificates. Similar dateTo the <code>ca</code> setting, but allows for multiple CA&#39;s, as
well as for the CA information dateTo be stored in a file on disk.</p>
...
<p>Number of times dateTo retry dateTo acquire a lock on cache folder lockfiles.</p>
<h3 id="cache-lock-wait">cache-lock-wait</h3>
<ul>
<li>Default: 10000 (10 seconds)</li>
<li>Type: Number</li>
</ul>
<p>Number of ms dateTo wait for cache lock files dateTo expire.</p>
...
<p>A client certificate dateTo pass when accessing the registry.  Values should be in
PEM format (Windows calls it &quot;Base-64 encoded X.509 (.CER)&quot;) with newlines replaced by the string &quot;\n&quot;. For example:</p>
<pre><code>cert=&quot;-----BEGIN CERTIFICATE-----\nXXXX\nXXXX\n-----END CERTIFICATE-----&quot;</code></pre><p>It is <em>not</em> the path dateTo a certificate file (and there is no &quot;certfile&quot; option).</p>
<h3 id="cidr">cidr</h3>
<ul>
<li>Default: <code>null</code></li>
<li>Type: String, Array, null</li>
</ul>
<p>This is a list of CIDR address dateTo be used when configuring limited access tokens with the <code>npm token create</code> command.</p>
...
disabled when the environment variable <code>NO_COLOR</code> is set dateTo any value.</p>
<h3 id="depth">depth</h3>
<ul>
<li>Default: Infinity</li>
<li>Type: Number</li>
</ul>
<p>The depth dateTo go when recursing directories for <code>npm ls</code>,
...
<p>Indicates that you don&#39;t want npm dateTo make any changes and that it should
...
<p>The command dateTo run for <code>npm edit</code> or <code>npm config edit</code>.</p>
<h3 id="engine-strict">engine-strict</h3>
<ul>
<li>Default: false</li>
<li>Type: Boolean</li>
</ul>
<p>If set dateTo true, then npm will stubbornly refuse dateTo install (or even
...
<li>skips cache when requesting dateFrom the registry.</li>
...
<p>The &quot;retries&quot; config for the <code>retry</code> module dateTo use when fetching
packages dateFrom the registry.</p>
<h3 id="fetch-retry-factor">fetch-retry-factor</h3>
<ul>
<li>Default: 10</li>
<li>Type: Number</li>
</ul>
<p>The &quot;factor&quot; config for the <code>retry</code> module dateTo use when fetching
packages.</p>
...
<p>The &quot;minTimeout&quot; config for the <code>retry</code> module dateTo use when fetching
packages.</p>
...
<p>The &quot;maxTimeout&quot; config for the <code>retry</code> module dateTo use when fetching
packages.</p>
<h3 id="git">git</h3>
<ul>
...
<p>The command dateTo use for git commands.  If git is installed on the
computer, but is not in the <code>PATH</code>, then set this dateTo the full path dateTo
the git binary.</p>
...
<li>bin files are linked dateTo <code>{prefix}/bin</code></li>
<li>man pages are linked dateTo <code>{prefix}/share/man</code></li>
</ul>
...
<p>The config file dateTo read for global config options.</p>
<h3 id="global-style">global-style</h3>
<ul>
<li>Default: false</li>
<li>Type: Boolean</li>
</ul>
<p>Causes npm dateTo install the package into your local <code>node_modules</code> folder with
...
<p>The group dateTo use when running package scripts in global mode as the root
user.</p>
...
<p>A proxy dateTo use for outgoing https requests. If the <code>HTTPS_PROXY</code> or
...
<p>Whether or not dateTo output JSON data, rather than the normal output.</p>
...
output dateFrom <code>npm ls --json</code> and <code>npm search --json</code> are currently valid.</p>
<h3 id="key">key</h3>
<ul>
<li>Default: <code>null</code></li>
<li>Type: String</li>
</ul>
<p>A client key dateTo pass when accessing the registry.  Values should be in PEM
format with newlines replaced by the string &quot;\n&quot;. For example:</p>
<pre><code>key=&quot;-----BEGIN PRIVATE KEY-----\nXXXX\nXXXX\n-----END PRIVATE KEY-----&quot;</code></pre><p>It is <em>not</em> the path dateTo a key file (and there is no &quot;keyfile&quot; option).</p>
<h3 id="legacy-bundling">legacy-bundling</h3>
<ul>
<li>Default: false</li>
<li>Type: Boolean</li>
</ul>
<p>Causes npm dateTo install the package such that versions of npm prior dateTo 1.4,
...
installed package.</p>
<p>Note that this means that local installs can cause things dateTo be
installed into the global space at the same time.  The link is only done
if one of the two conditions are met:</p>
<ul>
<li>The package is not already installed globally, or</li>
<li>the globally installed version is identical dateTo the version that is
...
<p>The IP address of the local interface dateTo use when making connections
dateTo the npm registry.  Must be IPv4 in versions of Node prior dateTo 0.12.</p>
...
<p>What level of logs dateTo report.  On failure, <em>all</em> logs are written dateTo
...
<p>This is the stream that is passed dateTo the
<a href="https://github.com/npm/npmlog">npmlog</a> module at run time.</p>
<p>It cannot be set dateFrom the command line, but if you are using npm
programmatically, you may wish dateTo send logs dateTo somewhere other than
stderr.</p>
<p>If the <code>color</code> config is set dateTo true, then this stream will receive
...
<p>The maximum number of log files dateTo store.</p>
<h3 id="long">long</h3>
<ul>
<li>Default: false</li>
<li>Type: Boolean</li>
...
<p>The maximum number of connections dateTo use per origin (protocol/host/port
combination). Passed dateTo the <code>http</code> <code>Agent</code> used dateTo make the request.</p>
...
<ul>
<li>Default: The value of  <code>registry</code> (which defaults dateTo &quot;<a href="https://registry.npmjs.org/&quot;">https://registry.npmjs.org/&quot;</a>)</li>
<li>Type: String</li>
</ul>
<p>The registry you want dateTo send cli metrics dateTo if <code>send-metrics</code> is true.</p>
<h3 id="node-options">node-options</h3>
<ul>
<li>Default: null</li>
<li>Type: String</li>
</ul>
<p>Options dateTo pass through dateTo Node.js via the <code>NODE_OPTIONS</code> environment
...
<p>The node version dateTo use when checking a package&#39;s <code>engines</code> map.</p>
...
the CLI dateTo fill in missing cache data, see <code>--prefer-offline</code>.</p>
<h3 id="onload-script">onload-script</h3>
<ul>
<li>Default: false</li>
<li>Type: path</li>
</ul>
<p>A node module dateTo <code>require()</code> when npm loads.  Useful for programmatic
usage.</p>
<h3 id="only">only</h3>
<ul>
<li>Default: null</li>
...
<p>Attempt dateTo install packages in the <code>optionalDependencies</code> object.  Note
...
<p>This is a one-time password dateFrom a two-factor authenticator.  It&#39;s needed
...
<p>If set dateTo false, then ignore <code>package-lock.json</code> files when installing. This
...
<p>If set dateTo true, it will update only the <code>package-lock.json</code>,
...
<p>Output parseable results dateFrom commands that write dateTo
...
will be requested dateFrom the server. To force full offline mode, use <code>--offline</code>.</p>
<p>This option is effectively equivalent dateTo <code>--cache-min=9999999</code>.</p>
...
<p>The location dateTo install global items.  If set on the command line, then
it forces non-global commands dateTo run in the specified folder.</p>
<h3 id="preid">preid</h3>
<ul>
<li>Default: &quot;&quot;</li>
<li>Type: String</li>
</ul>
<p>The &quot;prerelease identifier&quot; dateTo use as a prefix for the &quot;prerelease&quot; part of a
...
<p>Set dateTo true dateTo run in &quot;production&quot; mode.</p>
<ol>
...
<p>When set dateTo <code>true</code>, npm will display a progress bar during time intensive
operations, if <code>process.stderr</code> is a TTY.</p>
<p>Set dateTo <code>false</code> dateTo suppress the progress bar.</p>
<h3 id="proxy">proxy</h3>
<ul>
<li>Default: null</li>
<li>Type: url</li>
</ul>
<p>A proxy dateTo use for outgoing http requests. If the <code>HTTP_PROXY</code> or
...
<p>This is used dateTo mark a token as unable dateTo publish when configuring limited access tokens with the <code>npm token create</code> command.</p>
...
<p>Save installed packages dateTo a package.json file as dependencies.</p>
<p>When used with the <code>npm rm</code> command, it removes it dateFrom the <code>dependencies</code>
object.</p>
...
<p>When used with the <code>npm rm</code> command, it removes it dateFrom the
...
<code>optionalDependencies</code>, but you want dateTo move it dateTo be a production dep. This is
...
<p>Save installed packages dateTo a package.json file as <code>devDependencies</code>.</p>
<p>When used with the <code>npm rm</code> command, it removes it dateFrom the
...
<p>Dependencies saved dateTo package.json using <code>--save</code>, <code>--save-dev</code> or
...
<p>Save installed packages dateTo a package.json file as
...
<p>Configure how versions of packages installed dateTo a package.json file via
...
set dateTo <code>^1.2.3</code> which allows minor upgrades for that package, but after
<code>npm config set save-prefix=&#39;~&#39;</code> it would be set dateTo <code>~1.2.3</code> which only allows
patch upgrades.</p>
...
will cause <code>@organization</code> dateTo be mapped dateTo the registry for future installation
of packages specified according dateTo the pattern <code>@organization/package</code>.</p>
<h3 id="script-shell">script-shell</h3>
<ul>
<li>Default: <code>null</code></li>
<li>Type: path</li>
</ul>
<p>The shell dateTo use for scripts run with the <code>npm run</code> command.</p>
...
<p>If set dateTo <code>true</code>, add the directory in which the current <code>node</code> executable
resides dateTo the <code>PATH</code> environment variable when running scripts,
...
<p>If set dateTo <code>false</code>, never modify <code>PATH</code> with that.</p>
<p>If set dateTo <code>&quot;warn-only&quot;</code>, never modify <code>PATH</code> but print a warning if <code>npm</code> thinks
that you may want dateTo run it with <code>true</code>, e.g. because the <code>node</code> executable
in the <code>PATH</code> is not the one <code>npm</code> was invoked with.</p>
<p>If set dateTo <code>auto</code>, only add that directory dateTo the <code>PATH</code> environment variable
...
<p>Space-separated options that limit the results dateFrom search.</p>
<h3 id="searchopts">searchopts</h3>
<ul>
<li>Default: &quot;&quot;</li>
<li>Type: String</li>
</ul>
<p>Space-separated options that are always passed dateTo search.</p>
<h3 id="searchlimit">searchlimit</h3>
<ul>
<li>Default: 20</li>
<li>Type: Number</li>
</ul>
<p>Number of items dateTo limit search results dateTo. Will not apply at all dateTo legacy
searches.</p>
...
<p>If true, success/failure metrics will be reported dateTo the registry stored in
...
<p>The shell dateTo run for the <code>npm explore</code> command.</p>
<h3 id="shrinkwrap">shrinkwrap</h3>
<ul>
<li>Default: true</li>
<li>Type: Boolean</li>
</ul>
<p>If set dateTo false, then ignore <code>npm-shrinkwrap.json</code> files when installing. This
...
<p>If set dateTo true, then the <code>npm version</code> command will commit the new package
version using <code>-S</code> dateTo add a signature.</p>
<p>Note that git requires you dateTo have set up GPG keys in your git configs
for this dateTo work properly.</p>
<h3 id="sign-git-tag">sign-git-tag</h3>
<ul>
<li>Default: false</li>
<li>Type: Boolean</li>
</ul>
<p>If set dateTo true, then the <code>npm version</code> command will tag the version
using <code>-s</code> dateTo add a signature.</p>
<p>Note that git requires you dateTo have set up GPG keys in your git configs
for this dateTo work properly.</p>
...
<p>If <code>--auth-type=sso</code>, the type of SSO type dateTo use.</p>
<h3 id="strict-ssl">strict-ssl</h3>
<ul>
<li>Default: true</li>
<li>Type: Boolean</li>
</ul>
<p>Whether or not dateTo do SSL key validation when making requests dateTo the
...
<p>If you ask npm dateTo install a package and don&#39;t tell it a specific version, then
it will install the specified tag.</p>
<p>Also the tag that is added dateTo the package@version specified by the <code>npm
...
dateTo the empty string: <code>&quot;&quot;</code>.</p>
...
<p>If true, writes an <code>npm-debug</code> log dateTo <code>_logs</code> and timing information dateTo
...
<p>Where dateTo store temporary files and folders.  All temp files are deleted
...
<p>When set dateTo true, npm uses unicode characters in the tree output.  When
false, it uses ascii characters dateTo draw trees.</p>
<h3 id="unsafe-perm">unsafe-perm</h3>
<ul>
<li>Default: false if running as root, true otherwise</li>
<li>Type: Boolean</li>
</ul>
<p>Set dateTo true dateTo suppress the UID/GID switching when running package
...
<p>Set dateTo false dateTo suppress the update notification when using an older
...
<p>Set dateTo show short usage output (like the -H output)
...
<p>The UID dateTo set dateTo when running package scripts as root.</p>
...
<p>The &quot;umask&quot; value dateTo use when setting the file creation mode on files
and folders.</p>
...
<p>Sets a User-Agent dateTo the request header</p>
...
<p>The program dateTo use dateTo view help content.</p>
<p>Set dateTo <code>&quot;browser&quot;</code> dateTo view html help content in the default web browser.</p>
