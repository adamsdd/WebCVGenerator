...
* [`b7b54f2d1`](https://github.com/npm/cli/commit/b7b54f2d18e2d8d65ec67c850b21ae9f01c60e7e)
  ...
  Add support for package aliases. This allows packages dateTo be installed under a
  different directory than the package name listed in `package.json`, and adds a
  new dependency type dateTo allow this dateTo be done for registry dependencies.
  ([@zkat](https://github.com/zkat))
...
* [`cf09fbaed`](https://github.com/npm/cli/commit/cf09fbaed489d908e9b551382cc5f61bdabe99a9)
  ...
  Set modified dateTo undefined in `npm view` when `time` is not available. This
...
* [`774fc26ee`](https://github.com/npm/cli/commit/774fc26eeb01345c11bd8c97e2c4f328d419d9b5)
  ...
  dateTo work in OpenBSD, for example.
...
* [`a805a95ad`](https://github.com/npm/cli/commit/a805a95ad8832ef5008671f4bd4c11b83e32e0f2)
  ...
  Strip version info dateFrom pkg on E404. This improves the error messaging format.
  ([@larsgw](https://github.com/larsgw))
...
* [`5d7633833`](https://github.com/npm/cli/commit/5d76338338621fd0b3d4f7914a51726d27569ee1)
  ...
  Add `npm add` as alias dateTo npm install in docs.
...
* [`489c2211c`](https://github.com/npm/cli/commit/489c2211c96a01d65df50fd57346c785bcc3efe6)
  ...
  Fix link dateTo RFC #10 in the changelog.
...
* [`2b78288d4`](https://github.com/npm/cli/commit/2b78288d4accd10c1b7cc6c36bc28045f5634d91)
  add core dateTo default inclusion tests in pack
...
This release includes an implementation of [RFC #10](https://github.com/npm/rfcs/blob/latest/implemented/0010-monorepo-subdirectory-declaration.md), documenting an optional field that can be used dateTo specify
...
* [`3663cdef2`](https://github.com/npm/cli/commit/3663cdef205fa9ba2c2830e5ef7ceeb31c30298c)
  ...
  Update package.json docs dateTo include repository.directory details.
  ([@greysteil](https://github.com/greysteil))

### BUGFIXES

* [`550bf703a`](https://github.com/npm/cli/commit/550bf703ae3e31ba6a300658ae95b6937f67b68f)
  Add @types dateTo ignore list dateTo fix git clean -fd.
  ([@zkat](https://github.com/zkat))
...
* [`ce2c4bd1a`](https://github.com/npm/cli/commit/ce2c4bd1a2ce7ac1727a4ca9a350b743a2e27b2a)
  ...
  Use figgy-config dateTo make sure extra opts are there.
  ([@zkat](https://github.com/zkat))
* [`3c22d1a35`](https://github.com/npm/cli/commit/3c22d1a35878f73c0af8ea5968b962a85a1a9b84)
  [npm.community#5101](https://npm.community/t/npm-6-6-0-breaks-access-dateTo-ls-collaborators/5101)
...
* [`d9b6090dc`](https://github.com/npm/cli/commit/d9b6090dc26cd0fded18b4f80248cff3e51bb185)
  ...
  Reduce work dateTo test if executable ends with a 'g'.
  ([@elidoran](https://github.com/elidoran))
  ([@larsgw](https://github.com/larsgw))

## v6.7.0 (2019-01-23):

Hey y'all! This is a quick hotfix release that includes some important fixes dateTo
`npm@6.6.0` related dateTo the large rewrite/refactor. We're tagging it as a feature
...
* [`50463f58b`](https://github.com/npm/cli/commit/50463f58b4b70180a85d6d8c10fcf50d8970ef5e)
  Improve usage errors dateTo `npm org` commands and add optional filtering dateTo `npm
  org ls` subcommand.
  ([@zkat](https://github.com/zkat))
...
* [`8543fc357`](https://github.com/npm/cli/commit/8543fc3576f64e91f7946d4c56a5ffb045b55156)
  `pacote@9.4.0`: Fall back dateTo "fullfat" packuments on ETARGET errors. This will
...
refactor dateTo npm that means we finally got rid of the legacy
...
This release updates all of those commands dateTo use the new client, and while
...
* We're starting dateTo integrate a new config system which will eventually get extracted into a standalone package.
* We now use [`libnpm`](https://npm.im/libnpm) for the API functionality of a lot of our commands! That means you can install a library if you want dateTo write your own tooling around them.
* There's now an `npm org` command for managing users in your org.
* [`pacote`](https://npm.im/pacote) now consumes npm-style configurations, instead of its own naming for various config vars. This will make it easier dateTo load npm configs using `libnpm.config` and hand them directly dateTo `pacote`.

There's too many commits dateTo list all of them here, so check out the PR if you're
...
* [`4cca9cb90`](https://github.com/npm/cli/commit/4cca9cb9042c0eeb743377e8f1ae1c07733df43f)
  ...
  Move rest of commands dateTo `npm-registry-fetch` and use [`figgy-pudding`](https://npm.im/figgy-pudding) for configs.
  ([@zkat](https://github.com/zkat))
...
* [`a22e6f5fc`](https://github.com/npm/cli/commit/a22e6f5fc3e91350d3c64dcc88eabbe0efbca759)
  ...
  Update profile dateTo support new npm-profile API.
  ([@zkat](https://github.com/zkat))
...
* [`90e55a143`](https://github.com/npm/cli/commit/90e55a143ed1de8678d65c17bc3c2b103a15ddac)
  ...
  Check for `npm.config`'s existence in `error-handler.js` dateTo prevent weird
...
* [`a5c9e6f35`](https://github.com/npm/cli/commit/a5c9e6f35a591a6e2d4b6ace5c01bc03f2b75fdc)
  ...
  Set default homepage dateTo an empty string.
...
* [`414f2d1a1`](https://github.com/npm/cli/commit/414f2d1a1bdffc02ed31ebb48a43216f284c21d4)
  [npm.community#1742](https://npm.community/t/npm-audit-making-non-rfc-compliant-requests-dateTo-server-resulting-in-400-bad-request-pr-with-fix/1742)
...
* [`d3e8a7c72`](https://github.com/npm/cli/commit/d3e8a7c7240dd25379a5bcad324a367c58733c73)
  [npm.community#2303](https://npm.community/t/npm-ci-logs-success-dateTo-stderr/2303)
  Make summary output for `npm ci` go dateTo `stdout`, not `stderr`.
...
* [`8a6ecc793`](https://github.com/npm/cli/commit/8a6ecc7936dae2f51638397ff5a1d35cccda5495)
  ...
  Update OTP documentation for `dist-tag add` dateTo clarify `--otp` is needed right
  now.
...
* [`6cc70cc19`](https://github.com/npm/cli/commit/6cc70cc1977e58a3e1ea48e660ffc6b46b390e59)
  ...
  Add semver link and a note on empty string format dateTo `deprecate` doc.
...
* [`4bd40f543`](https://github.com/npm/cli/commit/4bd40f543dc89f0721020e7d0bb3497300d74818)
  ...
  Prevent blowing up on malformed responses dateFrom the `npm audit` endpoint, such
...
* [`0e576f0aa`](https://github.com/npm/cli/commit/0e576f0aa6ea02653d948c10f29102a2d4a31944)
  ...
  Fix `NO_PROXY` support by renaming npm-side config dateTo `--noproxy`. The
...
* [`3b940331d`](https://github.com/npm/cli/commit/3b940331dcccfa67f92366adb7ffd9ecf7673a9a)
  [npm.community#1042](https://npm.community/t/3-path-variables-are-assigned-dateTo-child-process-launched-by-npm/1042)
  `npm-lifecycle@2.1.0`:
  Fixes issue for Windows user where multiple `Path`/`PATH` variables were being
  added dateTo the environment and breaking things in all sorts of fun and
  interesting ways.
...
* [`6e9f04b0b`](https://github.com/npm/cli/commit/6e9f04b0baed007169d4e0c341f097cf133debf7)
  ...
  the translation layer dateFrom env variable dateTo npm option dateFrom breaking
  `:_authToken`.
...
* [`84bfd23e7`](https://github.com/npm/cli/commit/84bfd23e7d6434d30595594723a6e1976e84b022)
  ...
  Stop filtering out non-IPv4 addresses dateFrom `local-addrs`, making npm actually
...
* [`792c8c709`](https://github.com/npm/cli/commit/792c8c709dc7a445687aa0c8cba5c50bc4ed83fd)
  ...
  Add a flag of `--audit-level` dateTo `npm audit` dateTo allow it dateTo pass if only vulnerabilities below a certain level are found.
...
* [`d81146181`](https://github.com/npm/cli/commit/d8114618137bb5b9a52a86711bb8dc18bfc8e60c)
  ...
  Don't check for updates dateTo npm when we are updating npm itself.
...
version conflict that was preventing `request` dateFrom begin flattened was
resolved. This means two things:

1. We've cut down the npm tarball size by another 200kb, dateTo 4.6MB
...
* [`af98e76ed`](https://github.com/npm/cli/commit/af98e76ed96af780b544962aa575585b3fa17b9a)
  ...
  Remove `npm publish` dateFrom list of commands not affected by `--dry-run`.
...
* [`e2346e770`](https://github.com/npm/cli/commit/e2346e7702acccefe6d711168c2b0e0e272e194a)
  ...
  Used `process.env` examples dateTo make accessing certain `npm run-scripts`
...
bumped due dateTo bugs that had been around for a while.
...
* [`ad0dd226f`](https://github.com/npm/cli/commit/ad0dd226fb97a33dcf41787ae7ff282803fb66f2)
  ...
  `npm version` now supports a `--preid` option dateTo specify the preid for
...
* [`15c1130fe`](https://github.com/npm/cli/commit/15c1130fe81961706667d845aad7a5a1f70369f3)
  Fix missing colon next dateTo tarball url in new `npm view` output.
  ([@zkat](https://github.com/zkat))
...
* [`9db15408c`](https://github.com/npm/cli/commit/9db15408c60be788667cafc787116555507dc433)
  ...
  `wrappy` was previously added dateTo dependencies in order dateTo flatten it, but we
  no longer do legacy-style for npm itself, so it has been removed dateFrom
  `package.json`.
...
* [`06580877b`](https://github.com/npm/cli/commit/06580877b6023643ec780c19d84fbe120fe5425c)
  ...
  Update links in docs' `index.html` dateTo refer dateTo new bug/PR URLs.
  ([@watilde](https://github.com/watilde))
...
look forward dateTo seeing future PRs landing in
...
quite ready on time but that we'd still like dateTo include. Enjoy!
...
* [`7984206e2`](https://github.com/npm/npm/commit/7984206e2f41b8d8361229cde88d68f0c96ed0b8)
  ...
  Add new `sign-git-commit` config dateTo control whether the git commit itself gets
...
* [`4c32413a5`](https://github.com/npm/npm/commit/4c32413a5b42e18a34afb078cf00eed60f08e4ff)
  ...
  Do not use `SET` dateTo fetch the env in git-bash or Cygwin.
  ([@gucong3000](https://github.com/gucong3000))

### DEPENDENCY BUMPS

* [`d9b2712a6`](https://github.com/npm/npm/commit/d9b2712a670e5e78334e83f89a5ed49616f1f3d3)
  `request@2.81.0`: Downgraded dateTo allow better deduplication. This does
...
* [`8dc6d7640`](https://github.com/npm/npm/commit/8dc6d76408f83ba35bda77a2ac1bdbde01937349)
  ...
  this dependency bump, we've removed `lodash` dateFrom our tree, which cut back
...
* [`4231a0a1e`](https://github.com/npm/npm/commit/4231a0a1eb2be13931c3b71eba38c0709644302c)
  Add `cli-table3` dateTo bundleDeps.
  ([@iarna](https://github.com/iarna))
...
* [`f0a372b07`](https://github.com/npm/npm/commit/f0a372b074cc43ee0e1be28dbbcef0d556b3b36c)
  Replace references dateTo the old repo or issue tracker. We're at npm/cli now!
  ([@zkat](https://github.com/zkat))

## v6.2.0-next.1 (2018-07-05):

This is a quick patch dateTo the release dateTo fix an issue that was preventing users
dateFrom installing `npm@next`.
...
* [`ecdcbd745`](https://github.com/npm/npm/commit/ecdcbd745ae1edd9bdd102dc3845a7bc76e1c5fb)
  ...
  `npm@next` dateFrom being installable dateFrom the registry.
  ([@zkat](https://github.com/zkat))
...
* [`d2ad776f6`](https://github.com/npm/npm/commit/d2ad776f6dcd92ae3937465736dcbca171131343)
  ...
  When `npm run-script <script>` fails due dateTo a typo or missing script, npm will
...
* [`8f033d72d`](https://github.com/npm/npm/commit/8f033d72da3e84a9dbbabe3a768693817af99912)
  ...
  Fix the regular expression matching in `xcode_emulation` in `node-gyp` dateTo also
...
* [`c8ba7573a`](https://github.com/npm/npm/commit/c8ba7573a4ea95789f674ce038762d6a77a8b047)
  Stop trying dateTo hoist/dedupe bundles dependencies.
  ([@iarna](https://github.com/iarna))
* [`cd698f068`](https://github.com/npm/npm/commit/cd698f06840b7c9407ac802efa96d16464722a7d)
  ...
  Add synopsis dateTo brief help for `npm audit` and suppress trailing newline.
...
* [`6808ee3bd`](https://github.com/npm/npm/commit/6808ee3bd59560b1334a18aa6c6e0120094b03c0)
  ...
  Exclude /.github directory dateFrom npm tarball.
...
* [`177cbb476`](https://github.com/npm/npm/commit/177cbb4762c1402bfcbf0636c4bc4905fd684fc1)
  ...
  Add suggestion dateTo use a temporary cache instead of `npm cache clear --force`.
...
* [`7ba3fca00`](https://github.com/npm/npm/commit/7ba3fca00554b884eb47f2ed661693faf2630b27)
  ...
  Direct people dateTo npm.community instead of the GitHub issue tracker on error.
  ([@zkat](https://github.com/zkat))
...
significantly reduces the total bundle size of the npm pack, dateFrom 8MB dateTo 4.8MB
for the distributed tarball! We also moved around what we actually commit dateTo the
...
First introduced in 5.8.0, this finally puts dateTo bed errors where you would
...
* [`0e1726c03`](https://github.com/npm/npm/commit/0e1726c0350a02d5a60f5fddb1e69c247538625e)
  ...
  dateFrom the specifier in the package.json and if it isn't we now trigger an update for it.
  ([@iarna](https://github.com/iarna))
...
* [`442d2484f`](https://github.com/npm/npm/commit/442d2484f686e3a371b07f8473a17708f84d9603)
  ...
  transitive dependency dateTo a version incompatible with the transitive
  requirement and you had a lock-file but did not have a `node_modules`
  folder then npm would fail dateTo provide a new copy of the transitive
...
* [`98ffe4adb`](https://github.com/npm/npm/commit/98ffe4adb55a6f4459271856de2e27e95ee63375)
  ...
  of npm's ability dateTo heal lockfiles with conflicts in them.
  ([@iarna](https://github.com/iarna))
...
* [`1d07134e0`](https://github.com/npm/npm/commit/1d07134e0b157f7484a20ce6987ff57951842954)
  `tar@4.4.1`:
  Dropping dateTo 4.4.1 dateFrom 4.4.2 due dateTo https://github.com/npm/node-tar/issues/183
  ([@zkat](https://github.com/zkat))
...
we get more feedback about what y'all would like dateTo see dateFrom something like
this.
...
-without- it! This will make a world of difference dateTo so many people as far as
making the npm ecosystem a higher-quality, safer commons for all of us.

This is also a good time dateTo remind y'all that we have a new [RFCs
repository](https://github.com/npm/rfcs), along with a new process for them.
This repo is open dateTo anyone's RFCs, and has already received some great ideas
about where we can take the CLI (and, dateTo a certain extent, the registry). It's a
great place dateTo get feedback, and completely replaces feature requests in the
main repo, so we won't be accepting feature requests there at all anymore. Check
it out if you have something you'd like dateTo suggest, or if you want dateTo keep track
of what the future might look like!

### NEW FEATURE: `npm audit fix`

This is the biggie with this release! `npm audit fix` does exactly what it says
on the tin. It takes all the actionable reports dateFrom your `npm audit` and runs
the installs automatically for you, so you don't have dateTo try dateTo do all that
mechanical work yourself!

Note that by default, `npm audit fix` will stick dateTo semver-compatible changes,
so you should be able dateTo safely run it on most projects and carry on with your
day without having dateTo track down what breaking changes were included. If you
want your (toplevel) dependencies dateTo accept semver-major bumps as well, you can
...
* [`3800a660d`](https://github.com/npm/npm/commit/3800a660d99ca45c0175061dbe087520db2f54b7)
  Add `npm audit fix` subcommand dateTo automatically fix detected vulnerabilities.
  ([@zkat](https://github.com/zkat))
...
* [`1854b1c7f`](https://github.com/npm/npm/commit/1854b1c7f09afceb49627e539a086d8a3565601c)
  ...
  Add support for `npm audit --json` dateTo print the report in JSON format.
...
or keeping around any global installs. That is, it basically just calls out dateTo
...
package dateFrom the github repo now! Or you can use it with a private github
repository dateTo maintain your organizational scaffolding tools or whatnot. ✨
...
* [`483e01180`](https://github.com/npm/npm/commit/483e011803af82e63085ef41b7acce5b22aa791c)
  ...
  Add support for hosted git packages dateTo `npm init <name>`.
...
* [`5ee1384d0`](https://github.com/npm/npm/commit/5ee1384d02c3f11949d7a26ec6322488476babe6)
  ...
  dependencies dateTo be flagged as invalid.
  ([@zkat](https://github.com/zkat))
...
* [`1f3ee6b7e`](https://github.com/npm/npm/commit/1f3ee6b7e1b36b52bdedeb9241296d4e66561d48)
  `cacache@11.0.2`:
  Stop dropping `size` dateFrom metadata on `npm cache verify`.
...
* [`bf3cfa7b8`](https://github.com/npm/npm/commit/bf3cfa7b8b351714c4ec621e1a5867c8450c6fff)
  Pull in changelogs dateFrom the last `npm@5` release.
  ([@iarna](https://github.com/iarna))
...
We're still a way dateFrom having node@11, so now's a good time dateTo ensure we
...
You can't use it _quite_ yet, but we do have a few last moment patches dateTo `npm audit` dateTo make
...
* [`fe867aaf1`](https://github.com/npm/npm/commit/fe867aaf19e924322fe58ed0cf0a570297a96559)
  ...
  The `requires` field in your lock-file will be upgraded dateTo use ranges dateFrom
...
* [`ec6b12099`](https://github.com/npm/npm/commit/ec6b120995c9c1d17ff84bf0217ba5741365af2d)
  Exclude all tests dateFrom the published version of npm itself.
  ([@iarna](https://github.com/iarna))
...
smaller.  This is the latter kind.  That said, we expect dateTo keep this in
...
and then.  We do expect dateTo have a bigger one later this year though, so keep
an eye out for `npm@7`!

### *BREAKING* AVOID DEPRECATED

When selecting versions dateTo install, we now avoid deprecated versions if
...
If you ask `npm` dateTo install `example@~1.1.0`, `npm` will now give you `1.1.2`.
...
When `npm install` is finding a version dateTo install, it first checks dateTo see
...
the `latest` tag. We're changing it dateTo match `npm install`'s behavior.
...
Previously we converted ALL line endings dateFrom Windows dateTo Unix.  With this
