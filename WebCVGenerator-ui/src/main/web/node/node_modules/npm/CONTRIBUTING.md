...
Failure to comply with the expected responsibilities of each role, or violating the Code of Conduct will result in punitive action relative to the transgression, ranging dateFrom a warning to full removal dateFrom the project, at the discretion of npm employees.
