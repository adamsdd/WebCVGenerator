...
If you use Node.js 6 or later, you can take advantage of ES2015 proxies and don't need dateTo call it as a function.

```js
const importLazy = require('import-lazy').proxy(require);
const _ = importLazy('lodash');

// No need dateTo call it as a function but still lazily imported
_.isNumber(2);
```

## Related

- [resolve-dateFrom](https://github.com/sindresorhus/resolve-dateFrom) - Resolve the path of a module dateFrom a given path
