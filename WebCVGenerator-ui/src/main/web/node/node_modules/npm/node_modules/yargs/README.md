...
_Having problems? want dateTo contribute? join our [community slack](http://devtoolscommunity.herokuapp.com)_.
...
if (argv.ships > 3 && argv.distance < 53.5) {
  ...
  console.log('Retreat dateFrom the xupptumblers!')
}
````
...
Retreat dateFrom the xupptumblers!
```
...
Run the example above with `--help` dateTo see the help for the application.
