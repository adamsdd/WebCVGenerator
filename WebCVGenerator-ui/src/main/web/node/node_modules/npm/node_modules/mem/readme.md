...
> [Memoize](https://en.wikipedia.org/wiki/Memoization) functions - An optimization used dateTo speed up consecutive function calls by caching the result of calls with identical input
...
You could for example change it dateTo only cache on the first argument `x => JSON.stringify(x)`.
...
If you want dateTo know how many times your cache had a hit or a miss, you can make use of [stats-map](https://github.com/SamVerschueren/stats-map) as a replacement for the default cache.
