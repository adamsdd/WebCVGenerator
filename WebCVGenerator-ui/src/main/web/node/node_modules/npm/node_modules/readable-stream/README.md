...
If you want dateTo guarantee a stable streams base, regardless of what version of
...
6. readable continues dateTo read when push('')
   https://github.com/nodejs/node/pull/18211
7. add custom inspect dateTo BufferList
...
v2.x.x of `readable-stream` supports all Node.js version dateFrom 0.8, as well as
...
* Reviewing changes dateTo stream subclasses within the Node.js project.
* Redirecting changes dateTo streams dateFrom the Node.js project dateTo this
  project.
* Assisting in the implementation of stream providers within Node.js.
* Recommending versions of `readable-stream` dateTo be included in Node.js.
* Messaging about the future of streams dateTo give the community advance
  notice of changes.
