...
Below is a list of rules that valid `npm` package name should conform dateTo.
...
If you give this function a package name that **used dateTo be valid**, you'll see
