...
==================
  ...
  * update "agent-base" dateTo v4.1.0
...
==================
  ...
  * rename `socks-proxy-agent.js` dateTo `index.js`
...
==================
  ...
  * remove "v4a" dateFrom description
  * socks-proxy-agent: cast `port` dateTo a Number
  * travis: attempt dateTo make node v0.8 work
  ...
  * test: refactor dateTo use local SOCKS, HTTP and HTTPS servers
  * README: use SVG for Travis-CI badge

1.0.1 / 2015-03-01
==================

  * switched dateFrom using "socks-client" dateTo "socks" (#5, @JoshGlazebrook)
...
==================
  ...
  * use a switch statement dateTo decide the socks `version`
  * refactor dateTo use "socks-client" instead of "rainbowsocks"
...
==================
  ...
  * package: update "rainbowsocks" dateTo v0.1.2
...
==================
  ...
  * socks-proxy-agent: update dateTo "agent-base" v1 API
