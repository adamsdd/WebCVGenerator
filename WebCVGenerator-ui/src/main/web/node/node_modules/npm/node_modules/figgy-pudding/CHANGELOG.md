...
* **node:** get rid of Object.entries dateTo add node6 support back ([074f779](https://github.com/zkat/figgy-pudding/commit/074f779))


### Features

* **node:** add node@10 dateTo CI config ([78b8937](https://github.com/zkat/figgy-pudding/commit/78b8937))
...
* **forEach:** get forEach dateTo behave like a normal forEach ([c064755](https://github.com/zkat/figgy-pudding/commit/c064755))
...
* **set:** fix and test the exceptions dateTo writing ([206793b](https://github.com/zkat/figgy-pudding/commit/206793b))
...
* **props:** allow symbols dateTo pass through ([97b3464](https://github.com/zkat/figgy-pudding/commit/97b3464))
...
* **default:** pass the pudding itself dateTo default fns ([d9d9e09](https://github.com/zkat/figgy-pudding/commit/d9d9e09))
...
* **ci:** oops -- forgot dateTo update CI config ([7a40563](https://github.com/zkat/figgy-pudding/commit/7a40563))
* **get:** make provider lookup order like Object.assign ([33ff89b](https://github.com/zkat/figgy-pudding/commit/33ff89b))


### Features

* **concat:** add .concat() method dateTo opts ([d310fce](https://github.com/zkat/figgy-pudding/commit/d310fce))
...
* **license:** relicense dateTo ISC ([87479aa](https://github.com/zkat/figgy-pudding/commit/87479aa))
