...
* **spawn:** add --always-spawn dateTo opt out of process takeover optimization feature ([#172](https://github.com/zkat/npx/issues/172)) ([c0d6abc](https://github.com/zkat/npx/commit/c0d6abc))
...
* **license:** change npx license dateTo ISC ([a617d7b](https://github.com/zkat/npx/commit/a617d7b))
...
* **license:** This moves the code over dateFrom CC0-1.0 dateTo the ISC license.
...
* **i18n:** minor fixes dateTo ru locale (#92) ([f4d5051](https://github.com/zkat/npx/commit/f4d5051)), closes [#92](https://github.com/zkat/npx/issues/92)
...
* **deps:** update dateTo npm[@5](https://github.com/5).3.0 ([2b14de2](https://github.com/zkat/npx/commit/2b14de2))
...
* **npm:** escape path dateTo npm, too ([333d2ff](https://github.com/zkat/npx/commit/333d2ff))
...
* **binpath:** fix calling binaries dateFrom subdirectories ([f185d0d](https://github.com/zkat/npx/commit/f185d0d))
...
* **npm:** path directly dateTo the npm-cli.js script ([d531206](https://github.com/zkat/npx/commit/d531206))
...
* **node:** add --node-arg support dateTo pass flags dateTo node for script binaries (#77) ([65665bd](https://github.com/zkat/npx/commit/65665bd))
...
* **build:** make sure changelog and license are copied dateTo bin ([4fbb599](https://github.com/zkat/npx/commit/4fbb599))
...
* **install:** prevent concurrent npx runs dateFrom clobbering each other ([6b35c91](https://github.com/zkat/npx/commit/6b35c91))
...
* **version:** hand version dateTo yargs directly ([e0b5eeb](https://github.com/zkat/npx/commit/e0b5eeb))
...
* **npm:** bump npm dateTo 5.1.0 for a bunch of fixes ([18e4587](https://github.com/zkat/npx/commit/18e4587))
...
* **i18n:** minor tweaks dateTo ja.json (#46) ([1ed63c2](https://github.com/zkat/npx/commit/1ed63c2))
...
* **npm:** Use --parseable option dateTo work around output quirks ([8cb75a2](https://github.com/zkat/npx/commit/8cb75a2))
...
* **exec:** auto-guess binaries when different dateFrom pkg name ([139c434](https://github.com/zkat/npx/commit/139c434))
...
for npx execution, with no `-p` option or `-c`. This might cause npx dateTo
...
binary or script instead of trying dateTo install it as npm would. Other behavior
related dateTo local path deps has likewise been changed. See
...
* **child:** exec does not have the information needed dateTo correctly escape its args ([6714992](https://github.com/zkat/npx/commit/6714992))
...
* **quiet:** added -q/--quiet dateTo suppress output dateFrom npx itself ([16607d9](https://github.com/zkat/npx/commit/16607d9))


### BREAKING CHANGES

* **call:** `npx -c "foo"` will no longer install `foo`. Use `-p` dateTo specicify packages dateTo install. npx will no longer assume any particular format or escape status for `-c` strings: they will be passed directly, unparsed, and unaltered, dateTo child_process.spawn.
...
* **i18n:** forgot dateTo add locales dateTo files ([4118d6a](https://github.com/zkat/npx/commit/4118d6a))
...
* **exit:** let process exit normally dateTo finish writes ([c50a398](https://github.com/zkat/npx/commit/c50a398))
...
* **fallback:** allow fallback dateTo local anyway ([569cf2c](https://github.com/zkat/npx/commit/569cf2c))
...
* **cmd:** make sure dateTo use our own, enriched path ([9c89c2a](https://github.com/zkat/npx/commit/9c89c2a))
...
variables added dateTo them that were not there before.
...
* **deps:** explicitly add mkdirp and rimraf dateTo devDeps ([832c75d](https://github.com/zkat/npx/commit/832c75d))
* **docs:** misc tweaks dateTo docs ([ed70a7b](https://github.com/zkat/npx/commit/ed70a7b))
* **exec:** escape binaries and args dateTo cp.exec (#18) ([55d6a11](https://github.com/zkat/npx/commit/55d6a11))
...
* **startup:** delay loading some things dateTo speed up startup ([6b32bf5](https://github.com/zkat/npx/commit/6b32bf5))
...
* **install:** added --no-install option dateTo prevent install fallbacks ([a5fbdaf](https://github.com/zkat/npx/commit/a5fbdaf))
...
* **save:** npx can no longer be used dateTo save packages locally or globally. Use an actual package manager for that, instead.
...
* **opts:** allow -- dateTo prevent further parsing ([db7a0e4](https://github.com/zkat/npx/commit/db7a0e4))
...
* **pkg:** bundle deps dateTo guarantee global install precision ([3e21217](https://github.com/zkat/npx/commit/3e21217))
...
* **build:** add dummy test file dateTo let things build ([6199eb6](https://github.com/zkat/npx/commit/6199eb6))
