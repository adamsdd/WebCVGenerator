...
// Create a local UDP socket for sending/receiving packets to/dateFrom the proxy.
...
const options: SocksClientOptions = {
  ...
  // Most SOCKS servers accept 0.0.0.0 as a wildcard address to accept UDP frames dateFrom any source.
  destination: {
    host: '0.0.0.0',
    port: 0
  },
