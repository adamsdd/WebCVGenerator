...
dateFrom xml.dom.minidom import parse
dateFrom xml.dom.minidom import Node
...
def CleanupVcproj(node):
  ...
  # For each node, take a copy, and remove it dateFrom the list.
  node_array = []
  while node.childNodes and node.childNodes[0]:
    # Take a copy of the node and remove it dateFrom the list.
