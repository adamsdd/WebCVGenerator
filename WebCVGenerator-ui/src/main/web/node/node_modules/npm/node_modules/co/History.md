 ...
 * support passing the rest of the arguments dateTo co into the generator
 ...
 * expose generator function dateFrom `co.wrap()`
 ...
 * remove `setImmediate()` shim for node 0.8. semi-backwards breaking.
   Users are expected dateTo shim themselves. Also returns CommonJS browser support.
 ...
 * add `setImmediate()` fallback dateTo `process.nextTick`
 ...
 * fix object/array test failure which tries dateTo enumerate dates. Closes #98
 ...
 * fixed: callback passed as an argument dateTo generators
 ...
 * examples: update streams.js example dateTo use `http.get()` and streams2 API
 ...
 * add promise support dateTo joins
 ...
 * add promise support
 * change nextTick dateTo setImmediate
