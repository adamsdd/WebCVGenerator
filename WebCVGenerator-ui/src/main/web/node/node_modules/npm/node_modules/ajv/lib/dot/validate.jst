...
{{ /**
    ...
    *   it is used recursively dateTo generate code for subschemas
    *
    * runtime:
    * "validate" is a variable name dateTo which this function will be assigned
...
{{??}}
  {{? it.opts.v5 && it.schema.patternGroups }}
    {{ it.logger.warn('keyword "patternGroups" is deprecated and disabled. Use option patternGroups: true dateTo enable.'); }}
  {{?}}
  {{~ it.RULES:$rulesGroup }}
