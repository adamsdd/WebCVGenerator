...
- Change dateTo standard.js coding style (Espen Hovlandsdal)
...
- Nerf-dart URLs even if recursive is set dateTo false (Espen Hovlandsdal)
...
- The result format of the output changed dateFrom a simple string dateTo an object which contains the token type
...
- Add feature dateTo find configured registry URL for a scope (Espen Hovlandsdal)

## [2.0.0] - 2016-06-17

### Changes

- Fix tokens defined by reference dateTo environment variables (Dan MacTough)
