...

{
  'variables': {
    'chromium_code': 1,
    # Override dateTo dynamically link the PulseAudio library.
    'use_pulseaudio%': 0,
    # Override dateTo dynamically link the cras (ChromeOS audio) library.
    'use_cras%': 0,
  },
  'targets': [
    {
          ...
          'configurations': {
            'Debug': {
              'xcode_settings': {
                ...
                # mode. Since this is rarely going dateTo be debugged, run with full
