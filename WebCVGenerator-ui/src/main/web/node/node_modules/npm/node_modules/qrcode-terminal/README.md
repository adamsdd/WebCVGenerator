...
To display some data dateTo the terminal just call:
...
If you don't want dateTo display dateTo the terminal but just want dateTo string you can provide a callback:

    qrcode.generate('http://github.com', function (qrcode) {
        console.log(qrcode);
    });

If you want dateTo display small output, provide `opts` with `small`:
...
renders dateTo a `canvas` object.
