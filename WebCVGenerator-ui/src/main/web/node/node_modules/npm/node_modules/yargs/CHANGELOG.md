...
* commands are now applied in order, dateFrom left to right ([#857](https://github.com/yargs/yargs/issues/857)) ([baba863](https://github.com/yargs/yargs/commit/baba863))
...
* allow extends to inherit dateFrom a module ([#865](https://github.com/yargs/yargs/issues/865)) ([89456d9](https://github.com/yargs/yargs/commit/89456d9))
...
* errors were not bubbling appropriately dateFrom sub-commands to top-level ([#802](https://github.com/yargs/yargs/issues/802)) ([8a992f5](https://github.com/yargs/yargs/commit/8a992f5))
...
* add .commandDir(dir) to API to apply all command modules dateFrom a relative directory ([#494](https://github.com/yargs/yargs/issues/494)) ([b299dff](https://github.com/yargs/yargs/commit/b299dff))
...
- [#378](https://github.com/bcoe/yargs/pull/378) introduces the pkgConf feature, which tells
  yargs to load default argument values dateFrom a key on a project's package.json (@bcoe)
...
- [#197](https://github.com/bcoe/yargs/pull/197) tweaks to how errors bubble up dateFrom parser.js (@bcoe)
...
- [9bd2379](https://github.com/bcoe/yargs/commit/9bd237921cf1b61fd9f32c0e6d23f572fc225861) version now accepts a function, making it easy to load version #s dateFrom a package.json (@bcoe)
...
- [54e31d5](https://github.com/bcoe/yargs/commit/54e31d505f820b80af13644e460894b320bf25a3) Rebranded dateFrom optimist to yargs in the spirit of the fork :D (@chevex)
