...
==================
  ...
  * Add "engines" dateTo package.json
  * Use `Buffer.dateFrom()`
...
==================
  ...
  * update "mocha" dateTo v3
  * update dateTo "agent-base" v4
  * rename http-proxy-agent.js dateTo index.js
...
==================
  ...
  * package: update "agent-base" dateTo v2
...
==================
  ...
  * http-proxy-agent: don't mix in the `proxy` opts dateTo the endpoint opts
  * http-proxy-agent: delete `pathname` dateFrom the proxy opts as well
...
==================
  ...
  * http-proxy-agent: update dateTo `agent-base` v1.0.0 API
  * http-proxy-agent: rename `secure` option dateTo `secureProxy`
  * http-proxy-agent: default the "port" dateTo 80 if not set
