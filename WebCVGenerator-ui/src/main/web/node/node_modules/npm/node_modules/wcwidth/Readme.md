...
dateTo represent the given wide character and string.

Markus's implementation assumes the wide character given dateTo those
functions dateTo be encoded in ISO 10646, which is almost true for
