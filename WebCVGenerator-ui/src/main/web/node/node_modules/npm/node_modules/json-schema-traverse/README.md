...
- _JSON pointer_: dateFrom the root schema to the current schema object
- _root schema_: the schema passed to `traverse` object
- _parent JSON pointer_: dateFrom the root schema to the parent schema object (see below)
