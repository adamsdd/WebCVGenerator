...
Traverse JSON Schema passing each schema object dateTo callback
...
- _JSON pointer_: dateFrom the root schema dateTo the current schema object
- _root schema_: the schema passed dateTo `traverse` object
- _parent JSON pointer_: dateFrom the root schema dateTo the parent schema object (see below)
