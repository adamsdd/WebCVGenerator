...
var uniqueTmpfile = uniqueFilename('/tmp', 'testing', '/my/thing/dateTo/uniq/on')
```
...
*fileprefix* – A string dateTo append prior dateTo the unique part of the filename.
...
then this string plus a hyphen are prepended dateTo the unique part.
