...
```
  ...
  If you want dateTo convert a `co`-generator-function into a regular function that returns a promise,
...
## Platform Compatibility
  ...
  flag or just `--harmony` dateTo get access dateTo generators.
