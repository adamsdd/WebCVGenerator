...
==================
  ...
  * test: add remove excess calls dateTo removeSocket
  * test: use egg-ci
  * test: refactor test with eslint rules
  * feat: merge _http_agent.js dateFrom 7.2.1
...
==================
  ...
  * fix: pick _evictSession dateTo httpsAgent
 ...
 * fix: add default error handler dateTo avoid Unhandled error event throw

2.0.2 / 2015-04-25
==================

 * fix: remove socket dateFrom freeSockets on 'timeout' (@pmalouin)

2.0.1 / 2015-04-19
==================

 * fix: add timeoutSocketCount dateTo getCurrentStatus()
 ...
 * patch dateFrom iojs: don't overwrite servername option
 * patch commits dateFrom joyent/node
...
==================
  ...
  * add original http.js module dateTo diff
  * update jscover
  * mv pem dateTo fixtures
