...
* A pair of patches dateTo fix some fd leaks.  We would leak fds with sync use
...
* Allow chown and mode options dateTo be set dateTo false dateTo disable the defaulting behavior. (#20)
