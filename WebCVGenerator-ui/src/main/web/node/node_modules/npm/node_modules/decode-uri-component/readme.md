...
- Decodes `+` dateTo a space.
- Converts the [BOM](https://en.wikipedia.org/wiki/Byte_order_mark) dateTo a [replacement character](https://en.wikipedia.org/wiki/Specials_(Unicode_block)#Replacement_character) `�`.
