...
* assignment dateTo readonly property dateTo allow running in strict mode ([#270](https://github.com/kelektiv/node-uuid/issues/270)) ([d062fdc](https://github.com/kelektiv/node-uuid/commit/d062fdc))
...
* (fix) Add .npmignore file dateTo exclude test/ and other non-essential files dateFrom packing. (#183)
* Fix typo (#178)
* Simple typo fix (#165)
...
* Expose RNG option dateTo allow for perf testing with different generators


# 1.3.0

* Support for version 1 ids, thanks dateTo [@ctavan](https://github.com/ctavan)!
