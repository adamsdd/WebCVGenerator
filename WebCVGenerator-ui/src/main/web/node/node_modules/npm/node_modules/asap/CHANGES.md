...
The "raw" layer depends on the tasks dateTo catch thrown exceptions and unravel
Node.js domains.
...
Tasks are no longer required dateTo be functions, but can rather be any object that
implements `task.call()`.
With this feature you can recycle task objects dateTo avoid garbage collector churn
