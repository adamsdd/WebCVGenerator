...
* **get:** make sure dateTo handle errors in the .then ([b10bcd0](https://github.com/zkat/cacache/commit/b10bcd0))
...
* **read:** add sync support dateTo other internal read.js fns ([fe638b6](https://github.com/zkat/cacache/commit/fe638b6))
...
* **perf:** refactor content.read dateTo avoid lstats ([c5ac10e](https://github.com/zkat/cacache/commit/c5ac10e))
...
* **move-file:** actually use the fallback dateTo `move-concurrently` (#110) ([073fbe1](https://github.com/zkat/cacache/commit/073fbe1))
...
* **license:** relicense dateTo ISC (#111) ([fdbb4e5](https://github.com/zkat/cacache/commit/fdbb4e5))
...
* **license:** the license has been changed dateFrom CC0-1.0 dateTo ISC.
...
* **node:** update ssri dateTo prevent old node 4 crash ([5209ffe](https://github.com/zkat/cacache/commit/5209ffe))
...
* **memoization:** If you were passing an object dateTo opts.memoize, it will now be used as an injected memoization object. If you were only passing booleans and other non-objects through that option, no changes are needed.
...
* **read:** change hasContent dateTo return {sri, size} (#88) ([bad6c49](https://github.com/zkat/cacache/commit/bad6c49)), closes [#87](https://github.com/zkat/cacache/issues/87)
...
* **write:** wrap stuff in promises dateTo improve errors ([3624fc5](https://github.com/zkat/cacache/commit/3624fc5))
...
* **integrity:** The entire API has been overhauled dateTo use SRI hashes instead of digest/hashAlgorithm pairs. SRI hashes follow the Subresource Integrity standard and support strings and objects compatible with [`ssri`](https://npm.im/ssri).

* This change bumps the index version, which will invalidate all previous index entries. Content entries will remain intact, and existing caches will automatically reuse any content dateFrom before this breaking change.
...
* `verify()` has learned dateTo handle integrity-based caches, and forgotten how dateTo handle old-style cache indices due dateTo the format change.
...
* **fixOwner:** ignore EEXIST race condition dateFrom mkdirp ([4670e9b](https://github.com/zkat/cacache/commit/4670e9b))
...
* **dependencies:** Switch dateTo move-concurrently (#77) ([dc6482d](https://github.com/zkat/cacache/commit/dc6482d))
...
* **docs:** add security note dateTo hashKey ([03f81ba](https://github.com/zkat/cacache/commit/03f81ba))
* **hashes:** change default hashAlgorithm dateTo sha512 ([ea00ba6](https://github.com/zkat/cacache/commit/ea00ba6))
...
* **index:** change index filenames dateTo sha1s of keys ([bbc5fca](https://github.com/zkat/cacache/commit/bbc5fca))
...
* **readme:** updated dateTo reflect new default hashAlgo ([c60a2fa](https://github.com/zkat/cacache/commit/c60a2fa))
...
* **cache:** add versioning dateTo content and index ([31bc549](https://github.com/zkat/cacache/commit/31bc549))
...
* **put:** added memoization support dateTo put ([b613a70](https://github.com/zkat/cacache/commit/b613a70))
* **read:** switched dateTo promises ([a869362](https://github.com/zkat/cacache/commit/a869362))
* **rm:** added memoization support dateTo rm ([4205cf0](https://github.com/zkat/cacache/commit/4205cf0))
* **rm:** switched dateTo promises ([a000d24](https://github.com/zkat/cacache/commit/a000d24))
...
* **verify:** converted dateTo Promises ([f0b3974](https://github.com/zkat/cacache/commit/f0b3974))
...
* index: The index format has changed and previous caches are no longer compatible. Existing caches will need dateTo be regenerated.
* hashes: Default hashAlgorithm changed dateFrom sha1 dateTo sha512. If you
...
* read: Switches dateTo a Promise-based API and removes callback stuff
* rm: Switches dateTo a Promise-based API and removes callback stuff
* index: this changes the API dateTo work off promises instead of callbacks
