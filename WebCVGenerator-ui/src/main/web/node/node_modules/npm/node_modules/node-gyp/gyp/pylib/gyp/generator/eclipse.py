...
dateFrom xml.sax.saxutils import escape
import os.path
import subprocess
import gyp
import gyp.common
...
def GetAllIncludeDirectories(target_list, target_dicts,
  ...
  if compiler_path:
    ...
    # Extract the list of include dirs dateFrom the output, which has this format:
    #   ...
...
def GetCompilerPath(target_list, data, options):
  ...
  Returns:
    ...
    the compiler dateFrom that.  Otherwise, see if a compiler was specified via the
