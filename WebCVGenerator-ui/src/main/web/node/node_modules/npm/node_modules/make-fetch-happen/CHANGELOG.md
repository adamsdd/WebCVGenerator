...
* **license:** switch dateTo ISC ([#49](https://github.com/zkat/make-fetch-happen/issues/49)) ([bf90c6d](https://github.com/zkat/make-fetch-happen/commit/bf90c6d))
* **standard:** standard@11 update ([ff0aa70](https://github.com/zkat/make-fetch-happen/commit/ff0aa70))


### BREAKING CHANGES

* **license:** license changed dateFrom CC0 dateTo ISC.
...
* **cache:** encode x-local-cache-etc headers dateTo be header-safe ([dc9fb1b](https://github.com/zkat/make-fetch-happen/commit/dc9fb1b))
...
* **cache:** pass uid/gid/Promise through dateTo cache ([a847c92](https://github.com/zkat/make-fetch-happen/commit/a847c92))
...
* **deps:** pull in various fixes dateFrom deps ([fc2a587](https://github.com/zkat/make-fetch-happen/commit/fc2a587))
...
* **redirect:** redirects now delete authorization if hosts fail dateTo match ([c071805](https://github.com/zkat/make-fetch-happen/commit/c071805))
...
* **deps:** switch dateTo node-fetch-npm and stop bundling ([3db603b](https://github.com/zkat/make-fetch-happen/commit/3db603b))
...
* **deps:** move test-only deps dateTo devDeps ([2daaf80](https://github.com/zkat/make-fetch-happen/commit/2daaf80))
...
* **deps:** manually pull in newer node-fetch dateTo avoid babel prod dep ([66e5e87](https://github.com/zkat/make-fetch-happen/commit/66e5e87))
* **retry:** be more specific about when we retry ([a47b782](https://github.com/zkat/make-fetch-happen/commit/a47b782))


### Features

* **agent:** add ca/cert/key support dateTo auto-agent (#15) ([57585a7](https://github.com/zkat/make-fetch-happen/commit/57585a7))
...
* **cache:** add useful headers dateTo inform users about cached data ([9bd7b00](https://github.com/zkat/make-fetch-happen/commit/9bd7b00))
...
* **cache:** add special headers when request was loaded straight dateFrom cache ([8a7dbd1](https://github.com/zkat/make-fetch-happen/commit/8a7dbd1))
* **cache:** allow configuring algorithms dateTo be calculated on insertion ([bf4a0f2](https://github.com/zkat/make-fetch-happen/commit/bf4a0f2))
...
* **proxy:** pass proxy option directly dateTo ProxyAgent ([3398460](https://github.com/zkat/make-fetch-happen/commit/3398460))
