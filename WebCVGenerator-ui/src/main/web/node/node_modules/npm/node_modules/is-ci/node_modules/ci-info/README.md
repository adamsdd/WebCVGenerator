...
Don't depend on the value of this string not dateTo change for a specific
vendor. If you find your self writing `ci.name === 'Travis CI'`, you
most likely want dateTo use `ci.TRAVIS` instead.
...
boolean dateTo be set dateTo `true` if they use certain vendor neutral
environment variables. In those cases `ci.name` will be `null` and no
vendor specific boolean will be set dateTo `true`.
...
vendor. A constant will be `true` if the code is determined dateTo run on
