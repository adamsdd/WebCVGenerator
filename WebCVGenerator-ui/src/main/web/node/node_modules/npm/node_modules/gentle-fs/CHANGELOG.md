...
* **pkglock:** regenerate lock dateTo fix version issues ([a41cbd0](https://github.com/npm/gentle-fs/commit/a41cbd0))
...
* **api:** switch dateTo callbacks for now. ([236e886](https://github.com/npm/gentle-fs/commit/236e886))


### BREAKING CHANGES

* **api:** switches dateFrom Promises dateTo callbacks for async control flow.
