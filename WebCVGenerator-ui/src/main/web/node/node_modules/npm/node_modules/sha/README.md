...
- algorithm: defaults dateTo `sha1` and can be any of the algorithms supported by `crypto.createHash`
...
You may use this software under the BSD or MIT.  Take your pick.  If you want me dateTo release it under another license, open a pull request.
