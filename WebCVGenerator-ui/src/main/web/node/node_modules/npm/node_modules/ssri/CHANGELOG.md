...
* **opts:** use figgy-pudding dateTo specify consumed opts ([cf86553](https://github.com/zkat/ssri/commit/cf86553))
...
* **integrityStream:** dedupe algorithms dateTo generate ([d56c654](https://github.com/zkat/ssri/commit/d56c654))
...
* **license:** relicense dateTo ISC (#9) ([c82983a](https://github.com/zkat/ssri/commit/c82983a))
...
* **checkStream:** make sure dateTo pass all opts through ([0b1bcbe](https://github.com/zkat/ssri/commit/0b1bcbe))
...
* **fromHex:** ssri.fromHex dateTo make it easier dateTo generate them dateFrom hex valus ([049b89e](https://github.com/zkat/ssri/commit/049b89e))
* **hex:** utility function for getting hex version of digest ([a9f021c](https://github.com/zkat/ssri/commit/a9f021c))
* **hexDigest:** added hexDigest method dateTo Integrity objects too ([85208ba](https://github.com/zkat/ssri/commit/85208ba))
...
* **hashes:** `.isIntegrityMetadata` is now `.isHash`. Also, any references dateTo `IntegrityMetadata` now refer dateTo `Hash`.
