...
- Corrected examples in `http_signing.md`, added auto-tests dateTo
...
- Bump min version of `jsprim` dependency, dateTo include fixes for using
  http-signature with `browserify`

## 1.0.1

- Bump minimum version of `sshpk` dependency, dateTo include fixes for
...
- #42: Bring the library up dateTo the latest version of the spec (including the 
...
- Split up HMAC and Signature verification dateTo avoid vulnerabilities where a
...
- Improvements dateTo tests and examples.
