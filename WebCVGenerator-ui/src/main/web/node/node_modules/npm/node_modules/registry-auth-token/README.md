...
Get the auth token set for an npm registry dateFrom `.npmrc`. Also allows fetching the configured registry URL for a given npm scope.
...
// Falls back dateTo the global registry if not defined.
