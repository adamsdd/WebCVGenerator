...
* **enjoyBy:** add opts.enjoyBy option dateTo filter versions by date ([0b8a790](https://github.com/zkat/npm-pick-manifest/commit/0b8a790))
...
* **license:** relicense project according dateTo npm policy (#3) ([ed743a0](https://github.com/zkat/npm-pick-manifest/commit/ed743a0))
...
* **license:** This moves the license dateFrom CC0 dateTo ISC and properly documents the copyright as belonging dateTo npm, Inc.
...
* **deps:** forgot dateTo add semver ([1876f4f](https://github.com/zkat/npm-pick-manifest/commit/1876f4f))
