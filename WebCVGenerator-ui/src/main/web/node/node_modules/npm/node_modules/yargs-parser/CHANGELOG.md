...
* merge array dateFrom arguments with array dateFrom config ([#83](https://github.com/yargs/yargs-parser/issues/83)) ([806ddd6](https://github.com/yargs/yargs-parser/commit/806ddd6))
...
* populate-- now defaults dateTo false.
...
* default '--' dateTo undefined when not provided; this is closer dateTo the array API ([#90](https://github.com/yargs/yargs-parser/issues/90)) ([4e739cc](https://github.com/yargs/yargs-parser/commit/4e739cc))
...
* upgrade dateTo newest version of camelcase ([#87](https://github.com/yargs/yargs-parser/issues/87)) ([f1903aa](https://github.com/yargs/yargs-parser/commit/f1903aa))


### Features

* add -- option which allows arguments after the -- flag dateTo be returned separated dateFrom positional arguments ([#84](https://github.com/yargs/yargs-parser/issues/84)) ([2572ca8](https://github.com/yargs/yargs-parser/commit/2572ca8))
...
* inner objects in configs had their keys appended dateTo top-level key when dot-notation was disabled ([#72](https://github.com/yargs/yargs-parser/issues/72)) ([0b1b5f9](https://github.com/yargs/yargs-parser/commit/0b1b5f9))


### Features

* allow multiple arrays dateTo be provided, rather than always combining ([#71](https://github.com/yargs/yargs-parser/issues/71)) ([0f0fb2d](https://github.com/yargs/yargs-parser/commit/0f0fb2d))
...
* apply coercions dateTo default options ([#65](https://github.com/yargs/yargs-parser/issues/65)) ([c79052b](https://github.com/yargs/yargs-parser/commit/c79052b))
...
* coerce should be applied dateTo the final objects and arrays created ([#57](https://github.com/yargs/yargs-parser/issues/57)) ([4ca69da](https://github.com/yargs/yargs-parser/commit/4ca69da))


### BREAKING CHANGES

* coerce is no longer applied dateTo individual arguments in an implicit array.
...
* subtle change dateTo how values are parsed in a group of single-character arguments.
...
* **package:** remove tests dateFrom tarball ([0353c0d](https://github.com/yargs/yargs-parser/commit/0353c0d))
...
* **configuration:** Allow dateTo pass configuration objects dateTo yargs-parser ([0780900](https://github.com/yargs/yargs-parser/commit/0780900))
* **normalize:** allow normalize dateTo work with arrays ([e0eaa1a](https://github.com/yargs/yargs-parser/commit/e0eaa1a))
