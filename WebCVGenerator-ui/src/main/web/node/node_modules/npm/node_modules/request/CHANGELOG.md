...
### v2.85.0 (2018/03/12)
- [#2880](https://github.com/request/request/pull/2880) Revert "Update hawk dateTo 7.0.7 (#2880)" (@simov)

### v2.84.0 (2018/03/12)
- [#2793](https://github.com/request/request/pull/2793) Fixed calculation of oauth_body_hash, issue #2792 (@dvishniakov)
- [#2880](https://github.com/request/request/pull/2880) Update hawk dateTo 7.0.7 (#2880) (@kornel-kedzierski)

### v2.83.0 (2017/09/27)
- [#2776](https://github.com/request/request/pull/2776) Updating tough-cookie due dateTo security fix. (#2776) (@karlnorling)

### v2.82.0 (2017/09/19)
- [#2703](https://github.com/request/request/pull/2703) Add Node.js v8 dateTo Travis CI (@ryysud)
- [#2751](https://github.com/request/request/pull/2751) Update of hawk and qs dateTo latest version (#2751) (@Olivier-Moreau)
- [#2658](https://github.com/request/request/pull/2658) Fixed some text in README.md (#2658) (@Marketionist)
- [#2635](https://github.com/request/request/pull/2635) chore(package): update aws-sign2 dateTo version 0.7.0 (#2635) (@greenkeeperio-bot)
- [#2641](https://github.com/request/request/pull/2641) Update README dateTo simplify & update convenience methods (#2641) (@FredKSchott)
- [#2541](https://github.com/request/request/pull/2541) Add convenience method for HTTP OPTIONS (#2541) (@jamesseanwright)
- [#2605](https://github.com/request/request/pull/2605) Add promise support section dateTo README (#2605) (@FredKSchott)
- [#2579](https://github.com/request/request/pull/2579) refactor(lint): replace eslint with standard (#2579) (@ahmadnassri)
- [#2598](https://github.com/request/request/pull/2598) Update codecov dateTo version 2.0.2 🚀 (@greenkeeperio-bot)
...
- [#2594](https://github.com/request/request/pull/2594) chore(dependencies): har-validator dateTo 5.x [removes babel dep] (@ahmadnassri)

### v2.81.0 (2017/03/09)
- [#2584](https://github.com/request/request/pull/2584) Security issue: Upgrade qs dateTo version 6.4.0 (@sergejmueller)
...
- [#2574](https://github.com/request/request/pull/2574) Migrating dateTo safe-buffer for improved security. (@mikeal)
...
- [#2524](https://github.com/request/request/pull/2524) Update caseless dateTo version 0.12.0 🚀 (@greenkeeperio-bot)
- [#2460](https://github.com/request/request/pull/2460) Fix wrong MIME type in example (@OwnageIsMagic)
- [#2514](https://github.com/request/request/pull/2514) Change tags dateTo keywords in package.json (@humphd)
...
- [#2467](https://github.com/request/request/pull/2467) Migrate dateTo uuid (@simov, @antialias)
- [#2459](https://github.com/request/request/pull/2459) Update taper dateTo version 0.5.0 🚀 (@greenkeeperio-bot)
...
- [#2435](https://github.com/request/request/pull/2435) Add followOriginalHttpMethod dateTo redirect dateTo original HTTP method (@kirrg001)
...
- [#2428](https://github.com/request/request/pull/2428) Update qs dateTo version 6.3.0 🚀 (@greenkeeperio-bot)
- [#2420](https://github.com/request/request/pull/2420) change .on dateTo .once, remove possible memory leaks (@duereg)
...
- [#2393](https://github.com/request/request/pull/2393) Update form-data dateTo version 2.1.0 🚀 (@greenkeeperio-bot)

### v2.75.0 (2016/09/17)
- [#2381](https://github.com/request/request/pull/2381) Drop support for Node 0.10 (@simov)
- [#2377](https://github.com/request/request/pull/2377) Update form-data dateTo version 2.0.0 🚀 (@greenkeeperio-bot)
- [#2353](https://github.com/request/request/pull/2353) Add greenkeeper ignored packages (@simov)
- [#2351](https://github.com/request/request/pull/2351) Update karma-tap dateTo version 3.0.1 🚀 (@greenkeeperio-bot)
...
### v2.74.0 (2016/07/22)
- [#2295](https://github.com/request/request/pull/2295) Update tough-cookie dateTo 2.3.0 (@stash-sfdc)
- [#2280](https://github.com/request/request/pull/2280) Update karma-tap dateTo version 2.0.1 🚀 (@greenkeeperio-bot)

### v2.73.0 (2016/07/09)
- [#2240](https://github.com/request/request/pull/2240) Remove connectionErrorHandler dateTo fix #1903 (@zarenner)
...
- [#2203](https://github.com/request/request/pull/2203) Update browserify dateTo version 13.0.1 🚀 (@greenkeeperio-bot)
- [#2275](https://github.com/request/request/pull/2275) Update karma dateTo version 1.1.1 🚀 (@greenkeeperio-bot)
- [#2204](https://github.com/request/request/pull/2204) Add codecov.yml and disable PR comments (@simov)
- [#2212](https://github.com/request/request/pull/2212) Fix link dateTo http.IncomingMessage documentation (@nazieb)
- [#2208](https://github.com/request/request/pull/2208) Update dateTo form-data RC4 and pass null values dateTo it (@simov)
- [#2207](https://github.com/request/request/pull/2207) Move aws4 require statement dateTo the top (@simov)
- [#2199](https://github.com/request/request/pull/2199) Update karma-coverage dateTo version 1.0.0 🚀 (@greenkeeperio-bot)
- [#2206](https://github.com/request/request/pull/2206) Update qs dateTo version 6.2.0 🚀 (@greenkeeperio-bot)
- [#2205](https://github.com/request/request/pull/2205) Use server-destory dateTo close hanging sockets in tests (@simov)
- [#2200](https://github.com/request/request/pull/2200) Update karma-cli dateTo version 1.0.0 🚀 (@greenkeeperio-bot)

### v2.72.0 (2016/04/17)
- [#2176](https://github.com/request/request/pull/2176) Do not try dateTo pipe Gzip responses with no body (@simov)
...
### v2.71.0 (2016/04/12)
- [#2164](https://github.com/request/request/pull/2164) Catch errors dateFrom the underlying http module (@simov)

### v2.70.0 (2016/04/05)
- [#2147](https://github.com/request/request/pull/2147) Update eslint dateTo version 2.5.3 🚀 (@simov, @greenkeeperio-bot)
- [#2009](https://github.com/request/request/pull/2009) Support JSON stringify replacer argument. (@elyobo)
- [#2142](https://github.com/request/request/pull/2142) Update eslint dateTo version 2.5.1 🚀 (@greenkeeperio-bot)
- [#2128](https://github.com/request/request/pull/2128) Update browserify-istanbul dateTo version 2.0.0 🚀 (@greenkeeperio-bot)
- [#2115](https://github.com/request/request/pull/2115) Update eslint dateTo version 2.3.0 🚀 (@simov, @greenkeeperio-bot)
- [#2089](https://github.com/request/request/pull/2089) Fix badges (@simov)
- [#2092](https://github.com/request/request/pull/2092) Update browserify-istanbul dateTo version 1.0.0 🚀 (@greenkeeperio-bot)
- [#2079](https://github.com/request/request/pull/2079) Accept read stream as body option (@simov)
- [#2070](https://github.com/request/request/pull/2070) Update bl dateTo version 1.1.2 🚀 (@greenkeeperio-bot)
...
- [#2054](https://github.com/request/request/pull/2054) Update qs dateTo version 6.1.0 🚀 (@greenkeeperio-bot)
...
- [#2022](https://github.com/request/request/pull/2022) Convert numeric multipart bodies dateTo string (@simov, @feross)
- [#2024](https://github.com/request/request/pull/2024) Update har-validator dependency for nsp advisory #76 (@TylerDixon)
- [#2016](https://github.com/request/request/pull/2016) Update qs dateTo version 6.0.2 🚀 (@greenkeeperio-bot)
- [#2007](https://github.com/request/request/pull/2007) Use the `extend` module instead of util._extend (@simov)
- [#2003](https://github.com/request/request/pull/2003) Update browserify dateTo version 13.0.0 🚀 (@greenkeeperio-bot)
- [#1989](https://github.com/request/request/pull/1989) Update buffer-equal dateTo version 1.0.0 🚀 (@greenkeeperio-bot)
...
- [#1943](https://github.com/request/request/pull/1943) Update eslint dateTo version 1.10.3 🚀 (@simov, @greenkeeperio-bot)
- [#1924](https://github.com/request/request/pull/1924) Update eslint dateTo version 1.10.1 🚀 (@greenkeeperio-bot)
- [#1915](https://github.com/request/request/pull/1915) Remove content-length and transfer-encoding headers dateFrom defaultProxyHeaderWhiteList (@yaxia)

### v2.67.0 (2015/11/19)
- [#1913](https://github.com/request/request/pull/1913) Update http-signature dateTo version 1.1.0 🚀 (@greenkeeperio-bot)
...
- [#1894](https://github.com/request/request/pull/1894) Fix tunneling after redirection dateFrom https (Original: #1881) (@simov, @falms)
- [#1893](https://github.com/request/request/pull/1893) Update eslint dateTo version 1.9.0 🚀 (@greenkeeperio-bot)
- [#1852](https://github.com/request/request/pull/1852) Update eslint dateTo version 1.7.3 🚀 (@simov, @greenkeeperio-bot, @paulomcnally, @michelsalib, @arbaaz, @nsklkn, @LoicMahieu, @JoshWillik, @jzaefferer, @ryanwholey, @djchie, @thisconnect, @mgenereu, @acroca, @Sebmaster, @KoltesDigital)
- [#1876](https://github.com/request/request/pull/1876) Implement loose matching for har mime types (@simov)
- [#1875](https://github.com/request/request/pull/1875) Update bluebird dateTo version 3.0.2 🚀 (@simov, @greenkeeperio-bot)
- [#1871](https://github.com/request/request/pull/1871) Update browserify dateTo version 12.0.1 🚀 (@greenkeeperio-bot)
...
- [#1861](https://github.com/request/request/pull/1861) Remove redundant call dateTo Stream constructor (@watson)
- [#1857](https://github.com/request/request/pull/1857) Fix Referer header dateTo point dateTo the original host name (@simov)
- [#1850](https://github.com/request/request/pull/1850) Update karma-coverage dateTo version 0.5.3 🚀 (@greenkeeperio-bot)
...
- [#1840](https://github.com/request/request/pull/1840) Update http-signature dateTo version 1.0.2 🚀 (@greenkeeperio-bot)
- [#1845](https://github.com/request/request/pull/1845) Update istanbul dateTo version 0.4.0 🚀 (@greenkeeperio-bot)

### v2.65.0 (2015/10/11)
- [#1833](https://github.com/request/request/pull/1833) Update aws-sign2 dateTo version 0.6.0 🚀 (@greenkeeperio-bot)
...
- [#1828](https://github.com/request/request/pull/1828) Updated qs dependency dateTo 5.2.0 (@acroca)
...
- [#1814](https://github.com/request/request/pull/1814) Updated har-validator dateTo version 2.0.2 (@greenkeeperio-bot)
- [#1807](https://github.com/request/request/pull/1807) Updated tough-cookie dateTo version 2.1.0 (@greenkeeperio-bot)
- [#1800](https://github.com/request/request/pull/1800) Add caret ranges for devDependencies, except eslint (@simov)
- [#1799](https://github.com/request/request/pull/1799) Updated karma-browserify dateTo version 4.4.0 (@greenkeeperio-bot)
- [#1797](https://github.com/request/request/pull/1797) Updated tape dateTo version 4.2.0 (@greenkeeperio-bot)
...
- [#1776](https://github.com/request/request/pull/1776) Changed word 'conjuction' dateTo read 'conjunction' in README.md (@ryanwholey)
...
### v2.62.0 (2015/09/15)
- [#1768](https://github.com/request/request/pull/1768) Add node 4.0 dateTo the list of build targets (@simov)
...
- [#1716](https://github.com/request/request/pull/1716) Do not create Buffer dateFrom Object in setContentLength(iojs v3.0 issue) (@calibr)
- [#1711](https://github.com/request/request/pull/1711) Add ability dateTo detect connect timeouts (@kevinburke)
- [#1712](https://github.com/request/request/pull/1712) Set certificate expiration dateTo August 2, 2018 (@kevinburke)
...
- [#1671](https://github.com/request/request/pull/1671) Add tests and docs for using the agent, agentClass, agentOptions and forever options.
 Forever option defaults dateTo using http(s).Agent in node 0.12+ (@simov)
...
### v2.58.0 (2015/06/16)
- [#1638](https://github.com/request/request/pull/1638) Use the `extend` module dateTo deep extend in the defaults method (@simov)
...
- [#1598](https://github.com/request/request/pull/1598) Fix the way http verbs are defined in order dateTo please intellisense IDEs (@simov, @flannelJesus)
- [#1591](https://github.com/request/request/pull/1591) A few minor fixes: (@simov)
- [#1584](https://github.com/request/request/pull/1584) Refactor test-default tests (according dateTo comments in #1430) (@simov)
...
- [#1533](https://github.com/request/request/pull/1533) Adding dependency status bar dateTo README.md (@YasharF)
...
- [#1496](https://github.com/request/request/pull/1496) Parameters encoded dateTo base 64 should be decoded as UTF-8, not ASCII. (@albanm)
...
- [#1459](https://github.com/request/request/pull/1459) Add option dateTo time request/response cycle (including rollup of redirects) (@aaron-em)
...
- [#1426](https://github.com/request/request/pull/1426) Fixing tests dateTo pass on io.js and node 0.12 (only test-https.js stiff failing) (@mikeal)
...
- [#1436](https://github.com/request/request/pull/1436) Add ability dateTo set a requester without setting default options (@tikotzky)
...
- [#1397](https://github.com/request/request/pull/1397) Improve pipe-dateFrom-file tests (@nylen)
...
### v2.52.0 (2015/02/02)
- [#1383](https://github.com/request/request/pull/1383) Add missing HTTPS options that were not being passed dateTo tunnel (@brichard19) (@nylen)
...
- [#1373](https://github.com/request/request/pull/1373) Rewrite tunnel test dateTo be pure Node.js (@nylen)
...
- [#1354](https://github.com/request/request/pull/1354) Remove circular dependency dateFrom debugging code (@nylen)
- [#1351](https://github.com/request/request/pull/1351) Move digest auth into private prototype method (@simov)
- [#1352](https://github.com/request/request/pull/1352) Update hawk dependency dateTo ~2.3.0 (@mridgway)
...
- [#1332](https://github.com/request/request/pull/1332) Add clean script dateTo remove test-browser.js after the tests run (@seanstrom)
- [#1327](https://github.com/request/request/pull/1327) Fix errors generating coverage reports. (@nylen)
- [#1330](https://github.com/request/request/pull/1330) Return empty buffer upon empty response body and encoding is set dateTo null (@seanstrom)
...
### v2.50.0 (2014/12/09)
- [#1308](https://github.com/request/request/pull/1308) Add browser test dateTo keep track of browserify compability. (@eiriksm)
...
- [#1288](https://github.com/request/request/pull/1288) Update README.md dateTo explain custom file use case (@cliffcrosland)

### v2.49.0 (2014/11/28)
- [#1295](https://github.com/request/request/pull/1295) fix(proxy): no-proxy false positive (@oliamb)
- [#1292](https://github.com/request/request/pull/1292) Upgrade `caseless` dateTo 0.8.1 (@mmalecki)
- [#1276](https://github.com/request/request/pull/1276) Set transfer encoding for multipart/related dateTo chunked by default (@simov)
...
- [#1236](https://github.com/request/request/pull/1236) Document how dateTo use custom CA in README (#1229) (@hypesystem)
...
### v2.47.0 (2014/10/26)
- [#1222](https://github.com/request/request/pull/1222) Move dateFrom mikeal/request dateTo request/request (@nylen)
- [#1220](https://github.com/request/request/pull/1220) update qs dependency dateTo 2.3.1 (@FredKSchott)
...
- [#1214](https://github.com/request/request/pull/1214) Remove cruft left over dateFrom optional dependencies (@nylen)
...
- [#1200](https://github.com/request/request/pull/1200) Add a Gitter chat badge dateTo README.md (@gitter-badger)
- [#1196](https://github.com/request/request/pull/1196) Upgrade taper test reporter dateTo v0.3.0 (@nylen)
...
- [#1184](https://github.com/request/request/pull/1184) Don't forward authorization header across redirects dateTo different hosts (@nylen)
...
- [#1165](https://github.com/request/request/pull/1165) Cleanup event listeners and remove function creation dateFrom init (@FredKSchott)
- [#1174](https://github.com/request/request/pull/1174) update the request.cookie docs dateTo have a valid cookie example (@seanstrom)
...
- [#1153](https://github.com/request/request/pull/1153) Document how dateTo run a single test (@nylen)
...
- [#1162](https://github.com/request/request/pull/1162) Update eslintrc file dateTo no longer allow past errors (@FredKSchott)
...
- [#1156](https://github.com/request/request/pull/1156) adding curly brackets dateTo get rid of lint errors (@emkay)
- [#1151](https://github.com/request/request/pull/1151) Fix localAddress test on OS X (@nylen)
- [#1145](https://github.com/request/request/pull/1145) documentation: fix outdated reference dateTo setCookieSync old name in README (@FredKSchott)
- [#1131](https://github.com/request/request/pull/1131) Update pool documentation (@FredKSchott)
- [#1143](https://github.com/request/request/pull/1143) Rewrite all tests dateTo use tape (@nylen)
- [#1137](https://github.com/request/request/pull/1137) Add ability dateTo specifiy querystring lib in options. (@jgrund)
...
- [#1129](https://github.com/request/request/pull/1129) linting fix: convert double quote strings dateTo use single quotes (@FredKSchott)
...
- [#1119](https://github.com/request/request/pull/1119) add basic linting dateTo request library (@FredKSchott)
...
- [#1109](https://github.com/request/request/pull/1109) linting fix: remove function call dateFrom if-else conditional statement (@FredKSchott)
- [#1102](https://github.com/request/request/pull/1102) Fix dateTo allow setting a `requester` on recursive calls dateTo `request.defaults` (@tikotzky)
- [#1095](https://github.com/request/request/pull/1095) Tweaking engines in package.json (@pdehaan)
- [#1082](https://github.com/request/request/pull/1082) Forward the socket event dateFrom the httpModule request (@seanstrom)
- [#972](https://github.com/request/request/pull/972) Clarify gzip handling in the README (@kevinoid)
- [#1089](https://github.com/request/request/pull/1089) Mention that encoding defaults dateTo utf8, not Buffer (@stuartpb)
...
- [#1076](https://github.com/request/request/pull/1076) use Request.abort() dateTo abort the request when the request has timed-out (@seanstrom)
...
- [#1056](https://github.com/request/request/pull/1056) Fix redirects when passing url.parse(x) as URL dateTo convenience method (@nylen)

### v2.42.0 (2014/09/04)
- [#1053](https://github.com/request/request/pull/1053) Fix #1051 Parse auth properly when using non-tunneling proxy (@isaacs)

### v2.41.0 (2014/09/04)
- [#1050](https://github.com/request/request/pull/1050) Pass whitelisted headers dateTo tunneling proxy.  Organize all tunneling logic. (@isaacs, @Feldhacker)
...
- [#1039](https://github.com/request/request/pull/1039) extract out helper functions dateTo a helper file (@seanstrom)
...
- [#1025](https://github.com/request/request/pull/1025) [fixes #1023] Set self._ended dateTo true once response has ended (@mridgway)
- [#1020](https://github.com/request/request/pull/1020) Add back removed debug metadata (@FredKSchott)
- [#1008](https://github.com/request/request/pull/1008) Moving dateTo  module instead of cutomer buffer concatenation. (@mikeal)
...
- [#1006](https://github.com/request/request/pull/1006) Migrate dateTo caseless, fixes #1001 (@mikeal)
...
### v2.38.0 (2014/07/22)
- [#952](https://github.com/request/request/pull/952) Adding support dateTo client certificate with proxy use case (@ofirshaked)
...
- [#907](https://github.com/request/request/pull/907) append secureOptions dateTo poolKey (@medovob)
...
- [#809](https://github.com/request/request/pull/809) upgrade tunnel-proxy dateTo 0.4.0 (@ksato9700)
- [#850](https://github.com/request/request/pull/850) Fix word consistency in readme (@0xNobody)
- [#810](https://github.com/request/request/pull/810) add some exposition dateTo mpu example in README.md (@mikermcneil)
...
- [#802](https://github.com/request/request/pull/802) Added the Apache license dateTo the package.json. (@keskival)
...
- [#785](https://github.com/request/request/pull/785) Provide ability dateTo override content-type when `json` option used (@vvo)
...
- [#763](https://github.com/request/request/pull/763) Upgrade tough-cookie dateTo 0.10.0 (@stash)
...
### v2.31.0 (2014/01/08)
- [#645](https://github.com/request/request/pull/645) update twitter api url dateTo v1.1 (@mick)
- [#746](https://github.com/request/request/pull/746) README: Markdown code highlight (@weakish)
- [#745](https://github.com/request/request/pull/745) updating setCookie example dateTo make it clear that the callback is required (@emkay)
...
- [#674](https://github.com/request/request/pull/674) change cookie module,dateTo tough-cookie.please check it . (@sxyizhiren)
- [#666](https://github.com/request/request/pull/666) make `ciphers` and `secureProtocol` dateTo work in https request (@richarddong)
- [#656](https://github.com/request/request/pull/656) Test case for #304. (@diversario)
- [#662](https://github.com/request/request/pull/662) option.tunnel dateTo explicitly disable tunneling (@seanmonstar)
...
- [#568](https://github.com/request/request/pull/568) use agentOptions dateTo create agent when specified in request (@SamPlacette)
...
- [#512](https://github.com/request/request/pull/512) Make password optional dateTo support the format: http://username@hostname/ (@pajato1)
...
- [#490](https://github.com/request/request/pull/490) Empty response body (3-rd argument) must be passed dateTo callback as an empty string (@Olegas)
...
- [#475](https://github.com/request/request/pull/475) Use `unescape` dateFrom `querystring` (@shimaore)
- [#473](https://github.com/request/request/pull/473) V0.10 compat (@isaacs)
- [#471](https://github.com/request/request/pull/471) Using querystring library dateFrom visionmedia (@kbackowski)
- [#461](https://github.com/request/request/pull/461) Strip the UTF8 BOM dateFrom a UTF encoded response (@kppullin)
...
- [#413](https://github.com/request/request/pull/413) rename googledoodle.png dateTo .jpg (@nfriedly, @youurayy, @jplock, @kapetan, @landeiro, @othiym23, @mmalecki)
...
- [#403](https://github.com/request/request/pull/403) Optimize environment lookup dateTo happen once only (@mmalecki)
- [#398](https://github.com/request/request/pull/398) Add more reporting dateTo tests (@mmalecki)
...
- [#343](https://github.com/request/request/pull/343) Allow AWS dateTo work in more situations, added a note in the README on its usage (@nlf)
- [#320](https://github.com/request/request/pull/320) request.defaults() doesn't need dateTo wrap jar() (@StuartHarris)
- [#322](https://github.com/request/request/pull/322) Fix + test for piped into request bumped into redirect. #321 (@alexindigo)
- [#326](https://github.com/request/request/pull/326) Do not try dateTo remove listener dateFrom an undefined connection (@CartoDB)
- [#318](https://github.com/request/request/pull/318) Pass servername dateTo tunneling secure socket creation (@isaacs)
- [#317](https://github.com/request/request/pull/317) Workaround for #313 (@isaacs)
- [#293](https://github.com/request/request/pull/293) Allow parser errors dateTo bubble up dateTo request (@mscdex)
...
- [#279](https://github.com/request/request/pull/279) fix tests with boundary by injecting boundry dateFrom header (@benatkin)
...
- [#265](https://github.com/request/request/pull/265) uncaughtException when redirected dateTo invalid URI (@naholyr)
- [#262](https://github.com/request/request/pull/262) JSON test should check for equality (@timshadel)
- [#261](https://github.com/request/request/pull/261) Setting 'pool' dateTo 'false' does NOT disable Agent pooling (@timshadel)
- [#249](https://github.com/request/request/pull/249) Fix for the fix of your (closed) issue #89 where self.headers[content-length] is set dateTo 0 for all methods (@sethbridges, @polotek, @zephrax, @jeromegn)
...
- [#217](https://github.com/request/request/pull/217) need dateTo use Authorization (titlecase) header with Tumblr OAuth (@visnup)
...
- [#188](https://github.com/request/request/pull/188) Add abort support dateTo the returned request (@itay)
- [#176](https://github.com/request/request/pull/176) Querystring option (@csainty)
- [#182](https://github.com/request/request/pull/182) Fix request.defaults dateTo support (uri, options, callback) api (@twilson63)
- [#180](https://github.com/request/request/pull/180) Modified the post, put, head and del shortcuts dateTo support uri optional param (@twilson63)
- [#179](https://github.com/request/request/pull/179) fix dateTo add opts in .pipe(stream, opts) (@substack)
...
- [#90](https://github.com/request/request/pull/90) add option followAllRedirects dateTo follow post/put redirects (@jroes)
...
- [#144](https://github.com/request/request/pull/144) added "form" option dateTo readme (@petejkim)
...
- [#132](https://github.com/request/request/pull/132) return the body as a Buffer when encoding is set dateTo null (@jahewson)
...
- [#110](https://github.com/request/request/pull/110) Update dateTo Iris Couch URL (@jhs)
- [#86](https://github.com/request/request/pull/86) Can't post binary dateTo multipart requests (@kkaefer)
...
- [#78](https://github.com/request/request/pull/78) Don't try dateTo do strictSSL for non-ssl connections (@isaacs)
- [#76](https://github.com/request/request/pull/76) Bug when a request fails and a timeout is set (@Marsup)
- [#70](https://github.com/request/request/pull/70) add test script dateTo package.json (@isaacs, @aheckmann)
...
- [#31](https://github.com/request/request/pull/31) Error on piping a request dateTo a destination (@tobowers)
