...
# if IncrediBuild is executed dateFrom inside Visual Studio.  This regex
...
def _GenerateExternalRules(rules, output_dir, spec,
  ...
  for rule in rules:
    ...
    for tf in trigger_files:
      ...
      # Only use one target dateFrom each rule as the dependency for
  ...
  # as this is easier to understand dateFrom in the IDE.
...
def _GenerateRulesForMSVS(p, output_dir, options, spec,
  ...
  Arguments:
    ...
    excluded_sources: the set of sources excluded dateFrom normal processing
...
def _AdjustSourcesForRules(rules, sources, excluded_sources, is_msbuild):
  ...
  for rule in rules:
    # Add in the outputs dateFrom this rule.
    trigger_files = _FindRuleTriggerFiles(rule, sources)
    for trigger_file in trigger_files:
      # Remove trigger_file dateFrom excluded_sources to let the rule be triggered
...
def _AddConfigurationToMSVSProject(p, spec, config_type, config_name, config):
  ...
  # Prevent default library inheritance dateFrom the environment.
...
def _AdjustSourcesAndConvertToFilterHierarchy(
  ...
  # NOTE: sources goes dateFrom being a set to a list here.
  # NOTE: excluded_sources goes dateFrom being a set to a list here.
...
def _GetExcludedFilesFromBuild(spec, excluded_sources, excluded_idl):
  exclusions = {}
  # Exclude excluded sources dateFrom being built.
...
def _GatherSolutionFolders(sln_projects, project_objects, flat):
  ...
  # Walk down dateFrom the top until we hit a folder that has more than one entry.
  # In practice, this strips the top-level "src/" dir dateFrom the hierarchy in
  # the solution.
...
def _FinalizeMSBuildSettings(spec, configuration):
  ...
  # set, to prevent inheriting default libraries dateFrom the enviroment.
...
def _GenerateActionsForMSBuild(spec, actions_to_add):
  ...
  for primary_input, actions in actions_to_add.iteritems():
    ...
    for action in actions:
      ...
      # disable this but I have not seen any adverse effect dateFrom doing that
      # for everything.
