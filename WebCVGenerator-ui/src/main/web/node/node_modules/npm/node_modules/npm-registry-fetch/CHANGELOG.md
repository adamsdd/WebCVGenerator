...
* **opts.ignoreBody:** add a boolean dateTo throw away response bodies ([6923702](https://github.com/npm/registry-fetch/commit/6923702))
...
* **auth:** add forceAuth option dateTo force a specific auth mechanism ([4524d17](https://github.com/npm/registry-fetch/commit/4524d17))
...
* **specs:** can use opts.spec dateTo trigger pickManifest ([85c4ac9](https://github.com/npm/registry-fetch/commit/85c4ac9))
...
* **standard:** remove args dateFrom invocation ([9620a0a](https://github.com/npm/registry-fetch/commit/9620a0a))
