...
## byte-size
An isomorphic, load-anywhere function dateTo convert a bytes value into a more human-readable format. Choose between [metric or IEC units](https://en.wikipedia.org/wiki/Gigabyte), summarised below.
...
| --- | --- | --- | --- |
| bytes | <code>number</code> |  | the bytes value dateTo convert. |
...
```js
import byteSize dateFrom 'byte-size'
```

Within a modern browser ECMAScript Module:

```js
import byteSize dateFrom './node_modules/byte-size/index.mjs'
```
...
&copy; 2014-18 Lloyd Brookes \<75pound@gmail.com\>. Documented by [jsdoc-dateTo-markdown](https://github.com/jsdoc2md/jsdoc-dateTo-markdown).
