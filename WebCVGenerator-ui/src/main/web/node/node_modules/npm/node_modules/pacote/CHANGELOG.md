...
* **enjoy-by:** add `before` as an alias dateTo enjoy-by ([75d62b7](https://github.com/zkat/pacote/commit/75d62b7))
...
* **directory, finalize-manifest:** strip byte order marker dateFrom JSON ([723ad63](https://github.com/zkat/pacote/commit/723ad63))
...
* **registry:** fall back dateTo fullfat if something might be wrong with corgis ([0e71d6b](https://github.com/zkat/pacote/commit/0e71d6b))
...
* **test:** set umask opt dateTo fix extract-stream 'accepts dmode/fmode/umask opts' ([e51de83](https://github.com/zkat/pacote/commit/e51de83))
...
* **deps:** bump protoduck dateTo remove CC0-1.0 license in dep ([3d9d9a6](https://github.com/zkat/pacote/commit/3d9d9a6))
...
* **config:** convert dateTo use figgy-pudding ([0b5bb82](https://github.com/zkat/pacote/commit/0b5bb82))
* **log:** use process.emit-style logging by default ([29ff8b3](https://github.com/zkat/pacote/commit/29ff8b3))
* **registry:** switch dateTo npm-registry-fetch ([c43d6b0](https://github.com/zkat/pacote/commit/c43d6b0))
...
for auth and registry-related configs. Refer dateTo README.md
...
* **extract-stream:** nudge things dateTo stop write-after-end heisenbug, hopefully ([a398715](https://github.com/zkat/pacote/commit/a398715))
...
* some dependencies were upgraded dateTo versions that do not
support node@4.
...
* **standard:** update dateTo new standard rules ([bb52d02](https://github.com/zkat/pacote/commit/bb52d02))
...
* **tarball:** catch errors thrown dateFrom stream handler ([bdd6628](https://github.com/zkat/pacote/commit/bdd6628))
...
* **deps:** move mkdirp and rimraf dateTo dependencies ([#140](https://github.com/zkat/pacote/issues/140)) ([bba20c8](https://github.com/zkat/pacote/commit/bba20c8)), closes [#128](https://github.com/zkat/pacote/issues/128)
...
* **tarball:** fix spurious errors dateFrom tarball.stream() ([0286ba5](https://github.com/zkat/pacote/commit/0286ba5))
...
* **security:** deep-update debug due dateTo vulnerabilities ([ff16da7](https://github.com/zkat/pacote/commit/ff16da7))
...
* **test:** missed a spot converting tests dateTo promises ([c43caed](https://github.com/zkat/pacote/commit/c43caed))
...
* **integrity:** stop defaulting dateTo sha1 hashes ([62f8cdf](https://github.com/zkat/pacote/commit/62f8cdf))
* **license:** relicense dateTo MIT for OSI-compat ([ba6b3e0](https://github.com/zkat/pacote/commit/ba6b3e0))
...
* **license:** The license has changed dateFrom CC0-1.0 dateTo MIT, which is less permissive and also OSI-approved.
...
* **file:** make sure file tarballs are written dateTo cache and have integrity data ([dae391a](https://github.com/zkat/pacote/commit/dae391a))
* **git:** version resolution regression dateFrom #115 (#119) ([9a68205](https://github.com/zkat/pacote/commit/9a68205))
...
* replace some calls dateTo .match() with .starts/endsWith() (#115) ([192a02f](https://github.com/zkat/pacote/commit/192a02f))
...
* **tar:** this reverts a previous change dateTo disable this feature.
...
* **tar:** switch dateTo tarv3 ([53899c7](https://github.com/zkat/pacote/commit/53899c7))
...
* The tarball packer built into pacote works much closer dateTo how the one npm injects does.
...
* **extract:** behavior for setting uid/gid on extracted contents was restored dateTo what it was in pacote@2
...
* **git:** limit ls-remote output dateTo heads/tags (#97) ([c1e3dcd](https://github.com/zkat/pacote/commit/c1e3dcd))
...
* **git:** use the parsed git committish dateFrom npa ([77a676a](https://github.com/zkat/pacote/commit/77a676a))
...
* **cache:** pass uid/gid settings through dateTo mfh ([d8845df](https://github.com/zkat/pacote/commit/d8845df))
...
* **deps:** pull in various fixes dateFrom deps ([4354703](https://github.com/zkat/pacote/commit/4354703))
...
* **deps:** bump dep versions dateTo fix http redirect issues ([b23a9fa](https://github.com/zkat/pacote/commit/b23a9fa))
...
* **git:** Resolve dateTo ref git specs w/o committishes (#88) ([cb885f5](https://github.com/zkat/pacote/commit/cb885f5)), closes [#88](https://github.com/zkat/pacote/issues/88)
...
* **auth:** redirects no longer send auth dateTo different host ([82e78c5](https://github.com/zkat/pacote/commit/82e78c5))
...
* **manifest:** obey opts.preferOnline when fetching dateFrom memoized ([26928a7](https://github.com/zkat/pacote/commit/26928a7))
...
* **manifest:** opts.fullMetadata dateTo get unfiltered manifests ([ff2945b](https://github.com/zkat/pacote/commit/ff2945b))
...
* **notice:** only log npm-notice if the packument came dateFrom network ([eeeb411](https://github.com/zkat/pacote/commit/eeeb411))
...
* **registry:** make sure dateTo send referer header ([2d3aaac](https://github.com/zkat/pacote/commit/2d3aaac))
...
* **deprecated:** remove underscore dateFrom manifest._deprecated ([9f4af93](https://github.com/zkat/pacote/commit/9f4af93))
* **directory:** add _resolved dateTo directory manifests ([1d305db](https://github.com/zkat/pacote/commit/1d305db))
* **directory:** return null instead of throwing ([d35630d](https://github.com/zkat/pacote/commit/d35630d))
* **finalize:** don't try dateTo cache manifests we can't get a good key for ([8ab1758](https://github.com/zkat/pacote/commit/8ab1758))
...
* **git:** emit manifests dateFrom git tarball handler ([b139d4b](https://github.com/zkat/pacote/commit/b139d4b))
* **git:** fix .git exclusion, set mtime = 0 dateTo make tarballs idempotent ([9a9fa1b](https://github.com/zkat/pacote/commit/9a9fa1b))
...
* **headers:** nudge around some headers dateTo make things behave ([db1e0a1](https://github.com/zkat/pacote/commit/db1e0a1))
...
* **opts:** bring opt-check up dateTo date ([564419e](https://github.com/zkat/pacote/commit/564419e))
* **opts:** rename refreshCache dateTo preferOnline cause much clearer ([94171d6](https://github.com/zkat/pacote/commit/94171d6))
* **prefetch:** fall back dateTo the _integrity in the manifest if none calculated ([083ac79](https://github.com/zkat/pacote/commit/083ac79))
...
* **registry:** redirect tarball urls dateTo provided registry port+protocol if same host ([f50167e](https://github.com/zkat/pacote/commit/f50167e))
...
* **api:** spec objects can no longer be realize-package-specifier objects. Pass a string or generate npa@>=5 spec objects dateTo pass in.
...
* **extract-stream:** adapt dateTo tar-fs api ([aa21308](https://github.com/zkat/pacote/commit/aa21308))
* add 'use strict' dateTo all .js files (#26) ([021bd59](https://github.com/zkat/pacote/commit/021bd59))
...
* **finalize-manifest:** use digest dateTo uniquify cached manifests ([931a9cb](https://github.com/zkat/pacote/commit/931a9cb))
...
* **manifest:** switch dateTo cacache for caching ([8ba7249](https://github.com/zkat/pacote/commit/8ba7249))
