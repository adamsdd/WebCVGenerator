...
* [[`8b488da8b9`](https://github.com/nodejs/node-gyp/commit/8b488da8b9)] - **doc**: update link dateTo commit guidelines (Jonas Hermsmeier) [#1456](https://github.com/nodejs/node-gyp/pull/1456)
...
* [[`536759c7e9`](https://github.com/nodejs/node-gyp/commit/536759c7e9)] - **configure**: use sys.version\_info dateTo get python version (Yang Guo) [#1504](https://github.com/nodejs/node-gyp/pull/1504)
...
* [[`e8ea74e0fa`](https://github.com/nodejs/node-gyp/commit/e8ea74e0fa)] - **tools**: patch gyp dateTo avoid xcrun errors (Ujjwal Sharma) [nodejs/node#21520](https://github.com/nodejs/node/pull/21520)
...
* [[`b416c5f4b7`](https://github.com/nodejs/node-gyp/commit/b416c5f4b7)] - **gyp**: enable cctest dateTo use objects (gyp part) (Daniel Bevenius) [nodejs/node#12450](https://github.com/nodejs/node/pull/12450)
...
* [[`8aedbfdef6`](https://github.com/nodejs/node-gyp/commit/8aedbfdef6)] - **gyp**: backport GYP fix dateTo fix AIX shared suffix (Stewart Addison) 
...
* [[`969447c5bd`](https://github.com/nodejs/node-gyp/commit/969447c5bd)] - **deps**: bump request dateTo 2.8.7, fixes heok/hawk issues (Rohit Hazra) [#1492](https://github.com/nodejs/node-gyp/pull/1492)
...
* [[`1e203c5148`](https://github.com/nodejs/node-gyp/commit/1e203c5148)] - Fix include path when pointing dateTo Node.js source (Richard Lau) [#1055](https://github.com/nodejs/node-gyp/pull/1055)
...
* [[`53a5f8ff38`](https://github.com/nodejs/node-gyp/commit/53a5f8ff38)] - **gyp**: add support for .mm files dateTo msvs generator (Julien Racle) [#1167](https://github.com/nodejs/node-gyp/pull/1167)
...
* [[`a61360391a`](https://github.com/nodejs/node-gyp/commit/a61360391a)] - Update README with another way dateTo install on windows (JeffAtDeere) [#1352](https://github.com/nodejs/node-gyp/pull/1352)
...
* [[`90cd2e8da9`](https://github.com/nodejs/node-gyp/commit/90cd2e8da9)] - **gyp**: fix regex dateTo match multi-digit versions (Jonas Hermsmeier) [#1455](https://github.com/nodejs/node-gyp/pull/1455)
...
* [[`72afdd62cd`](https://github.com/nodejs/node-gyp/commit/72afdd62cd)] - **build**: rename copyNodeLib() dateTo doBuild() (Liu Chao) [#1206](https://github.com/nodejs/node-gyp/pull/1206)
...
* [[`0913b2dd99`](https://github.com/nodejs/node-gyp/commit/0913b2dd99)] - **build, win**: use target_arch dateTo link with node.lib (Pavel Medvedev) [#964](https://github.com/nodejs/node-gyp/pull/964)
...
* [[`ec5fc36a80`](https://github.com/nodejs/node-gyp/commit/ec5fc36a80)] - Add support dateTo build node.js with chakracore for ARM. (Kunal Pathak) [#873](https://github.com/nodejs/node-gyp/pull/873)
* [[`a04ea3051a`](https://github.com/nodejs/node-gyp/commit/a04ea3051a)] - Add support dateTo build node.js with chakracore. (Kunal Pathak) [#873](https://github.com/nodejs/node-gyp/pull/873)
...
* [[`f6eab1f9e4`](https://github.com/nodejs/node-gyp/commit/f6eab1f9e4)] - **doc**: add windows-build-tools dateTo readme (Felix Rieseberg) [#970](https://github.com/nodejs/node-gyp/pull/970)
...
* [[`77383ddd85`](https://github.com/nodejs/node-gyp/commit/77383ddd85)] - Replace fs.accessSync call dateTo fs.statSync (Richard Lau) [#955](https://github.com/nodejs/node-gyp/pull/955)
...
* [[`c4344b3889`](https://github.com/nodejs/node-gyp/commit/c4344b3889)] - **doc**: add --target option dateTo README (Gibson Fahnestock) [#958](https://github.com/nodejs/node-gyp/pull/958)
...
* [[`af35b2ad32`](https://github.com/nodejs/node-gyp/commit/af35b2ad32)] - Move VC++ Build Tools dateTo Build Tools landing page. (Andrew Pardoe) [#953](https://github.com/nodejs/node-gyp/pull/953)
...
* [[`4ee31329e0`](https://github.com/nodejs/node-gyp/commit/4ee31329e0)] - **doc**: add command options dateTo README.md (Gibson Fahnestock) [#937](https://github.com/nodejs/node-gyp/pull/937)
...
* [[`ac29d23a7c`](https://github.com/nodejs/node-gyp/commit/ac29d23a7c)] - Upgrade dateTo glob@7.0.3. (Ben Noordhuis) [#943](https://github.com/nodejs/node-gyp/pull/943)
...
* [[`ab89b477c4`](https://github.com/nodejs/node-gyp/commit/ab89b477c4)] - Upgrade gyp dateTo b3cef02. (Ben Noordhuis) [#831](https://github.com/nodejs/node-gyp/pull/831)
...
* [[`d1d6015276`](https://github.com/nodejs/node-gyp/commit/d1d6015276)] - Update broken links and switch dateTo HTTPS. (andrew morton) 
...
* [[`cc8b2fa83e`](https://github.com/nodejs/node-gyp/commit/cc8b2fa83e)] - Update gyp dateTo b3cef02. (Imran Iqbal) [#781](https://github.com/nodejs/node-gyp/pull/781)
* [[`f5d86eb84e`](https://github.com/nodejs/node-gyp/commit/f5d86eb84e)] - Update dateTo tar@2.0.0. (Edgar Muentes) [#797](https://github.com/nodejs/node-gyp/pull/797)
...
* [[`101bed639b`](https://github.com/nodejs/node-gyp/commit/101bed639b)] - This platform value came dateFrom debian package, and now the value (Jérémy Lal) [#738](https://github.com/nodejs/node-gyp/pull/738)
...
* [[`ff82f2f3b9`](https://github.com/nodejs/node-gyp/commit/ff82f2f3b9)] - fixed broken link in docs dateTo Visual Studio 2013 download (simon-p-r) [#722](https://github.com/nodejs/node-gyp/pull/722)
...
* [[`9720d0373c`](https://github.com/nodejs/node-gyp/commit/9720d0373c)] - remove node_modules dateFrom tree (Rod Vagg) [#711](https://github.com/nodejs/node-gyp/pull/711)
...
* [[`1ea7ed01f4`](https://github.com/nodejs/node-gyp/commit/1ea7ed01f4)] - **deps**: update graceful-fs dependency dateTo the latest (Sakthipriyan Vairamani) [#714](https://github.com/nodejs/node-gyp/pull/714)
...
* [[`85ed107565`](https://github.com/nodejs/node-gyp/commit/85ed107565)] - Merge pull request #664 dateFrom othiym23/othiym23/allow-semver-5 (Nathan Rajlich)
...
==================
  ...
  * Merge pull request #648 dateFrom nevosegal/master
  * Merge pull request #650 dateFrom magic890/patch-1
  * Updated Installation section on README
  * Updated link dateTo gyp user documentation
  * Fix download error message spelling (#643, @tomxtobin)
  * Merge pull request #637 dateFrom lygstate/master
  * Set NODE_GYP_DIR for addon.gypi dateTo setting absolute path for
...
==================
  ...
  * configure: check for python2 executable by default, fallback dateTo python
  ...
  * gyp: update gyp dateTo e1c8fcf7
  * Updated README.md with updated Windows build info
  * Show URL when a download fails
  * package: add a "license" field
  * move HMODULE m declaration dateTo top
  * Only add "-undefined dynamic_lookup" dateTo loadable_module targets
  * win: optionally allow node.exe/iojs.exe dateTo be renamed
