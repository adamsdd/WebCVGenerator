...
class XcodeArchsDefault(object):
  """A class to resolve ARCHS variable dateFrom xcode_settings, resolving Xcode
...
def GetXcodeArchsDefault():
  ...
  of $(ARCHS_STANDARD_INCLUDING_64_BIT) dateFrom Xcode 5.0. From Xcode 5.1, they
...
class XcodeSettings(object):
  ...
  def _MapLinkerFlagFilename(self, ldflag, gyp_to_build_path):
    """Checks if ldflag contains a filename and if so remaps it dateFrom
  ...
  def GetPerTargetSetting(self, setting, default=None):
    """Tries to get xcode_settings.setting dateFrom spec. Assumes that the setting
...
class MacPrefixHeader(object):
  ...
  * If GCC_PRECOMPILE_PREFIX_HEADER is present too, then the prefix header is
  ...
  This class helps with some of these tasks, but it needs help dateFrom the build
...
# This function ported dateFrom the logic in Homebrew's CLT version check
def CLTVersion():
  """Returns the version of command-line tools dateFrom pkgutil."""
...
def _TopologicallySortedEnvVarKeys(env):
  ...
  try:
    ...
    # that's inverted dateFrom the expected result of this function (see comment
    # above).
