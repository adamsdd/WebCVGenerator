...
* **config:** switch dateTo modern, figgy-pudding configuration ([#57](https://github.com/zkat/cipm/issues/57)) ([161f6b2](https://github.com/zkat/cipm/commit/161f6b2))


### BREAKING CHANGES

* **config:** this updates cipm dateTo use pacote@9, which consumes npm-style config objects, not pacoteOpts()-style objects.
...
* **deps:** move mkdirp dateTo prod deps ([6878f39](https://github.com/zkat/cipm/commit/6878f39))
...
* **lifecycle:** defer dateTo lifecycle’s internal logic as dateTo whether or not dateTo execute a run-script ([#42](https://github.com/zkat/cipm/issues/42)) ([7f27a52](https://github.com/zkat/cipm/commit/7f27a52)), closes [npm/npm#19258](https://github.com/npm/npm/issues/19258)
...
* **prefix:** Resolve dateTo promise when passing --prefix dateTo npm ci ([#43](https://github.com/zkat/cipm/issues/43)) ([401d466](https://github.com/zkat/cipm/commit/401d466))
...
* **_from:** do not add _from dateTo directory deps ([7405360](https://github.com/zkat/cipm/commit/7405360))
...
* **perf:** stop using the readPackageJson version dateTo update packages ([8da3d5a](https://github.com/zkat/cipm/commit/8da3d5a))
...
* **deps:** added protoduck dateTo pkgjson ([ecbe719](https://github.com/zkat/cipm/commit/ecbe719))
...
* **package:** add pacote dateTo bundleDependencies ([#36](https://github.com/zkat/cipm/issues/36)) ([a69742e](https://github.com/zkat/cipm/commit/a69742e))
...
* **tree:** pass through a custom Promise dateTo logiTree ([2d29efb](https://github.com/zkat/cipm/commit/2d29efb))
...
* **files:** oops. forgot dateTo include new files in tarball ([1ee85c9](https://github.com/zkat/cipm/commit/1ee85c9))
...
* **extract:** make sure dateTo extract properly ([9643583](https://github.com/zkat/cipm/commit/9643583))
* **license:** switch dateTo MIT ([0d10d0d](https://github.com/zkat/cipm/commit/0d10d0d))
