...
==================
  ...
  * Set `timeout` dateTo null for proper cleanup
...
==================
  ...
  * add async function pseudo-example dateTo README
...
==================
  ...
  * rename main file dateTo `index.js`
...
==================
  ...
  * add tests dateTo dangling socket (@pi0)
  ...
  * test: Node.js v4 likes dateTo call `cork` on the stream (#3, @tomhughes)
  * travis: test node v4, v5, v6 and v7

2.0.1 / 2015-09-10
==================

  * package: update "semver" dateTo v5.0.1 for WebPack (#1, @vhpoet)

2.0.0 / 2015-07-10
==================

  * refactor dateTo patch Node.js core for more consistent `opts` values
...
==================
  ...
  * agent: set `req._hadError` dateTo true after emitting "error"
...
==================
  ...
  * Fix passing an "error" object dateTo the callback function on the first tick
